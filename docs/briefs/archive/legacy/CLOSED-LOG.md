# Closed briefs — full history

Moved out of AGENTS.md on 2026-07-08 (was ~3,956 lines — the bulk of a 293KB
file) so the always-loaded manifest stays small. A file that size risks silent
truncation under OpenAI Codex CLI's default 32KB combined-instructions cap, and
Codex is one of the two providers filling brain/decomper/scaffolder roles per
...
- **Briefs 542/543 (2026-07-07, Mac).** **#1112** (b542, drain w3): 296 ov002 `.s`, all
  ...
  mwasmarm (fixed a `.extern`-list-before-substitution bug that hit 3/14) + **shipped all 15
  ov004/006 C-absorbed walls** (USA+JPN) — the `base+offset` C-absorbed class is now
  recoverable, not a permanent wall. Recommends wiring it as a batch_carve default (→ b545).
  59 asm_escape tests, 2453 suite. 3-region green.

- **Briefs 540/541 (2026-07-07, Mac).** **#1110** (b540, drain w2): 296 ov002 `.s` (148/
  region), 4 REFUSE, 0 verify-fail, all first-attempt; USA code ~50.6% / JPN ~49.4%; ~1,147
  USA + 1,283 JPN ov002 remain. **#1109** (b541, wall autopsy): confirmed all 15 ov004/006
  residues are genuinely C-absorbed walls (clean skip) BUT they're all the `base+small_offset`
  sub-case b406 flagged as fixable-but-unimplemented → **prototyped `asm_escape
  --allow-absorbed-offset`** (opt-in, default-off, 58/58 tests, but UNVERIFIED vs mwasmarm →
  b543 validates). Byproduct: regen stale tools-index.md. 3-region green.
...
- **Brief 239** — `scaffolder`, shipped in PR #709. 🎯 **C-39e
  ...
  **(D) NEGATIVE RESULT — brain's calcrom directive was wrong.**
  ...
  [`brief-239-c39e-sub-c42-audit-gotchas.md`](../../../research/brief-239-c39e-sub-c42-audit-gotchas.md).
- **Brief 238** — `decomper`, shipped in PR #710. 🎯 **30 .c
  ...
  [`brief-238-c42-drain-wave1.md`](../../../research/brief-238-c42-drain-wave1.md).
...
- **Brief 237** — `scaffolder`, shipped in PR #705. 🎯 **C-42
  ...
  **C-42 is a HINT not a recipe wall** — these picks aren't a
  ...
  [`brief-237-hard-tier-landscape-survey.md`](../../../research/brief-237-hard-tier-landscape-survey.md).
...
- **Brief 235** — `scaffolder`, shipped in PR #701. 🎯 **C-39e
  ...
  note:
  [`brief-235-c39e-c40-broader-and-232-deferred.md`](../../../research/brief-235-c39e-c40-broader-and-232-deferred.md).
...
- **Brief 233** — `scaffolder`, shipped in PR #698. 🎯 **C-40
  ...
  [`mmio-bit-extract.md`](../../../research/mmio-bit-extract.md).
- **Brief 232** — `decomper`, shipped in PR #699. 🎯 **35 .c
  ...
  **E4** helper-reuse + early-return + tail, **E5** early-
  ...
  [`brief-232-c39-drain-wave-5.md`](../../../research/brief-232-c39-drain-wave-5.md).
- **Brief 231** — `scaffolder`, shipped in PR #695. 🎯 **2
  ...
  [`brief-231-c39c-cross-tier-and-c38-nonleaf-p12.md`](../../../research/brief-231-c39c-cross-tier-and-c38-nonleaf-p12.md).
- **Brief 230** — `decomper`, shipped in PR #696. 🎯 **31 .c ships
  ...
  **Pattern Dδ** (brief 227-shape singles flagged C-39d, V11-V14
  ...
  [`brief-230-c39-wave4-cohort-hunt.md`](../../../research/brief-230-c39-wave4-cohort-hunt.md).
- **Brief 229** — `scaffolder`, shipped in PR #693. 🎯 **C-39d
  ...
  [`brief-229-c39c-d-pilots-and-c38-nonleaf.md`](../../../research/brief-229-c39c-d-pilots-and-c38-nonleaf.md).
...
- **Brief 228** — `decomper`, shipped in PR #692. 🎯 **31 .c
  ...
  [`brief-228-c39-wave3-sub-shapes.md`](../../../research/brief-228-c39-wave3-sub-shapes.md).
- **Brief 227** — `decomper`, shipped in PR #690. 🎯 **19/19 .c
  ...
  [`brief-227-c38-chained-cast-c39-wave2.md`](../../../research/brief-227-c38-chained-cast-c39-wave2.md).
- **Brief 226** — `scaffolder`, shipped in PR #689. 🎯 **C-39a +
  ...
  **C-39a (sign-check)** recipe: dead-arg helper-reuse —
  ...
  note:
  [`brief-226-c39-subclass-sign-check-helper-reuse.md`](../../../research/brief-226-c39-subclass-sign-check-helper-reuse.md).
- **Brief 225** — `scaffolder`, shipped in PR #686. 🎯 **1 ship +
  ...
  [`brief-225-c39-subpatterns-and-c38-deferred.md`](../../../research/brief-225-c39-subpatterns-and-c38-deferred.md).
- **Brief 224** — `decomper`, shipped in PR #687. 🎯 **25 ships,
  ...
  [`brief-224-c39-wave1.md`](../../../research/brief-224-c39-wave1.md).
...
- **Brief 222** — `scaffolder`, shipped in PR #684. 🎯 **C-39
  ...
  [`brief-222-c39-non-leaf-bitfield.md`](../../../research/brief-222-c39-non-leaf-bitfield.md).
...
- **Brief 220** — `scaffolder`, shipped in PR #681. 🎯 **Hard-tier
  ...
  **C-1 + C-23 co-dominance:** 2,933 picks fire both (37 % of
  ...
  Research note:
  [`hard-tier-wall-survey.md`](../../../research/hard-tier-wall-survey.md).
...
- **Brief 218** — `scaffolder`, shipped in PR #678. 🎯 **P-4 extended
  ...
  Research note:
  [`brief-218-wall-1-broader-and-shape-b.md`](../../../research/brief-218-wall-1-broader-and-shape-b.md).
...
- **Brief 203** — `decomper`, shipped in PR #654. 🎯 **2/3 C-23
  ...
  [`docs/research/objdiff-fuzzy-vs-complete-metric.md`](../../../research/objdiff-fuzzy-vs-complete-metric.md)).
...
- **Brief 184** — `scaffolder`, shipped in PR #629. 🎯
  **Cluster C / D-1 / D-2 cross-region subcommands.** Direct
  continuation of [PR #626's research note](../../../research/chunk-extent-generalisation.md):
...
- [`docs/briefs/176-cross-region-cluster-b-residue-with-generator.md`](176-cross-region-cluster-b-residue-with-generator.md)
...
- [`docs/briefs/177-unified-chunk-extent-generator.md`](177-unified-chunk-extent-generator.md)
...
- [`docs/briefs/175-cross-region-cluster-d3-apply.md`](175-cross-region-cluster-d3-apply.md)
...
- [`docs/briefs/174-bundle-extent-heuristic-generator.md`](174-bundle-extent-heuristic-generator.md)
...
- [`docs/briefs/172-cross-region-cluster-b-residue.md`](172-cross-region-cluster-b-residue.md)
  ...
  fix.
- [`docs/briefs/173-odd-aligned-slot-recipe-research.md`](173-odd-aligned-slot-recipe-research.md)
...
- [`docs/briefs/171-ov004-rodata-path-2-scale-up-wave-2.md`](171-ov004-rodata-path-2-scale-up-wave-2.md)
...
- [`docs/briefs/170-cross-region-cluster-bd3-apply-tooling.md`](170-cross-region-cluster-bd3-apply-tooling.md)
...
- [`docs/briefs/169-cross-region-cluster-a-apply.md`](169-cross-region-cluster-a-apply.md)
  ...
  regression verified.
- [`docs/briefs/168-patcher-n3-residual-fix.md`](168-patcher-n3-residual-fix.md)
...
- [`docs/briefs/167-ov004-rodata-path-2-scale-up.md`](167-ov004-rodata-path-2-scale-up.md)
...
- [`docs/briefs/166-pattern3-generator-local-label-fix.md`](166-pattern3-generator-local-label-fix.md)
...
- [`docs/briefs/165-main-30kb-mega-array.md`](165-main-30kb-mega-array.md)
...
- [`docs/briefs/164-patcher-n5-residual-fix.md`](164-patcher-n5-residual-fix.md)
...
- [`docs/briefs/163-cluster-d3-wave-3.md`](163-cluster-d3-wave-3.md)
  ...
  candidate.
- [`docs/briefs/162-patcher-low-n-extended-coverage.md`](162-patcher-low-n-extended-coverage.md)
...
- [`docs/briefs/160-ov004-rodata-veneer-trigger-claims.md`](160-ov004-rodata-veneer-trigger-claims.md)
  ...
  preserved.
- [`docs/briefs/161-pattern3-subsumed-ref-resolution.md`](161-pattern3-subsumed-ref-resolution.md)
...
- [`docs/briefs/158-cluster-d3-wave-2.md`](158-cluster-d3-wave-2.md)
  ...
  **Structural collision surfaced**: `data_02101928` skipped
  ...
  3-region SHA1 PASS + 27/27 OK preserved.
- [`docs/briefs/159-pattern3-section-flag-plus-reverse-lookup-tool.md`](159-pattern3-section-flag-plus-reverse-lookup-tool.md)
...
- [`docs/briefs/157-cluster-d3-wave-1.md`](157-cluster-d3-wave-1.md)
...
- [`docs/briefs/156-cluster-b-recipe-addendum-medium-spot-disassembly.md`](156-cluster-b-recipe-addendum-medium-spot-disassembly.md)
...
- [`docs/briefs/155-cluster-b-size-1-2-main-wave.md`](155-cluster-b-size-1-2-main-wave.md)
  ...
  **3-region SHA1 PASS + 27/27 OK preserved.**
- [`docs/briefs/154-ov004-rodata-symbol-reclassification-research.md`](154-ov004-rodata-symbol-reclassification-research.md)
...
- [`docs/briefs/153-cluster-b-size-1-2-wave.md`](153-cluster-b-size-1-2-wave.md)
  ...
  **Critical recipe adaptation discovered**: brief 152's
  ...
  SHA1 PASS preserved.**
- [`docs/briefs/151-ov004-rodata-cluster-wave-2.md`](151-ov004-rodata-cluster-wave-2.md)
...
- [`docs/briefs/152-cluster-b-size-1-2-workarounds.md`](152-cluster-b-size-1-2-workarounds.md)
...
- [`docs/briefs/149-cluster-b-wave-3-pointer-apply.md`](149-cluster-b-wave-3-pointer-apply.md)
...
- [`docs/briefs/150-patcher-low-n-with-terminator.md`](150-patcher-low-n-with-terminator.md)
...
- [`docs/briefs/147-ov004-rodata-cluster-wave-retry.md`](147-ov004-rodata-cluster-wave-retry.md)
  ...
  boundary.
- [`docs/briefs/148-cluster-b-pointer-typedef-research.md`](148-cluster-b-pointer-typedef-research.md)
...
- [`docs/briefs/146-patcher-ctor-terminator-detection.md`](146-patcher-ctor-terminator-detection.md)
...
- [`docs/briefs/144-pattern3-extern-emission-fix.md`](144-pattern3-extern-emission-fix.md)
...
- [`docs/briefs/145-ov004-rodata-cluster-wave.md`](145-ov004-rodata-cluster-wave.md)
...
- [`docs/briefs/142-patch-veneers-variable-count.md`](142-patch-veneers-variable-count.md)
  ...
  brief 145 ov004
  `.rodata` cluster work.
- [`docs/briefs/143-cluster-b-wave-1.md`](143-cluster-b-wave-1.md)
...
- [`docs/briefs/140-sha1-final-gate.md`](140-sha1-final-gate.md)
  ...
  **Brief-spec correction discovered**: 0x6C is the
  ...
  unused-import fix.
- [`docs/briefs/141-ov004-cluster-sweep.md`](141-ov004-cluster-sweep.md)
...
- [`docs/briefs/138-clean-macos-junk-filter.md`](138-clean-macos-junk-filter.md)
...
- [`docs/briefs/139-cluster-a-wave-4-pattern3-wave-2.md`](139-cluster-a-wave-4-pattern3-wave-2.md)
...
- [`docs/briefs/136-usa-jpn-main-2byte-fix.md`](136-usa-jpn-main-2byte-fix.md)
...
- [`docs/briefs/137-sha1-gap-scoping.md`](137-sha1-gap-scoping.md)
...
- [`docs/briefs/134-ov004-binary-patch-phase3.md`](134-ov004-binary-patch-phase3.md)
...
- [`docs/briefs/135-cluster-d2-pattern3-wave-1.md`](135-cluster-d2-pattern3-wave-1.md)
...
- [`docs/briefs/132-ov004-symbol-scoping-phase2.md`](132-ov004-symbol-scoping-phase2.md)
...
- [`docs/briefs/133-cluster-d1-wave-3-mega2.md`](133-cluster-d1-wave-3-mega2.md)
...
- [`docs/briefs/130-cluster-c-wave-4-d1-wave-2.md`](130-cluster-c-wave-4-d1-wave-2.md)
  ...
  6 briefs.
- [`docs/briefs/131-ov004-thunk-section-fix.md`](131-ov004-thunk-section-fix.md)
...
- [`docs/briefs/128-main-cat1-cluster-c-wave-3.md`](128-main-cat1-cluster-c-wave-3.md)
  ...
  (30 KB / 5 KB / 4.6 KB).
- [`docs/briefs/129-ov004-checksum-scoping.md`](129-ov004-checksum-scoping.md)
...
- [`docs/briefs/126-cluster-cd-wave-2.md`](126-cluster-cd-wave-2.md)
...
- [`docs/briefs/127-arm9-main-checksum-scoping.md`](127-arm9-main-checksum-scoping.md)
...
- [`docs/briefs/124-cluster-d-wave-1-d1.md`](124-cluster-d-wave-1-d1.md)
...
- [`docs/briefs/125-cluster-c-pattern3-generator.md`](125-cluster-c-pattern3-generator.md)
...
- [`docs/briefs/122-cluster-c-wave-1-pattern1.md`](122-cluster-c-wave-1-pattern1.md)
  ...
  remain.
- [`docs/briefs/123-data-worklist-v3.md`](123-data-worklist-v3.md)
...
- [`docs/briefs/120-cluster-a-wave-3-overlays.md`](120-cluster-a-wave-3-overlays.md)
...
- [`docs/briefs/121-cluster-d-pattern2-research.md`](121-cluster-d-pattern2-research.md)
...
- [`docs/briefs/118-cluster-a-wave-2-overlay.md`](118-cluster-a-wave-2-overlay.md)
  ...
  = ~61% drained.**
- [`docs/briefs/119-cluster-c-strings-research.md`](119-cluster-c-strings-research.md)
...
- [`docs/briefs/116-cluster-a-wave-1-dtcm-parity.md`](116-cluster-a-wave-1-dtcm-parity.md)
...
- [`docs/briefs/117-cluster-b-scalars-research.md`](117-cluster-b-scalars-research.md)
...
- [`docs/briefs/115-dtcm-pilot-cluster-e.md`](115-dtcm-pilot-cluster-e.md)
...
- [`docs/briefs/114-data-worklist-v2.md`](114-data-worklist-v2.md)
...
- [`docs/briefs/112-c29-c30-application-wave.md`](112-c29-c30-application-wave.md)
...
- [`docs/briefs/113-data-tier-scoping.md`](113-data-tier-scoping.md)
...
- [`docs/briefs/110-cross-region-apply-wave-3.md`](110-cross-region-apply-wave-3.md)
...
- [`docs/briefs/111-p10-permuter-callee-save.md`](111-p10-permuter-callee-save.md)
...
- [`docs/briefs/108-c27-application-wave-1.md`](108-c27-application-wave-1.md)
...
- [`docs/briefs/109-brief-106-residue-research.md`](109-brief-106-residue-research.md)
...
- [`docs/briefs/106-c26-w2-p9-early-return.md`](106-c26-w2-p9-early-return.md)
...
- [`docs/briefs/107-poolword-crossmodule-bl-research.md`](107-poolword-crossmodule-bl-research.md)
...
- [`docs/briefs/104-c24-w3-c26-application.md`](104-c24-w3-c26-application.md)
  ...
  resolution push).
- [`docs/briefs/105-permuter-vs-p9.md`](105-permuter-vs-p9.md)
...
- [`docs/briefs/102-c24-recipe-wave-2.md`](102-c24-recipe-wave-2.md)
...
- [`docs/briefs/103-predicated-cascade-research.md`](103-predicated-cascade-research.md)
...
- [`docs/briefs/101-c24-recipe-wave-1.md`](101-c24-recipe-wave-1.md)
  ...
  umbrella covered.
- [`docs/briefs/100-wn-codify-critical-section.md`](100-wn-codify-critical-section.md)
...
- [`docs/briefs/098-permuter-sweep-byte-diff.md`](098-permuter-sweep-byte-diff.md)
...
- [`docs/briefs/099-medium-tier-walls-research.md`](099-medium-tier-walls-research.md)
...
- [`docs/briefs/096-permuter-wrapper.md`](096-permuter-wrapper.md)
  ...
  F841 in new test.
- [`docs/briefs/097-medium-tier-follow-on-wave.md`](097-medium-tier-follow-on-wave.md)
...
- [`docs/briefs/094-cross-region-apply-wave-2.md`](094-cross-region-apply-wave-2.md)
...
- [`docs/briefs/095-port-to-region-d2-v2.md`](095-port-to-region-d2-v2.md)
...
- [`docs/briefs/092-single-region-cap-raise-0x80.md`](092-single-region-cap-raise-0x80.md)
...
- [`docs/briefs/093-permuter-vs-p4-validation.md`](093-permuter-vs-p4-validation.md)
...
- [`docs/briefs/090-cross-region-apply-single-region-matches.md`](090-cross-region-apply-single-region-matches.md)
...
- [`docs/briefs/091-c22-v2-expansion.md`](091-c22-v2-expansion.md)
...
- [`docs/briefs/086-single-region-hard-tier-cap-raise-0x60.md`](086-single-region-hard-tier-cap-raise-0x60.md)
...
- [`docs/briefs/088-mmio-base-folding-wall-sweep.md`](088-mmio-base-folding-wall-sweep.md)
...
- [`docs/briefs/084-c22-struct-pointer-corruption-wall.md`](084-c22-struct-pointer-corruption-wall.md)
  ...
  pool.
- [`docs/briefs/082-pokeheartgold-bulk-port-wave-1.md`](082-pokeheartgold-bulk-port-wave-1.md)
  ...
  + 1 pokeheartgold).
- [`docs/briefs/063-permuter-auto-runner.md`](063-permuter-auto-runner.md)
...
- [`docs/briefs/066-cross-project-source-research.md`](066-cross-project-source-research.md)
  `scaffolder`, originally shipped via PR #429; correction
  applied via brief 080 (PR #465). Folded into the
  cross-project pipeline.
- [`docs/briefs/081-single-region-hard-tier-resumption.md`](081-single-region-hard-tier-resumption.md)
...
- [`docs/briefs/079-cross-apply-tool-v2-fixes.md`](079-cross-apply-tool-v2-fixes.md)
  ...
  brief 085 (future).
- [`docs/briefs/080-pokeheartgold-extension-research.md`](080-pokeheartgold-extension-research.md)
  ...
  shipped via PR #466.
- [`docs/briefs/078-cross-region-apply-wave-2.md`](078-cross-region-apply-wave-2.md)
...
- [`docs/briefs/077-strip-static-keyword.md`](077-strip-static-keyword.md)
  ...
  family members).
- [`docs/briefs/074-cross-project-bulk-port-wave-3.md`](074-cross-project-bulk-port-wave-3.md)
...
- [`docs/briefs/076-cross-apply-libs-port-improvements.md`](076-cross-apply-libs-port-improvements.md)
...
- [`docs/briefs/075-cross-region-apply-existing-ports.md`](075-cross-region-apply-existing-ports.md)
...
- [`docs/briefs/073-per-region-cross-application.md`](073-per-region-cross-application.md)
...
- [`docs/briefs/072-port-driver-d5-struct-vendoring.md`](072-port-driver-d5-struct-vendoring.md)
...
- [`docs/briefs/071-cross-project-bulk-port-wave-1-rerun.md`](071-cross-project-bulk-port-wave-1-rerun.md)
...
- [`docs/briefs/070-port-external-source-driver.md`](070-port-external-source-driver.md)
...
- [`docs/briefs/069-cross-project-bulk-port-wave-1.md`](069-cross-project-bulk-port-wave-1.md)
...
- [`docs/briefs/065-multi-region-bulk-port-wave-1.md`](065-multi-region-bulk-port-wave-1.md)
...
- [`docs/briefs/068-cross-project-byte-fingerprint-pass.md`](068-cross-project-byte-fingerprint-pass.md)
...
- [`docs/briefs/062-diff-to-coercion-suggester.md`](062-diff-to-coercion-suggester.md)
...
- [`docs/briefs/064-multi-region-implementation.md`](064-multi-region-implementation.md)
  ...
  precision** (PR #423).
- [`docs/briefs/061-multi-region-porting-research.md`](061-multi-region-porting-research.md)
...
- [`docs/briefs/060-hard-tier-c20-medium-pool.md`](060-hard-tier-c20-medium-pool.md)
...
- [`docs/briefs/057-hard-tier-cap-raise-0x60.md`](057-hard-tier-cap-raise-0x60.md)
...
- [`docs/briefs/055-hard-tier-byte-volume-continued.md`](055-hard-tier-byte-volume-continued.md)
...
- [`docs/briefs/053-hard-tier-byte-volume.md`](053-hard-tier-byte-volume.md)
...
- [`docs/briefs/054-c15-vs-p1-taxonomy-fold-plus-ldr-ip-wall.md`](054-c15-vs-p1-taxonomy-fold-plus-ldr-ip-wall.md)
...
- [`docs/briefs/051-mixed-wave-13.md`](051-mixed-wave-13.md)
  ...
  (82.7% → 84.0%).
- [`docs/briefs/052-wave-12-wall-investigations.md`](052-wave-12-wall-investigations.md)
  ...
  documented.
- [`docs/briefs/049-hard-tier-wave-10.md`](049-hard-tier-wave-10.md)
...
- [`docs/briefs/050-codegen-walls-c13-plus-r2-research.md`](050-codegen-walls-c13-plus-r2-research.md)
...
- [`docs/briefs/048-push-r0-wall-research.md`](048-push-r0-wall-research.md)
...
- [`docs/briefs/047-hard-tier-pilot.md`](047-hard-tier-pilot.md)
  ...
  available.
- [`docs/briefs/046-medium-tier-wave-5.md`](046-medium-tier-wave-5.md)
...
- [`docs/briefs/045-sp3-routing-implementation.md`](045-sp3-routing-implementation.md)
...
- [`docs/briefs/044-sp3-routing-research.md`](044-sp3-routing-research.md)
...
- [`docs/briefs/043-medium-tier-wave-4.md`](043-medium-tier-wave-4.md)
...
- [`docs/briefs/042-codegen-walls-w-abcd.md`](042-codegen-walls-w-abcd.md)
  ...
  (P-8).
- [`docs/briefs/041-medium-tier-wave-3.md`](041-medium-tier-wave-3.md)
...
- [`docs/briefs/040-medium-tier-wave-2-retry.md`](040-medium-tier-wave-2-retry.md)
...
- [`docs/briefs/039-objects-txt-legacy-patch.md`](039-objects-txt-legacy-patch.md)
...
- [`docs/briefs/038-medium-tier-wave-2-dual-compiler.md`](038-medium-tier-wave-2-dual-compiler.md)
  ...
  brief 039.
- [`docs/briefs/037-dual-compiler-routing.md`](037-dual-compiler-routing.md)
...
- [`docs/briefs/036-style-a-epilogue-research.md`](036-style-a-epilogue-research.md)
  ...
  (decomper) consumes.
- [`docs/briefs/035-codegen-walls-c1-refinement.md`](035-codegen-walls-c1-refinement.md)
  ...
  13%).
- [`docs/briefs/034-medium-tier-wave.md`](034-medium-tier-wave.md)
...
- [`docs/briefs/032-consolidate-codegen-walls.md`](032-consolidate-codegen-walls.md)
...
- [`docs/briefs/030-cluster-prop-next-med-2.md`](030-cluster-prop-next-med-2.md)
...
- [`docs/briefs/029-cluster-prop-next-med.md`](029-cluster-prop-next-med.md)
  ...
  filtering.
- [`docs/briefs/028-cluster-prop-ov006-021c81a4.md`](028-cluster-prop-ov006-021c81a4.md)
...
- [`docs/briefs/027-cluster-prop-ov006-021b7ce0.md`](027-cluster-prop-ov006-021b7ce0.md)
  ...
  C-write step.
- [`docs/briefs/026-wine-migration-prep.md`](026-wine-migration-prep.md)
...
- [`docs/briefs/025-ov006-tooling-followup.md`](025-ov006-tooling-followup.md)
...
- [`docs/briefs/024-cluster-prop-next-high.md`](024-cluster-prop-next-high.md)
...
- [`docs/briefs/022-cluster-prop-0202b0e0.md`](022-cluster-prop-0202b0e0.md)
...
- [`docs/briefs/023-ov006-cluster-investigation.md`](023-ov006-cluster-investigation.md)
  ...
  brief 025).
- [`docs/briefs/021-markdownlint-cleanup.md`](021-markdownlint-cleanup.md)
  ...
  symptoms).
- [`docs/briefs/020-cluster-prop-02006164.md`](020-cluster-prop-02006164.md)
...
- [`docs/briefs/019-configure-mwasmarm-output.md`](019-configure-mwasmarm-output.md)
...
- [`docs/briefs/018-cluster-tooling-upgrade.md`](018-cluster-tooling-upgrade.md)
...
- [`docs/briefs/017-cluster-prop-020085d4.md`](017-cluster-prop-020085d4.md)
