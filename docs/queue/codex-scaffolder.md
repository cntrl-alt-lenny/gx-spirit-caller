...
### q-cmatch-triage-rest — finish the cmatch classification map (remaining ~12 modules) [DONE]
...
### q-winelane-untrack — remove the accidentally-tracked .wine-lane/ leak [CLAIMED]
