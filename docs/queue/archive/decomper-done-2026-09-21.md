...
# Decomper — completed items (2026-09-21 archive)

> **ARCHIVED / READ-ONLY (2026-09-21).** These are the `[DONE]` items moved
> out of [`docs/queue/decomper.md`](../decomper.md) when the project adopted
> the agentic framework, to keep the live backlog short. Kept verbatim for
> their completed-item history; do NOT claim, add or transition items here,
> and do not dispatch against it. `work_queue.py` will still read it if
> pointed at it — don't.
