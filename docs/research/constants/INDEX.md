...
| Duel phase field | `data_ov002_022d016c.f_cf8` values 0–4 (corrected 2026-08-03, was wrongly documented as 0–3) | [DuelStateEnums.md](DuelStateEnums.md) | Most-tested field in the duel state singleton |
...
| [DuelStateEnums.md](DuelStateEnums.md) | Duel phase (0–4, corrected 2026-08-03); per-overlay 4-state sub-machine; gauge kind (12/14/15); VRAM bank selector (0–9); slot-to-cell LUT; timer thresholds (0x3E8, 0x4B0, 0xBB8); state-pair handshake (0x7F/0x80) |
