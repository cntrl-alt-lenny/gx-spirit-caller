/* CAMPAIGN-PREP candidate for func_0202c46c (main, class A) — brief 494.
 ...
 *   confidence: high
 */
/* func_0202c46c: p = data_0219a93c.p1; return p->base8 + p->arr[idx].v4;
 * arr (stride 8, field @+4) at p+0x0, base8 at p+0x8 (gap at +4 -> two
 * separate ldr, no ldmia). Sibling of matched func_0202c44c/func_0202b7cc. */
...
extern Ctx0202c46c data_0219a93c;

char *func_0202c46c(int idx) {
    Inner0202c46c *p = data_0219a93c.p1;
