/* CAMPAIGN-PREP candidate for func_02053560 (main, class A) — brief 494.
 ...
 *   confidence: low
 */
/* func_02053560: build a small stack record {self, arg1}, hash 8 bytes of it,
 * mask the result to 7 bits, and return a 64-bit (self, hash) pair.
 *   func_020a68e0(work, 7);                 // seed/init 'work' (size 0x100)
 *   h = func_020a6754(work, &rec, 8) & 0x7f;
...
extern void         func_020a68e0(void *work, int k);
extern unsigned int func_020a6754(void *work, void *data, int len);

unsigned long long func_02053560(void *self, int arg1) {
    ...
    {
        unsigned int h = func_020a6754(work, &rec, 8) & 0x7f;
