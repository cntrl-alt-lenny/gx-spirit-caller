/* CAMPAIGN-PREP candidate for func_0202f59c (main, class A) — brief 494.
 ...
 *   confidence: high
 */
/* func_0202f59c: membership over 0x1AD6, 0x1AD7(+1), 0x1AD8(+2).
...
int func_0202f59c(int x) {
    if (x == 0x1AD6 || x == 0x1AD7 || x == 0x1AD8) return 1;
    return 0;
}
