/* CAMPAIGN-PREP candidate for func_0207c570 (main, class A) — brief 494.
 ...
 *   confidence: high
 */
/* func_0207c570: guarded accessor -> returns list head (f2270->f4) when
 * f2270!=0 && count>0xc, else 0. Style A epilogue with sub-sp, single
 * push {lr} only (no callee regs needed; func_0207b538 is the only call,
...
extern ctx_c570_t *func_0207b538(void);

void *func_0207c570(void) {
    ctx_c570_t  *ctx = func_0207b538();
