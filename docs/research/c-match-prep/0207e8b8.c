/* CAMPAIGN-PREP candidate for func_0207e8b8 (main, class A) — brief 494.
 ...
 *   confidence: high
 */
/* func_0207e8b8: sub-init call then eight constant field stores.
 *
 *   stmdb sp!, {r4, lr}
 *   mov  r4, r0
 *   add  r0, r4, #0x1c
 *   bl   func_0207e8a0      ; init &self->sub
...
typedef struct {
    ...
    int  f14;   /* +0x14 */
    int  f18;   /* +0x18 */
    char sub[4];/* +0x1c sub-object passed to func_0207e8a0 */
} S0207e8b8;

extern void func_0207e8a0(void *p);

void func_0207e8b8(S0207e8b8 *self) {
    func_0207e8a0(&self->sub);
    self->f0  = 0;
    self->f4  = 0;
    self->f8  = 1;
    self->fc  = 0;
