 ...
 *   confidence: high
 */
/* CAMPAIGN-PREP candidate for func_ov002_0229cd70 (ov002, class A).
...
extern int func_02094688(int a, int b);

int func_ov002_0229cd70(int a, int b)
{
    return func_02094688(b, a);
}
