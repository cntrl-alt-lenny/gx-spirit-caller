/* CAMPAIGN-PREP candidate for func_02084a9c (main, class A) — brief 494.
 ...
 *   confidence: med
 */
/* func_02084a9c: optional callback at +0x10 (passed this), then OR 0x20 at +0x8. */
struct obj_84a9c {
    char pad8[0x8];
    int flags;      /* +0x8 */
    char pad10[0x4];
...
void func_02084a9c(struct obj_84a9c *self) {
    if (self->cb != 0)
        self->cb(self);
    self->flags |= 0x20;
}
