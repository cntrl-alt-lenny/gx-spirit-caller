/* CAMPAIGN-PREP candidate for func_02295b08 (ov002, class A) — brief 494.
 * UNVERIFIED: built-free swarm draft. The campaign drops this into src/,
 * runs ninja + objdiff, and tweaks per the risk note if <100%.
 *   recipe:     bitfield bit0, rsb 1-b0, inverted-polarity nested if -> shared ret-0 epilogue
 *   risk:       low; matches shipped sibling 022950b0 shape; only the ==0 predication could flip
 *   confidence: high
 */
