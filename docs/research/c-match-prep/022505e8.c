/* CAMPAIGN-PREP candidate for func_022505e8 (ov002, class A) — brief 494.
 ...
 *   confidence: high
 */
/* func_ov002_022505e8: per-player slot scan. For each slot whose id passes
 * func_0202e234 (non-zero), mark via the list sink. */
