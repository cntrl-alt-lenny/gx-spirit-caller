/* CAMPAIGN-PREP candidate for func_02031764 (main, class A) — brief 494.
 ...
 *   confidence: high
 */
/* func_02031764: membership over 0x1652, 0x170A(+0xB8), 0x17D2(+0x180).
...
int func_02031764(int x) {
    if (x == 0x1652 || x == 0x170A || x == 0x17D2) return 1;
    return 0;
}
