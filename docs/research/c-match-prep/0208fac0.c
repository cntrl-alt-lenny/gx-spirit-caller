/* CAMPAIGN-PREP candidate for func_0208fac0 (main, class B) — brief 494.
 ...
 *   confidence: med
 */
/* func_0208fac0 — threshold dispatch wrapper (sibling of func_0208fa58,
 * base helper swapped to func_0208e0a0). */
...
void func_0208fac0(void *dst, int off, int len) {
    int base = (int)func_0208e0a0();
    int g = data_0210249c;
    if (g != -1 && len > 0x1c) {
