/* CAMPAIGN-PREP candidate for func_0201d0e8 (main, class A) — brief 494.
 ...
 *   confidence: high
 */
/* func_0201d0e8: count nonzero entries.
 *   count = 0;
 *   for (i = 0; i < 0x20; i++) if (data_0218ff8c[i] != 0) count++;
 *   return count;
 */

extern int data_0218ff8c[];

int func_0201d0e8(void) {
    int count = 0;
    int i;
    for (i = 0; i < 0x20; i++) {
