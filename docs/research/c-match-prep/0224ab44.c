/* CAMPAIGN-PREP candidate for func_0224ab44 (ov002, class C) — brief 494.
 * UNVERIFIED: built-free swarm draft. The campaign drops this into src/,
 * runs ninja + objdiff, and tweaks per the risk note if <100%.
 *   recipe:     guard-tail + :13 bitfield + bind-off; identical shape to 0224a4f8
 *   risk:       0x418 immediate-split order; :13 vs and; byte-identical asm to 0224a4f8 expected
 *   confidence: high
 */
/* func_ov002_0224ab44: per-parity table scan, tag matching entries. */
...
void func_ov002_0224ab44(int idx) {
    int x = idx;
    int off = (x & 1) * 0x868;
    char *base;
    struct ov002_ent *e;
