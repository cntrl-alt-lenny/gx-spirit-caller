/* CAMPAIGN-PREP candidate for func_0207de6c (main, class A) — brief 494.
 ...
 *   confidence: med
 */
/* func_0207de6c (main, class A, 0x44) — magic-compare validator returning bool.
...
int func_0207de6c(hdr_0207de6c_t *hdr) {
