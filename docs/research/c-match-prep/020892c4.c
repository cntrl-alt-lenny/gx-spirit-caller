/* CAMPAIGN-PREP candidate for func_020892c4 (main, class A) — brief 494.
 ...
 *   confidence: high
 */
/* func_020892c4 — clone of func_02089134, field rel[2] (offset 0x10). */
