/* CAMPAIGN-PREP candidate for func_02028804 (main, class B) — brief 494.
 ...
 *   confidence: high
 */
/* func_02028804 — null-guard + bit2 two-way dispatch + clear (twin of 0x245e8) */
...
extern void func_02029458(Obj28804 *p);
extern void func_020298f8(Obj28804 *p);

int func_02028804(Obj28804 *p) {
    if (p->field0 == 0)
        return 0;
    if (p->b2)
        func_02029458(p);
