/* CAMPAIGN-PREP candidate for func_02059d90 (main, class A) — brief 494.
 ...
 *   confidence: med
 */
/* func_02059d90: repetitive free-and-null teardown. The original
...
void func_02059d90(Owner *p) {
    if (p->res == 0) return;

    func_020453b4(p->res->a); p->res->a = 0;
    func_020453b4(p->res->b); p->res->b = 0;
    func_020453b4(p->res->c); p->res->c = 0;
    func_020453b4(p->res->d); p->res->d = 0;
    func_020453b4(p->res->e); p->res->e = 0;
    func_020453b4(p->res->f); p->res->f = 0;
    func_020453b4(p->res->g); p->res->g = 0;
    func_020453b4(p->res);
    p->res = 0;
}
