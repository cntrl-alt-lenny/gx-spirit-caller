 ...
 *   confidence: high
 */
/* func_ov002_0226b13c: forward (u16)arg1 to the command sink func_ov002_0226acf8
...
int func_ov002_0226b13c(int arg0, int arg1, int arg2) {
    return func_ov002_0226acf8(arg0, 0xc, (u16)arg1, 0);
}
