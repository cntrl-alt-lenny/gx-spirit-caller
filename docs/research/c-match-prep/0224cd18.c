/* CAMPAIGN-PREP candidate for func_0224cd18 (ov002, class D) — brief 494.
 ...
 *   confidence: med
 */
/* func_ov002_0224cd18: cf17c guard, 0x260 array, limit row[0x10]; getter
 * func_0202b8c0, compare == 3 -> post kind-13. */
#include "ov002_core.h"
extern int func_0202b8c0(int id);
void func_ov002_0224cd18(int player) {
