/* CAMPAIGN-PREP candidate for func_02089198 (main, class A) — brief 494.
 ...
 *   confidence: high
 */
/* func_02089198 — clone of func_02089134, field rel[4] (offset 0x18). */
