/* CAMPAIGN-PREP candidate for func_0200ef60 (main, class A) — brief 494.
 ...
 *   confidence: high
 */
/* func_0200ef60: allocate+zero+copy a record, then for each of two
 * pending-task slots (@0x18,@0x1c) invoke and clear it, stash a2 @0x27c,
 * and finalize via func_0200edb8. Returns the edb8 result. */
...
int func_0200ef60(void *o, int a2) {
    int *p = (int *)func_0200ed48();
    if (p == 0) return 0;
    if (o == 0) return 0;
    Fill32(0, p, 0x284);
    Copy32(o, p, 0x34);
