/* CAMPAIGN-PREP candidate for func_02089260 (main, class A) — brief 494.
 ...
 *   confidence: high
 */
/* func_02089260 — clone of func_02089134, field rel[3] (offset 0x14). */
