/* CAMPAIGN-PREP candidate for func_020317c0 (main, class A) — brief 494.
 ...
 *   confidence: high
 */
/* func_020317c0: x == 0x1A9F as a 0/1 result, branch form.
 *
 *     ldr r1,=0x1A9F; cmp r0,r1; bne .L; mov r0,#1; bx lr
 *  .L: mov r0,#0; bx lr
 */

int func_020317c0(int x) {
    if (x == 0x1A9F) return 1;
    return 0;
}
