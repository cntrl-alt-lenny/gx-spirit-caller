/* CAMPAIGN-PREP candidate for func_0200fd84 (main, class A) — brief 494.
 ...
 *   confidence: high
 */
/* func_0200fd84: walk the list whose head is at data_0218dbc8+0x910,
