/* CAMPAIGN-PREP candidate for func_0208fbf8 (main, class B) — brief 494.
 ...
 *   confidence: med
 */
/* func_0208fbf8 — threshold dispatch wrapper (sibling, base helper func_0208e1cc). */
...
void func_0208fbf8(void *dst, int off, int len) {
    int base = (int)func_0208e1cc();
    int g = data_0210249c;
    if (g != -1 && len > 0x1c) {
