/* CAMPAIGN-PREP candidate for func_0208fb28 (main, class B) — brief 494.
 ...
 *   confidence: med
 */
/* func_0208fb28 — threshold dispatch wrapper (sibling, base helper func_0208e120). */

extern int data_0210249c;
extern void *func_0208e120(void);
extern void func_02093fb8(int n, void *dst, int src, int len);
extern void func_020944a4(void *dst, int src, int len);

void func_0208fb28(void *dst, int off, int len) {
    int base = (int)func_0208e120();
    int g = data_0210249c;
    if (g != -1 && len > 0x1c) {
