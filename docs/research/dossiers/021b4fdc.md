...
| label | value | type |
|-------|-------|------|
| `_LIT0` | `data_ov010_021b91b4` | raw |
| `_LIT1` | `data_ov010_021b9260` | raw |
| `_LIT2` | `0x04001008` | MMIO/const |
| `_LIT3` | `0x0400000a` | MMIO/const |
| `_LIT4` | `data_ov010_021b8d44` | raw |
| `_LIT5` | `0x0400104c` | MMIO/const |
| `_LIT6` | `0x0400004d` | MMIO/const |
