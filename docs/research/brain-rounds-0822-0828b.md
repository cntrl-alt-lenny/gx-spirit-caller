...
# Brain round archive — 0818b, 0822b, 0825b, 0827, 0828, 0828b

Lifted verbatim out of `docs/state.md` on 2026-09-02 to keep that file at
its intended size. `state.md` is the churn file the next brain reads cold;
it is meant to be short. These rounds are settled — their durable lessons
already live in `docs/dispatch-log.md`, the wall catalog, and the campaign
analytics docs. Nothing here is load-bearing for current work.

Sections appear in the order they sat in `state.md`, which was not
chronological.
