...
- `docs/briefs/177-unified-chunk-extent-generator.md` (removed from `main`; at tag `archive/pre-redesign-2026-09-23`: `docs/briefs/archive/legacy/177-unified-chunk-extent-generator.md`)
  — original tool spec.
- `docs/briefs/178-cross-region-cluster-d3-with-generator.md` (removed from `main`; at tag `archive/pre-redesign-2026-09-23`: `docs/briefs/archive/legacy/178-cross-region-cluster-d3-with-generator.md`)
