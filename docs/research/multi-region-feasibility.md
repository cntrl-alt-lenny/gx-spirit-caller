...
- Brief 061
  (`docs/briefs/061-multi-region-porting-research.md` (removed from `main`; at tag `archive/pre-redesign-2026-09-23`: `docs/briefs/archive/legacy/061-multi-region-porting-research.md`))
