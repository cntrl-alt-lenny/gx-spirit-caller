# func_020a9914 (main, HIGH class A, 8B)
...
**Verify gate:**
1. `python tools/verify.py src/main/func_020a9914.c func_020a9914 --cc all` (diffs visible directly)
...
- Prep: `docs/research/c-match-prep/020a9914.c`
