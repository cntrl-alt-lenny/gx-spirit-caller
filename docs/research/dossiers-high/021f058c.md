# func_021f058c (ov002, HIGH class B, 152B)
...
**Verify gate:**
1. `python tools/verify.py src/overlay002/func_ov002_021f058c.c func_ov002_021f058c --cc all --module ov002` (diffs visible directly)
...
- Prep: `docs/research/c-match-prep/021f058c.c`
