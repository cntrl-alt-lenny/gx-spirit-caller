# func_0207e6bc (main, HIGH class B, 36B)
...
**Verify gate:**
1. `python tools/verify.py src/main/func_0207e6bc.c func_0207e6bc --cc all` (diffs visible directly)
...
- Prep: `docs/research/c-match-prep/0207e6bc.c`
