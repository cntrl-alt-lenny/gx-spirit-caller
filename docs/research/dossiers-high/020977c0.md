# func_020977c0 (main, HIGH class A, 80B)
...
**Verify gate:**
1. `python tools/verify.py src/main/func_020977c0.c func_020977c0 --cc all` (diffs visible directly)
...
| label | value | type |
|-------|-------|------|
| `_LIT0` | `data_021a8308` | data symbol |

**BL/BLX callees (in call order, unique):**

| instr | target | notes |
|-------|--------|-------|
| `bl` | `func_02097d60` | main TU call |
| `bl` | `OS_DisableIrq` |  |
| `bl` | `OS_RestoreIrq` |  |
...
- Prep: `docs/research/c-match-prep/020977c0.c`
