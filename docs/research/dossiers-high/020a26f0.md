# func_020a26f0 (main, HIGH class B, 148B)
...
**Verify gate:**
1. `python tools/verify.py src/main/func_020a26f0.c func_020a26f0 --cc all` (diffs visible directly)
...
- Prep: `docs/research/c-match-prep/020a26f0.c`
