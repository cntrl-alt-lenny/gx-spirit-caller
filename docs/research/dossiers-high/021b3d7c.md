# func_021b3d7c (ov002, HIGH class A, 84B)
...
**Verify gate:**
1. `python tools/verify.py src/overlay002/func_ov002_021b3d7c.c func_ov002_021b3d7c --cc all --module ov002` (diffs visible directly)
...
- Prep: `docs/research/c-match-prep/021b3d7c.c`
