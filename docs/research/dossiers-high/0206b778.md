# func_0206b778 (main, HIGH class A, 96B)
...
**Verify gate:**
1. `python tools/verify.py src/main/func_0206b778.c func_0206b778 --cc all` (diffs visible directly)
...
- Prep: `docs/research/c-match-prep/0206b778.c`
