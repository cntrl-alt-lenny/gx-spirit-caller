# func_020a3144 (main, HIGH class A, 76B)
...
**Verify gate:**
1. `python tools/verify.py src/main/func_020a3144.c func_020a3144 --cc all` (diffs visible directly)
...
- Prep: `docs/research/c-match-prep/020a3144.c`
