# func_02092074 (main, HIGH class A, 72B)
...
**Verify gate:**
1. `python tools/verify.py src/main/func_02092074.c func_02092074 --cc all` (diffs visible directly)
...
- Prep: `docs/research/c-match-prep/02092074.c`
