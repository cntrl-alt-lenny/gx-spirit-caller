# func_020a67cc (main, HIGH class A, 68B)
...
**Verify gate:**
1. `python tools/verify.py src/main/func_020a67cc.c func_020a67cc --cc all` (diffs visible directly)
...
- Prep: `docs/research/c-match-prep/020a67cc.c`
