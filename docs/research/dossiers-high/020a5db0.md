# func_020a5db0 (main, HIGH class A, 84B)
...
**Verify gate:**
1. `python tools/verify.py src/main/func_020a5db0.c func_020a5db0 --cc all` (diffs visible directly)
...
| label | value | type |
|-------|-------|------|
| `_LIT0` | `data_021a9934` | data symbol |
...
|-------|--------|-------|
| `bl` | `OS_DisableIrq` |  |
| `bl` | `func_020a60c0` | main TU call |
| `bl` | `func_02092e6c` | main TU call |
| `bl` | `OS_RestoreIrq` |  |
...
- Prep: `docs/research/c-match-prep/020a5db0.c`
