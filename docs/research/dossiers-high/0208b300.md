# func_0208b300 (main, HIGH class A, 44B)
...
**Verify gate:**
1. `python tools/verify.py src/main/func_0208b300.c func_0208b300 --cc all` (diffs visible directly)
...
- Prep: `docs/research/c-match-prep/0208b300.c`
