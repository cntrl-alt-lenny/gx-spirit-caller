# func_0229e14c (ov002, HIGH class A, 72B)
...
**Verify gate:**
1. `python tools/verify.py src/overlay002/func_ov002_0229e14c.c func_ov002_0229e14c --cc all --module ov002` (diffs visible directly)
...
| instr | target | notes |
|-------|--------|-------|
| `bl` | `func_ov002_0229d2c8` | overlay call (ov002) |
...
- Prep: `docs/research/c-match-prep/0229e14c.c`
