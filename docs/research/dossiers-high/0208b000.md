# func_0208b000 (main, HIGH class A, 64B)
...
**Verify gate:**
1. `python tools/verify.py src/main/func_0208b000.c func_0208b000 --cc all` (diffs visible directly)
...
- Prep: `docs/research/c-match-prep/0208b000.c`
