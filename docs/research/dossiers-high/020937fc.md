# func_020937fc (main, HIGH class A, 12B)
...
**Verify gate:**
1. `python tools/verify.py src/main/func_020937fc.c func_020937fc --cc all` (diffs visible directly)
...
- Prep: `docs/research/c-match-prep/020937fc.c`
