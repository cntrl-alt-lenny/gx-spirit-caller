# func_02095344 (main, HIGH class A, 72B)
...
**Verify gate:**
1. `python tools/verify.py src/main/func_02095344.c func_02095344 --cc all` (diffs visible directly)
...
| label | value | type |
|-------|-------|------|
| `_LIT0` | `0x04fff200` | MMIO/const |

**BL/BLX callees (in call order, unique):**

| instr | target | notes |
|-------|--------|-------|
| `bl` | `func_02092380` | main TU call |
| `bl` | `OS_DisableIrq` |  |
| `bl` | `OS_RestoreIrq` |  |
...
- Prep: `docs/research/c-match-prep/02095344.c`
