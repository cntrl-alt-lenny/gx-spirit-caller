# func_0208f920 (main, HIGH class B, 104B)
...
**Verify gate:**
1. `python tools/verify.py src/main/func_0208f920.c func_0208f920 --cc all` (diffs visible directly)
...
- Prep: `docs/research/c-match-prep/0208f920.c`
