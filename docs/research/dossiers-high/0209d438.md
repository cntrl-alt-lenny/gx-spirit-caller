# func_0209d438 (main, HIGH class A, 80B)
...
**Verify gate:**
1. `python tools/verify.py src/main/func_0209d438.c func_0209d438 --cc all` (diffs visible directly)
...
- Prep: `docs/research/c-match-prep/0209d438.c`
