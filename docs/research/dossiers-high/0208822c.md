# func_0208822c (main, HIGH class A, 60B)
...
**Verify gate:**
1. `python tools/verify.py src/main/func_0208822c.c func_0208822c --cc all` (diffs visible directly)
...
- Prep: `docs/research/c-match-prep/0208822c.c`
