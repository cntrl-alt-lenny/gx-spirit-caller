# func_020986c0 (main, HIGH class A, 76B)
...
**Verify gate:**
1. `python tools/verify.py src/main/func_020986c0.c func_020986c0 --cc all` (diffs visible directly)
...
| label | value | type |
|-------|-------|------|
| `_LIT0` | `func_0209870c` | func ptr |
| `_LIT1` | `data_021a8320` | data symbol |

**BL/BLX callees (in call order, unique):**

| instr | target | notes |
|-------|--------|-------|
| `bl` | `func_0209cb68` | main TU call |
...
- Prep: `docs/research/c-match-prep/020986c0.c`
