# func_020a978c (main, HIGH class B, 44B)
...
**Verify gate:**
1. `python tools/verify.py src/main/func_020a978c.c func_020a978c --cc all` (diffs visible directly)
...
- Prep: `docs/research/c-match-prep/020a978c.c`
