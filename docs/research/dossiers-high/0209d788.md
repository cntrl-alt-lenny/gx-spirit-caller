# func_0209d788 (main, HIGH class A, 28B)
...
**Verify gate:**
1. `python tools/verify.py src/main/func_0209d788.c func_0209d788 --cc all` (diffs visible directly)
...
| label | value | type |
|-------|-------|------|
| `.L_0209d7a0` | `0x27fff96` | MMIO/const |
...
- Prep: `docs/research/c-match-prep/0209d788.c`
