# func_02200084 (ov002, HIGH class A, 60B)
...
**Verify gate:**
1. `python tools/verify.py src/overlay002/func_ov002_02200084.c func_ov002_02200084 --cc all --module ov002` (diffs visible directly)
...
| `bl` | `func_ov002_02203930` | overlay call (ov002) |
...
- Prep: `docs/research/c-match-prep/02200084.c`
