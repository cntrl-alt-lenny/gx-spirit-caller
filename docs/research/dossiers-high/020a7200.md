# func_020a7200 (main, HIGH class A, 56B)
...
**Verify gate:**
1. `python tools/verify.py src/main/func_020a7200.c func_020a7200 --cc all` (diffs visible directly)
...
- Prep: `docs/research/c-match-prep/020a7200.c`
