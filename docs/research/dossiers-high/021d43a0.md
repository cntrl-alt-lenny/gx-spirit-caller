# func_021d43a0 (ov004, HIGH class A, 124B)
...
**Verify gate:**
1. `python tools/verify.py src/overlay004/func_ov004_021d43a0.c func_ov004_021d43a0 --cc all --module ov004` (diffs visible directly)
...
- Prep: `docs/research/c-match-prep/021d43a0.c`
