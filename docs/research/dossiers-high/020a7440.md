# func_020a7440 (main, HIGH class A, 64B)
...
**Verify gate:**
1. `python tools/verify.py src/main/func_020a7440.c func_020a7440 --cc all` (diffs visible directly)
...
- Prep: `docs/research/c-match-prep/020a7440.c`
