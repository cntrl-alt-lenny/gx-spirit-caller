# func_0208f4c8 (main, HIGH class B, 100B)
...
**Verify gate:**
1. `python tools/verify.py src/main/func_0208f4c8.c func_0208f4c8 --cc all` (diffs visible directly)
...
| `_LIT1` | `data_021a6334` | data symbol |
| `_LIT2` | `data_021a6330` | data symbol |
| `_LIT3` | `data_021a632c` | data symbol |
...
- Prep: `docs/research/c-match-prep/0208f4c8.c`
