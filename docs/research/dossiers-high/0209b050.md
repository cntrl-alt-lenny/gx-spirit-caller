# func_0209b050 (main, HIGH class A, 104B)
...
**Verify gate:**
1. `python tools/verify.py src/main/func_0209b050.c func_0209b050 --cc all` (diffs visible directly)
...
- Prep: `docs/research/c-match-prep/0209b050.c`
