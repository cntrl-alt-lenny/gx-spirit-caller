# func_0208df60 (main, HIGH class A, 52B)
...
**Verify gate:**
1. `python tools/verify.py src/main/func_0208df60.c func_0208df60 --cc all` (diffs visible directly)
...
- Prep: `docs/research/c-match-prep/0208df60.c`
