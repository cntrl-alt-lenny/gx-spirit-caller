# func_0206e4a4 (main, HIGH class B, 72B)
...
**Verify gate:**
1. `python tools/verify.py src/main/func_0206e4a4.c func_0206e4a4 --cc all` (diffs visible directly)
...
| label | value | type |
|-------|-------|------|
| `_LIT0` | `data_0219ed48` | data symbol |

**BL/BLX callees (in call order, unique):**

| instr | target | notes |
|-------|--------|-------|
| `bl` | `func_0206e504` | main TU call |
...
- Prep: `docs/research/c-match-prep/0206e4a4.c`
