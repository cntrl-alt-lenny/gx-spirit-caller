# func_02077094 (main, HIGH class A, 40B)
...
**Verify gate:**
1. `python tools/verify.py src/main/func_02077094.c func_02077094 --cc all` (diffs visible directly)
...
- Prep: `docs/research/c-match-prep/02077094.c`
