# func_0206e1e8 (main, HIGH class A, 60B)
...
**Verify gate:**
1. `python tools/verify.py src/main/func_0206e1e8.c func_0206e1e8 --cc all` (diffs visible directly)
...
| label | value | type |
|-------|-------|------|
| `_LIT0` | `data_0219ef34` | data symbol |
...
- Prep: `docs/research/c-match-prep/0206e1e8.c`
