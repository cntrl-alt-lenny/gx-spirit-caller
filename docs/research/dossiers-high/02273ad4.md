# func_02273ad4 (ov002, HIGH class A, 72B)
...
**Verify gate:**
1. `python tools/verify.py src/overlay002/func_ov002_02273ad4.c func_ov002_02273ad4 --cc all --module ov002` (diffs visible directly)
...
| `bl` | `func_ov002_02272a24` | overlay call (ov002) |
...
- Prep: `docs/research/c-match-prep/02273ad4.c`
