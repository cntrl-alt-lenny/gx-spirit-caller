# func_02093808 (main, HIGH class A, 12B)
...
**Verify gate:**
1. `python tools/verify.py src/main/func_02093808.c func_02093808 --cc all` (diffs visible directly)
...
- Prep: `docs/research/c-match-prep/02093808.c`
