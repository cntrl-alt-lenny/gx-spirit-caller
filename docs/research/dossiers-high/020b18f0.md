# func_020b18f0 (main, HIGH class A, 104B)
...
**Verify gate:**
1. `python tools/verify.py src/main/func_020b18f0.c func_020b18f0 --cc all` (diffs visible directly)
...
- Prep: `docs/research/c-match-prep/020b18f0.c`
