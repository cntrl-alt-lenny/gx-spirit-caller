# func_021aba54 (ov020, HIGH class B, 108B)
...
**Verify gate:**
1. `python tools/verify.py src/overlay020/func_ov020_021aba54.c func_ov020_021aba54 --cc all --module ov020` (diffs visible directly)
...
- Prep: `docs/research/c-match-prep/021aba54.c`
