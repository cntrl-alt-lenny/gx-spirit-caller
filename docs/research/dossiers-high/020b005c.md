# func_020b005c (main, HIGH class A, 32B)
...
**Verify gate:**
1. `python tools/verify.py src/main/func_020b005c.c func_020b005c --cc all` (diffs visible directly)
...
- Prep: `docs/research/c-match-prep/020b005c.c`
