# func_0206be1c (main, HIGH class A, 12B)
...
**Verify gate:**
1. `python tools/verify.py src/main/func_0206be1c.c func_0206be1c --cc all` (diffs visible directly)
...
- Prep: `docs/research/c-match-prep/0206be1c.c`
