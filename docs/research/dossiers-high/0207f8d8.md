# func_0207f8d8 (main, HIGH class A, 32B)
...
**Verify gate:**
1. `python tools/verify.py src/main/func_0207f8d8.c func_0207f8d8 --cc all` (diffs visible directly)
...
- Prep: `docs/research/c-match-prep/0207f8d8.c`
