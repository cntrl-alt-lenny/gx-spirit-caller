# func_02288a48 (ov002, HIGH class A, 88B)
...
**Verify gate:**
1. `python tools/verify.py src/overlay002/func_ov002_02288a48.c func_ov002_02288a48 --cc all --module ov002` (diffs visible directly)
...
| `_LIT1` | `0x000019bc` | MMIO/const |

**BL/BLX callees (in call order, unique):**

| instr | target | notes |
|-------|--------|-------|
| `bl` | `func_0202ef08` | main TU call |
...
- Prep: `docs/research/c-match-prep/02288a48.c`
