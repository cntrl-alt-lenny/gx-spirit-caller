# func_020a6858 (main, HIGH class A, 72B)
...
**Verify gate:**
1. `python tools/verify.py src/main/func_020a6858.c func_020a6858 --cc all` (diffs visible directly)
...
- Prep: `docs/research/c-match-prep/020a6858.c`
