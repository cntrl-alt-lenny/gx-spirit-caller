# func_0229cf10 (ov002, HIGH class A, 144B)
...
**Verify gate:**
1. `python tools/verify.py src/overlay002/func_ov002_0229cf10.c func_ov002_0229cf10 --cc all --module ov002` (diffs visible directly)
...
| `bl` | `func_ov002_0229cde8` | overlay call (ov002) |
...
- Prep: `docs/research/c-match-prep/0229cf10.c`
