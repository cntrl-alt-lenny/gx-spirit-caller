# func_0207cfc8 (main, HIGH class A, 20B)
...
**Verify gate:**
1. `python tools/verify.py src/main/func_0207cfc8.c func_0207cfc8 --cc all` (diffs visible directly)
...
- Prep: `docs/research/c-match-prep/0207cfc8.c`
