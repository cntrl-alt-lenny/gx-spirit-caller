# func_021d4044 (ov004, HIGH class A, 120B)
...
**Verify gate:**
1. `python tools/verify.py src/overlay004/func_ov004_021d4044.c func_ov004_021d4044 --cc all --module ov004` (diffs visible directly)
...
- Prep: `docs/research/c-match-prep/021d4044.c`
