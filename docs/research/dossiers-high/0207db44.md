# func_0207db44 (main, HIGH class A, 48B)
...
**Verify gate:**
1. `python tools/verify.py src/main/func_0207db44.c func_0207db44 --cc all` (diffs visible directly)
...
- Prep: `docs/research/c-match-prep/0207db44.c`
