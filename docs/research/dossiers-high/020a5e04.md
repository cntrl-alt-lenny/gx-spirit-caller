# func_020a5e04 (main, HIGH class A, 100B)
...
**Verify gate:**
1. `python tools/verify.py src/main/func_020a5e04.c func_020a5e04 --cc all` (diffs visible directly)
...
- Prep: `docs/research/c-match-prep/020a5e04.c`
