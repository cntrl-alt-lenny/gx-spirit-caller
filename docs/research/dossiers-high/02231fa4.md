# func_02231fa4 (ov002, HIGH class A, 96B)
...
**Verify gate:**
1. `python tools/verify.py src/overlay002/func_ov002_02231fa4.c func_ov002_02231fa4 --cc all --module ov002` (diffs visible directly)
...
- Prep: `docs/research/c-match-prep/02231fa4.c`
