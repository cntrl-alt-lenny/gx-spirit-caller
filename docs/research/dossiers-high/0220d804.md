# func_0220d804 (ov002, HIGH class A, 84B)
...
**Verify gate:**
1. `python tools/verify.py src/overlay002/func_ov002_0220d804.c func_ov002_0220d804 --cc all --module ov002` (diffs visible directly)
...
| `_LIT1` | `0x00001aa7` | MMIO/const |

**BL/BLX callees (in call order, unique):**

| instr | target | notes |
|-------|--------|-------|
| `bl` | `func_ov002_021bb950` | overlay call (ov002) |
...
- Prep: `docs/research/c-match-prep/0220d804.c`
