# func_020919ac (main, HIGH class A, 44B)
...
**Verify gate:**
1. `python tools/verify.py src/main/func_020919ac.c func_020919ac --cc all` (diffs visible directly)
...
- Prep: `docs/research/c-match-prep/020919ac.c`
