# func_020822f0 (main, HIGH class A, 60B)
...
**Verify gate:**
1. `python tools/verify.py src/main/func_020822f0.c func_020822f0 --cc all` (diffs visible directly)
...
| label | value | type |
|-------|-------|------|
| `_LIT0` | `data_021a18b8` | data symbol |
...
- Prep: `docs/research/c-match-prep/020822f0.c`
