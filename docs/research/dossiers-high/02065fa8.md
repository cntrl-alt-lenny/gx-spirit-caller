# func_02065fa8 (main, HIGH class A, 104B)
...
**Verify gate:**
1. `python tools/verify.py src/main/func_02065fa8.c func_02065fa8 --cc all` (diffs visible directly)
...
- Prep: `docs/research/c-match-prep/02065fa8.c`
