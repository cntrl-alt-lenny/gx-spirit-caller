# func_0209bb60 (main, HIGH class A, 68B)
...
**Verify gate:**
1. `python tools/verify.py src/main/func_0209bb60.c func_0209bb60 --cc all` (diffs visible directly)
...
| label | value | type |
|-------|-------|------|
| `_LIT0` | `func_0209b54c` | func ptr |
| `_LIT1` | `data_021a8438` | data symbol |

**BL/BLX callees (in call order, unique):**

| instr | target | notes |
|-------|--------|-------|
| `bl` | `func_0209bba4` | main TU call |
| `bl` | `func_0209b534` | main TU call |
...
- Prep: `docs/research/c-match-prep/0209bb60.c`
