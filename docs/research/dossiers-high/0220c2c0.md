# func_0220c2c0 (ov002, HIGH class A, 52B)
...
**Verify gate:**
1. `python tools/verify.py src/overlay002/func_ov002_0220c2c0.c func_ov002_0220c2c0 --cc all --module ov002` (diffs visible directly)
...
| instr | target | notes |
|-------|--------|-------|
| `bl` | `func_ov002_02207b3c` | overlay call (ov002) |
...
- Prep: `docs/research/c-match-prep/0220c2c0.c`
