# func_020952f8 (main, HIGH class A, 76B)
...
**Verify gate:**
1. `python tools/verify.py src/main/func_020952f8.c func_020952f8 --cc all` (diffs visible directly)
...
| label | value | type |
|-------|-------|------|
| `_LIT0` | `data_021a6730` | data symbol |
| `_LIT1` | `data_021a6734` | data symbol |
...
| `bl` | `func_02095a50` | main TU call |
| `bl` | `func_02095c18` | main TU call |
...
- Prep: `docs/research/c-match-prep/020952f8.c`
