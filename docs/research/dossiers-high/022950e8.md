# func_022950e8 (ov002, HIGH class A, 92B)
...
**Verify gate:**
1. `python tools/verify.py src/overlay002/func_ov002_022950e8.c func_ov002_022950e8 --cc all --module ov002` (diffs visible directly)
...
| instr | target | notes |
|-------|--------|-------|
| `bl` | `func_ov002_021b4254` | overlay call (ov002) |
| `bl` | `func_ov002_02291214` | overlay call (ov002) |
...
- Prep: `docs/research/c-match-prep/022950e8.c`
