# func_0208be9c (main, HIGH class A, 60B)
...
**Verify gate:**
1. `python tools/verify.py src/main/func_0208be9c.c func_0208be9c --cc all` (diffs visible directly)
...
| `_LIT1` | `0x04000290` | MMIO/const |
| `_LIT2` | `0x04000298` | MMIO/const |
...
- Prep: `docs/research/c-match-prep/0208be9c.c`
