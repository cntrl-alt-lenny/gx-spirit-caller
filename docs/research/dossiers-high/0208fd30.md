# func_0208fd30 (main, HIGH class B, 96B)
...
**Verify gate:**
1. `python tools/verify.py src/main/func_0208fd30.c func_0208fd30 --cc all` (diffs visible directly)
...
- Prep: `docs/research/c-match-prep/0208fd30.c`
