# func_0209b4a4 (main, HIGH class A, 64B)
...
**Verify gate:**
1. `python tools/verify.py src/main/func_0209b4a4.c func_0209b4a4 --cc all` (diffs visible directly)
...
| instr | target | notes |
|-------|--------|-------|
| `bl` | `func_020937fc` | main TU call |
| `bl` | `func_02096234` | main TU call |
...
- Prep: `docs/research/c-match-prep/0209b4a4.c`
