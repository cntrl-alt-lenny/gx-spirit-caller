# func_020a73e8 (main, HIGH class A, 44B)
...
**Verify gate:**
1. `python tools/verify.py src/main/func_020a73e8.c func_020a73e8 --cc all` (diffs visible directly)
...
- Prep: `docs/research/c-match-prep/020a73e8.c`
