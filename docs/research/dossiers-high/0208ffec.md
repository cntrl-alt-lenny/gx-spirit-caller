# func_0208ffec (main, HIGH class B, 92B)
...
**Verify gate:**
1. `python tools/verify.py src/main/func_0208ffec.c func_0208ffec --cc all` (diffs visible directly)
...
- Prep: `docs/research/c-match-prep/0208ffec.c`
