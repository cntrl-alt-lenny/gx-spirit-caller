# func_021b2ad0 (ov007, HIGH class A, 156B)
...
**Verify gate:**
1. `python tools/verify.py src/overlay007/func_ov007_021b2ad0.c func_ov007_021b2ad0 --cc all --module ov007` (diffs visible directly)
...
| instr | target | notes |
|-------|--------|-------|
| `bl` | `func_ov007_021b2d0c` | overlay call (ov007) |
| `bl` | `func_020215d8` | main TU call |
| `bl` | `func_ov007_021b2d3c` | overlay call (ov007) |
...
- Prep: `docs/research/c-match-prep/021b2ad0.c`
