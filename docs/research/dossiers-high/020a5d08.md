# func_020a5d08 (main, HIGH class A, 76B)
...
**Verify gate:**
1. `python tools/verify.py src/main/func_020a5d08.c func_020a5d08 --cc all` (diffs visible directly)
...
| label | value | type |
|-------|-------|------|
| `_LIT0` | `data_021a9924` | data symbol |
...
- Prep: `docs/research/c-match-prep/020a5d08.c`
