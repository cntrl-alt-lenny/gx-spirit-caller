# func_021b9d58 (ov006, HIGH class A, 64B)
...
**Verify gate:**
1. `python tools/verify.py src/overlay006/func_ov006_021b9d58.c func_ov006_021b9d58 --cc all --module ov006` (diffs visible directly)
...
| label | value | type |
|-------|-------|------|
| `_LIT0` | `func_ov006_021b9d98` | raw |
| `_LIT1` | `data_ov006_021cb3d4` | raw |
...
- Prep: `docs/research/c-match-prep/021b9d58.c`
