/* func_ov002_02291248: brief 227 C-39 wave 2 — single-arg helper, bool-from-int.
 *
...
int func_ov002_02291248(struct F02291248_Self *self) {
    return func_ov002_02281a74(self->f2.bit0) != 0;
}
