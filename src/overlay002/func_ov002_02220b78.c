/* func_ov002_02220b78: brief 234 — helper(bit0, f0, 4, 0); return 0.
 *
...
int func_ov002_02220b78(struct F02220b78_Self *self) {
    func_ov002_021e276c(self->f2.bit0, self->f0, 4, 0);
    return 0;
}
