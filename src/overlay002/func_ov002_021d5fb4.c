/* func_ov002_021d5fb4: byte-pack arg0/arg1 into a u16 ((u8)arg0 |
 * (u8)arg1<<8), then call func_ov002_021d5ab4(i, j, packed, 1) for i in
 * [0,2) and j in [0,5) -- the (u8)-cast byte-pack lever (ov002_core.h
 * wave 5). Sibling of the 021d5xxx arg-pack cluster.
 */

extern void func_ov002_021d5ab4(int i, int j, int packed, int one);
...
void func_ov002_021d5fb4(int arg0, int arg1) {
    ...
    for (i = 0; i < 2; i++) {
        for (j = 0; j < 5; j++) {
            func_ov002_021d5ab4(i, j, packed16, 1);
        }
    }
}
