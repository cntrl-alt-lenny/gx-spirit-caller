/* func_ov002_02257b48: result = func_ov002_02257464(p, q); if NULL
 * return 1. Save/restore data_ov002_022ce288.field_48c around a
 ...
 * data_ov002_022cf16c[i&1] rows (stride 0x14 within, base stride
...
extern data_ce288_t data_ov002_022ce288;
...
extern result_02257b48_t *func_ov002_02257464(void *p, void *q);

int func_ov002_02257b48(void *p, void *q) {
    result_02257b48_t *result;
    void *saved;
    int i, j;

    result = func_ov002_02257464(p, q);
    if (result == 0) {
        goto ret1;
    }

    saved = data_ov002_022ce288.field_48c;

    if (result->field_c != 0) {
        int r;
        data_ov002_022ce288.field_48c = p;
        r = result->field_c(p, q);
        data_ov002_022ce288.field_48c = saved;
        if (r == 0) {
            return 0;
        }
        if (r > 1) {
    ...
    data_ov002_022ce288.field_5c0 = 0;
    if (result->field_8 == 0) {
        goto ret1;
    }
    ...
    i = 0;
    do {
        char *row = data_ov002_022cf16c + (i & 1) * 0x868;
        j = 0;
        do {
