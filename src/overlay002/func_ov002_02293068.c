/* func_ov002_02293068: C-39b cross-call compare — same helper, both
...
int func_ov002_02293068(struct F02293068_Self *self) {
    int n = func_ov002_021bbf50(1 - self->f2.bit0);
    return n < func_ov002_021bbf50(self->f2.bit0);
}
