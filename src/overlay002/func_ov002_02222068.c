/* func_ov002_02222068: bail if self1's +0xc u16 is zero; else OR 4 into
...
extern int func_ov002_021de4b0(void *self1, int a, int b);

int func_ov002_02222068(void *self1, struct Self2 *self2) {
    ...
    func_ov002_021d8904(f2b->b0, f2b->f1_5, f4b->f2_9);
    func_ov002_021de4b0(self1, f2b->b0, f2b->f1_5);
    return 0;
}
