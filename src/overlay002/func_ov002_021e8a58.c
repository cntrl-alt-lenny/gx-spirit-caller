/* func_ov002_021e8a58: brief 227 C-39 wave 2 — single-arg helper, bool-from-int.
 *
...
int func_ov002_021e8a58(struct F021e8a58_Self *self) {
    return func_ov002_021bc8c8(self->f2.bit0) != 0;
}
