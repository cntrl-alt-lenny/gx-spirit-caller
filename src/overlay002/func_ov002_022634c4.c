/* func_ov002_022634c4: thunk — `func_ov002_022630b0` with r1 = 0x1a1f.
 *
...
int func_ov002_022634c4(int a, int _unused, int c, int d) {
    return func_ov002_022630b0(a, 0x1a1f, c, d);
}
