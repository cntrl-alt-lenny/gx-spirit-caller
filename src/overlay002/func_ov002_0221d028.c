/* func_ov002_0221d028: bit2 of self+4 guards; then self's field5 (bits1-5 of
 ...
 * to func_ov002_021de408(self, 0x04000400). */
...
int func_ov002_0221d028(struct Ov002Self *self) {
...

    {
        ...
        int bit0 = self->b0;
        char *row = data_ov002_022cf16c + (bit0 & 1) * 0x868;
