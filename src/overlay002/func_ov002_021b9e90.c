/* func_ov002_021b9e90: thunk — `func_ov002_021b3e28` with r2 = 0x1513.
 *
...
int func_ov002_021b9e90(int a, int b, int _unused, int d) {
    return func_ov002_021b3e28(a, b, 0x1513, d);
}
