...
extern int func_ov002_022817f4(int a);
...
/* func_ov002_02291640: a chain of per-player probes on obj->b0 (bit0 of
 ...
 */
int func_ov002_02291640(void *r5) {
    struct Ov1640Obj *o = r5;
    int r4;

    r4 = func_ov002_021bcf00(1 - o->b0);
    if (r4 == 0) {
        return 0;
    }

    if (func_ov002_021bae7c(o->b0, 0x1a7e, -1) != 0) {
        return 0;
    }

    {
        int a = func_ov002_022817f4(1 - o->b0);
        int b = func_ov002_022817f4(o->b0);
        if (a > b) {
            return 1;
        }
    }
    ...
    if (r4 >= 2) {
        if (r4 > func_ov002_021bcf00(o->b0)) {
            return 1;
        }
    }

    if (func_ov002_02259f74(o->b0) == 0) {
        return 0;
    }

    if (func_ov002_021bb068(0x140e) == 0 && func_ov002_021bb068(0x17a6) == 0) {
        goto ret_zero;
    }

    {
        int score = func_ov002_0227b0b8(o->b0, -1, 0);
        int bit0 = o->b0;
        int other = (1 - bit0) & 1;
        int tableVal = *(int *)(data_ov002_022cf16c + other * 0x868);
        if (score < tableVal && score < 0x960) {
            goto ret_zero;
        }
        if (func_ov002_02280980(bit0) > 0) {
            return 1;
        }
    }
