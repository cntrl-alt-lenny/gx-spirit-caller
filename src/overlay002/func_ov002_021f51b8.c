/* func_ov002_021f51b8: tag6 bitfield + helper-tail (brief 242 recipe).
 *
 *     push {r3, lr}
 *     ldrh r2, [r0, #2]; lsl/lsr → tag6
 *     cmp r2, #2; moveq r0, #1; popeq
 *     bl func_ov002_021f4df4
 *     pop
 *
...
extern int func_ov002_021f4df4(struct FuncOv002021f51b8Self *self, int arg);

int func_ov002_021f51b8(struct FuncOv002021f51b8Self *self, int arg) {
