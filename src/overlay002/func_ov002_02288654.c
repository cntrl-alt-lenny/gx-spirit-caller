/* func_ov002_02288654: brief 228 C-39 wave 3 — helper(1-bit0); bool tail.
 *
...
int func_ov002_02288654(struct F02288654_Self *self) {
    return func_ov002_021bcf00(1 - self->f2.bit0) >= 2;
}
