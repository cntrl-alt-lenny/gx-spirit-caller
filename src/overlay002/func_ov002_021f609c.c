/* func_ov002_021f609c: multi-bitfield extract + tag-check + helper.
 *
 ...
 *     bl    func_ov002_021e276c           ; helper(bit0, halfword_0, 1, field9)
 *   .L_end:
 *     mov   r0, #1                         ; return 1
 *     pop   {r3, pc}
 *
 ...
 * extracts in the same body. See `func_ov002_0223fd10.c` for
...
extern int func_ov002_021e276c(
    unsigned int bit0,
    unsigned int f0,
    unsigned int constant1,
    unsigned int field9);

int func_ov002_021f609c(struct Func021f609cSelf *self) {
