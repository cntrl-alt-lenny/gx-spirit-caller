/* func_ov002_02203b8c (ov002): player=self->b0; guard via 021ca698(player,
 ...
 * apart - same shape as func_ov002_022859e8): "row"(id, bitfield:13) and
...
int func_ov002_02203b8c(Self02203b8c *self)
{
    int found;
    int p, s;

    if (!func_ov002_021ca698(self->b0, self->b0))
        goto tail;

    if (func_ov002_021b3ecc(self->b0, 0xb, 0x14a0) != 0)
        found = func_ov002_021bbf50(self->b0);
    else
        found = func_ov002_021c325c(self->b0);
