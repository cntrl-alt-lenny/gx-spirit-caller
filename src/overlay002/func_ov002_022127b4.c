...
extern void func_ov002_0226b22c(int player, int field6, int c, int d);
extern void func_ov002_021d59cc(int player, int field6, int c, int d, int e);

int func_ov002_022127b4(void *arg0_raw) {
...

    {
        ...
        if (data_ov002_022cd744[player] == 1) {
            data_ov002_022d016c.fd44 = func_ov002_021b00d0(2);
        } else {
...
case_7f: {
        ...
        int fd44 = data_ov002_022d016c.fd44;
        func_ov002_0226b22c(player, field5, 1, fd44);
        return 0x7e;
    }

case_7e: {
        u16 fb2 = data_ov002_022d0e6c.fb2;
        int player = f2->player;
        int field5 = f2->field5;
        int f0 = *(u16 *)arg0_raw;
        func_ov002_021d59cc(player, field5, f0, 2, fb2);
        return 0xa;
    }
