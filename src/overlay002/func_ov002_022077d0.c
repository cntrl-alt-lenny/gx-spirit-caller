/* func_ov002_022077d0: brief 230 C-39d — helper(!bit0)>5 early + helper(bit0)<=5 tail.
 *
...
int func_ov002_022077d0(struct F022077d0_Self *self) {
    if (func_ov002_021bbeac(1 - self->f2.bit0) > 5) return 0;
    return func_ov002_021bbeac(self->f2.bit0) <= 5;
}
