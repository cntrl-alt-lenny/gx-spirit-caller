...
int func_ov002_02206d10(struct S02206d10 *self) {
    ...
    case2:
        c = 0x129e;
    cont:
        if (func_ov002_021bb90c(self->f2.bit0, c) == 0)
            return 0;
    }
    return 1;
}
