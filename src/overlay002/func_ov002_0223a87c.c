/* func_ov002_0223a87c: 3-guard chain; on full pass, arg-pack a kind-61 event with
...
int func_ov002_0223a87c(struct Ov002Self *arg0) {
    int ret, b0, b1, c;
    ...
    if (func_ov002_021bc55c(arg0->b0, c) == 0) goto end;
    func_ov002_021d479c((u16)((arg0->b0 ? 0x8000 : 0) | 61),
                        (u16)((u8)b0 | ((u8)b1 << 8)),
                        (u16)((u8)b0 | ((u8)c << 8)), 0);
end:
    return 0;
