/* func_ov002_02263ff4: thunk — `func_ov002_02263f04` with r1 = 0x1409.
 *
...
int func_ov002_02263ff4(int a, int _unused, int c, int d) {
    return func_ov002_02263f04(a, 0x1409, c, d);
}
