/* func_ov002_021f0954: 0x868 wrapper — f30 / opponent / idx guards, require
 * func_ov002_021c1ef0, then report func_ov002_021c1e44 clear. */
...
int func_ov002_021f0954(struct self_t *self, int player, int idx) {
