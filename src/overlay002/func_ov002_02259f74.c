/* func_ov002_02259f74: pool-deref + unsigned `> 3` check + helper-tail.
 *
 *     push  {r3, lr}
 *     ldr   r1, [pc, #20]
 *     ldr   r1, [r1, #0xcf8]
...
extern struct FuncOv00202259f74PoolStruct data_ov002_022d016c;
extern int func_ov002_02259f98(int x);

int func_ov002_02259f74(int x) {
    if (data_ov002_022d016c.f3320 > 3) return 0;
    return func_ov002_02259f98(x);
}
