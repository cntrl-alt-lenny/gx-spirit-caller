/* func_ov002_021f9954: tag6 bitfield + helper-tail.
 *
 *     push  {r3, lr}
 *     ldrh  r2, [r0, #2]
 *     lsl   r2, r2, #20
...
extern int func_ov002_021f9434(struct FuncOv002021f9954Self *self, int arg);

int func_ov002_021f9954(struct FuncOv002021f9954Self *self, int arg) {
    if (self->f2.tag6 != 2) return 1;
    return func_ov002_021f9434(self, arg);
}
