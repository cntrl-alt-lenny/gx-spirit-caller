/* func_ov002_021ba1a0: push onto player (arg0&1)'s 608-list — hand the next
 * free slot (cf16c+608 + count*4) plus arg1 to func_ov002_021b91c4, then bump
...
void func_ov002_021ba1a0(int arg0, int arg1) {
    int idx = (arg0 & 1) * 0x868;
    int count = *(int *)((char *)data_ov002_022cf17c + idx);
    func_ov002_021b91c4((int *)(data_ov002_022cf16c + idx + 608) + count, arg1);
