/* func_ov002_022640a4: thunk — `func_ov002_02263f04` with r1 = 0x1a31.
 *
...
int func_ov002_022640a4(int a, int _unused, int c, int d) {
    return func_ov002_02263f04(a, 0x1a31, c, d);
}
