/* func_ov002_02206168: compare func_ov002_021bbf50(!b0) to func_ov002_021bbf50(b0);
...
int func_ov002_02206168(void *self) {
    struct S02206168 *s = (struct S02206168 *)((char *)self + 2);
    int call1 = func_ov002_021bbf50(1 - s->b0);
    int call2 = func_ov002_021bbf50(s->b0);
