/* func_ov002_0220dc9c: C-39b helper-check + tail-call.
 *
 * Orig (56 B):
 ...
 *   mov   r1, #0xb                  ; r1 = 11
 *   bl    func_ov002_021b3ecc       ; helper1(bit0, 11, f0)
 *   cmp   r0, #0x0
 *   movne r0, #0x0
 *   ldmneia sp!, {r3, r4, r5, pc}   ; early-return 0 if != 0
 *   mov   r0, r5
 *   mov   r1, r4
 *   bl    func_ov002_021ff400       ; tail-call helper2(self, arg1)
 *   pop   {r3, r4, r5, pc}
 */
...
extern int func_ov002_021ff400(struct F0220dc9c_Self *self, int arg1);

int func_ov002_0220dc9c(struct F0220dc9c_Self *self, int arg1) {
