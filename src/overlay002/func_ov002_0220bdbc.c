/* func_ov002_0220bdbc: guard chain -- a 6-bit field of *(u16*)(arg0+2)
 * must be 0x12, CD3F4->f_8 must be 0, CD3F4->f_4 must equal bit0 of the
 * same u16 -- then tail func_ov002_021ba104(CD3F4->f_4, CD3F4->f_20,
...
int func_ov002_0220bdbc(void *arg0) {
    ...
    if (field6 == 0x12
        && *(int *)(data_ov002_022cd3f4 + 0x8) == 0
        && *(int *)(data_ov002_022cd3f4 + 0x4) == self->b0) {
        v = func_ov002_021ba104(*(int *)(data_ov002_022cd3f4 + 0x4),
                                 *(int *)(data_ov002_022cd3f4 + 0x20), 0x18a8);
        if (v != 0) return 1;
    }
    return 0;
}
