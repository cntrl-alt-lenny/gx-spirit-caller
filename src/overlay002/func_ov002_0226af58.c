 ...
 *   confidence: high
 */
/* func_ov002_0226af58: u16-zext two-arg tail-call shim, selector 4.
 * Identical shape to af38; only the selector constant differs (mov r1,#4).
 * Callee func_ov002_0226acf8(int r0, int sel, u16 a, u16 b) per acf8.s. */

typedef unsigned short u16;

extern void func_ov002_0226acf8(int a, int sel, u16 c, u16 d);

void func_ov002_0226af58(int arg0, int arg1, int arg2) {
    func_ov002_0226acf8(arg0, 4, (u16)arg1, (u16)arg2);
}
