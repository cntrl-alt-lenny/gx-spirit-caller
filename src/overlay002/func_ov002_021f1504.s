; func_ov002_021f1504 — .s escape hatch (brief 290): mwcc is byte-identical except
; the commutative add-operand order below (a CSE'd-temp wall, brief 288).
;   fix [14]: C emits `add r0, r4, r0`; original is `add r0, r0, r4`.
