/* func_ov002_021f09e8: 0x868 accessor wrapper — guard sub-row f30, opponent
 * (player != self->b0), idx, then forward to func_ov002_021c1ef0. */
...
int func_ov002_021f09e8(struct self_t *self, int player, int idx) {
