/* func_ov002_02248f60: kind-11 post if the idx card shares func_0202b878 type
 * with arg1 and func_ov002_021ca440 holds. */
#include "ov002_core.h"
extern int func_0202b878(int a);
extern int func_ov002_021ca440(int player, int id);
void func_ov002_02248f60(int player, int arg1, int idx) {
