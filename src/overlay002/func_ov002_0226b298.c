 ...
 *   confidence: high
 */
/* func_ov002_0226b298: forward (arg1,arg2) as zero-extended u16 payload to the
 * command sink func_ov002_0226acf8 with kind 0x17. Pure tail-call shim. */
typedef unsigned short u16;
extern int func_ov002_0226acf8(int a, int b, int c, int d);
int func_ov002_0226b298(int arg0, int arg1, int arg2) {
    return func_ov002_0226acf8(arg0, 0x17, (u16)arg1, (u16)arg2);
}
