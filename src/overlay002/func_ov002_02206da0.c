/* func_ov002_02206da0: ability-gated slot lookup. self->f4 bits[6:14] is
 * an ability id passed to func_ov002_021ca5bc; self->f2 bits[6:11] must be
 ...
 * slot_id (bits 0-8) indexes data_ov002_022d0250 for a 13-bit node id
 * passed to func_0202df78.
 *
...
extern int func_ov002_021ca5bc(int ability);
extern int func_0202df78(int id, int code);

int func_ov002_02206da0(Self02206da0 *self)
{
    if (!func_ov002_021ca5bc(self->f4.ability)) {
        return 0;
    }
...

    {
        struct Ov002Slot0250 *node =
            (struct Ov002Slot0250 *)(data_ov002_022d0250 + self->f14.slot_id * 4);
        return func_0202df78(node->id, 0x1691);
    }
