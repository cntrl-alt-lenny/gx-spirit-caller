/* func_ov002_0222bf14: brief 230 C-39d wave 4 — D1 dual-call same-helper return 0.
 *
...
extern int func_ov002_021df73c(unsigned int bit, unsigned int z);

int func_ov002_0222bf14(struct F0222bf14_Self *self) {
    func_ov002_021df73c(self->f2.bit0, 0);
    func_ov002_021df73c(1 - self->f2.bit0, 0);
    return 0;
}
