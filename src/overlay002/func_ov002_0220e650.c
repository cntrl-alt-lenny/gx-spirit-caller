...
extern int func_ov002_021ca0d4(int arg0, int arg1);
...
int func_ov002_0220e650(struct Self0220e650 *self) {
    int xorFlag = self->b0 ^ self->b14;

    if (func_ov002_021bc618(xorFlag) == 0) {
        return 0;
    }
    if (func_ov002_021ca0d4(self->b0, self->f0) == 0) {
        return 0;
    }
    if (self->f6_hi != 1) {
        goto fail;
    }
    {
        ...
        if (func_ov002_021c33e4(xorFlag, byte0, high16) == 0) {
            goto fail;
        }
        {
            char *rowBase = data_ov002_022cf16c + (byte0 & 1) * 0x868;
            int *arr = (int *)(rowBase + 0x418);
            func_ov002_0227adb8(xorFlag, (int)&arr[high16], 1, (int)self->f0 << 16);
        }
    }
    return 1;
