 ...
 *   confidence: high
 */
/* func_ov002_0226b0d0: forward (arg1,arg2) as zero-extended u16 payload to the
 * command sink func_ov002_0226acf8 with kind 0x13. Pure tail-call shim.
...
int func_ov002_0226b0d0(int arg0, int arg1, int arg2) {
    return func_ov002_0226acf8(arg0, 0x13, (u16)arg1, (u16)arg2);
}
