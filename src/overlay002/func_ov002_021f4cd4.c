/* func_ov002_021f4cd4: C-39a — sign-check via dead-arg helper-reuse.
 *
 ...
 *     bl    func_ov002_021d7a1c       ; helper2(bit0, n)
 *   .end:
 *     mov   r0, #1
 *     pop   {r4, pc}
 *
...
extern void func_ov002_021d7a1c(unsigned int bit, int n);

int func_ov002_021f4cd4(struct Func021f4cd4Self *self) {
    int n = func_ov002_021b9aa8(self->f2.bit0, self->f4.field9);
    if (n >= 0) {
        func_ov002_021d7a1c(self->f2.bit0, n);
    }
    return 1;
}
