/* func_ov002_022023d8: self+0x14 holds a (player:bit9, idx:bits10-13)
 ...
 * then threshold func_ov002_021c84a8(player, idx) <= 2000. */
...
int func_ov002_022023d8(struct Ov002Self *self) {
        ...
        return 0;
    {
        ...
        if (slot->id == 0)
            return 0;
        if (*(u16 *)(data_ov002_022cf1a4 + off + idx20) == 0)
            return 0;
    }
    return func_ov002_021c84a8(vb->player, vb->idx) <= 2000;
}
