/* func_ov002_0220762c: C-39f — unless b6_11==0x23, bail if table[bit0]
...
extern int func_ov002_021ff400(struct S762 *self, int arg1);
int func_ov002_0220762c(struct S762 *self, int arg1) {
    if (self->b6_11 != 0x23) {
        if (*(int *)(data_ov002_022cf180 + (self->bit0 & 1) * 0x868) != 0) return 0;
    }
