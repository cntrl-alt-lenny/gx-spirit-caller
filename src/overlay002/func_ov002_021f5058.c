/* func_ov002_021f5058: C-39 bit-extract under a sign-check (gotcha 5 —
...
extern int func_ov002_021f4a84(struct S021f5058 *self);
extern void func_ov002_021e276c(int a0, u16 a1, int a2, int a3);

int func_ov002_021f5058(struct S021f5058 *self) {
