/* func_ov002_0220c474: if self->kind==5, gate on
 * func_ov002_021ca698(self->b0, self->b0)!=0 and on the player-cf180
...
int func_ov002_0220c474(struct Ov002SelfBitKind *self) {
    if (self->kind == 5) {
        if (func_ov002_021ca698(self->b0, self->b0) == 0) {
            return 0;
        }
        if (*(int *)(data_ov002_022cf180 + (self->b0 & 1) * 0x868) == 0) {
            return 0;
        }
    }
    return 1;
