/* func_ov002_0220052c: 021ff3bc-query predicate — require the query and a set
...
extern int func_ov002_021ff3bc(struct Func0220052cSelf *self);
extern char data_ov002_022cf17c[];
extern char data_ov002_022cf288[];

int func_ov002_0220052c(struct Func0220052cSelf *self) {
    int off;
    ...
    if (self->f2.field6 != 0x23
        && ((*(unsigned int *)(data_ov002_022cf288 + off) >> 16) & 1))
        return 0;
    return 1;
}
