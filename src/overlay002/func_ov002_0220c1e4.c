/* func_ov002_0220c1e4 (ov002): guard chain (02206a98; 021ca2b8(b0);
...
extern int func_ov002_02206a98(Card0220c1e4 *s);
extern int func_ov002_021ca2b8(int a);
extern int func_ov002_021ca3f0(int a, int id);
extern int func_ov002_021bc618(int a);
extern int func_ov002_021bb90c(int a, int id);

int func_ov002_0220c1e4(Card0220c1e4 *s)
{
    ...
    if (func_ov002_021bb90c(s->b0, 0x19a3))
        goto ret_one_a;
    if (func_ov002_021bb90c(s->b0, 0x19a4) == 0)
        goto ret_zero;
