/* func_ov002_022633a0: for i=0,1, id=player^i; if func_ov002_021b4120(id,11,
 * arg1) > 0, arg-pack (bit31=id&1, |0x4e0000|0xa000000|u16(arg1)) to
 * func_ov002_021e30b4 with u16(result), then func_ov002_021d5b80(id,11,
...
int func_ov002_022633a0(int player, int arg1) {
    int i;

    for (i = 0; i < 2; i++) {
        int id = player ^ i;
        int result = func_ov002_021b4120(id, 11, arg1);
        if (result > 0) {
            unsigned int packed = ((unsigned)(id << 31) & 0x80000000u) | 0x4e0000 | 0xa000000 | (unsigned short)arg1;
            func_ov002_021e30b4(packed, (unsigned short)result, 0);
            func_ov002_021d5b80(id, 11, arg1, 0);
            return 0;
        }
    }
    return 1;
