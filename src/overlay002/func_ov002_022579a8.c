/* func_ov002_022579a8: resolve self's record via func_ov002_02257464; zero
...
extern char *func_ov002_02257464(void *self);

int func_ov002_022579a8(void *self) {
    int count = 0;
    char *rec = func_ov002_02257464(self);
    CE288->f_5c0 = 0;
