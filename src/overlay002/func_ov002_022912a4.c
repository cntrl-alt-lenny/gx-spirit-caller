/* func_ov002_022912a4: brief 227 C-39 wave 2 — two-arg helper, eq-0 bool.
 *
...
extern int func_ov002_02257ab8(struct F022912a4_Self *self, unsigned int bit0);

int func_ov002_022912a4(struct F022912a4_Self *self) {
