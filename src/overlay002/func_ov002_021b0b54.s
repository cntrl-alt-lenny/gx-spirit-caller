; func_ov002_021b0b54 — whole-function ship-as-.s (GLOBAL_ASM endgame, brief 302):
; the original disassembly emitted verbatim as a byte-exact mwasm TU.
; For reg-alloc-walled functions with no C match (brief 294 endgame).

        .text
        .extern data_ov002_022cd31c
        .extern data_ov002_022cd3f0
        .global func_ov002_021b0b54
        .arm
func_ov002_021b0b54:
    stmdb sp!, {r3, lr}
    cmp r0, #0x35
...
.L_50:
    ...
    ldmia sp!, {r3, pc}
_LIT0: .word data_ov002_022cd31c
_LIT1: .word data_ov002_022cd3f0
