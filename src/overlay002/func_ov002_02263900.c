/* func_ov002_02263900: thunk — `func_ov002_02262fd0` with r1 = 0x11cf.
 *
...
int func_ov002_02263900(int a, int _unused, int c, int d) {
    return func_ov002_02262fd0(a, 0x11cf, c, d);
}
