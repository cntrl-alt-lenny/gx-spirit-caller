/* func_ov002_02234894: C-39f bit-0-indexed table lookup (gotcha 14).
...
extern void func_ov002_02214720(struct S02234894 *self, int arg1);
int func_ov002_02234894(struct S02234894 *self, int arg1) {
    unsigned int v = *(unsigned int *)(data_ov002_022cf288 + (self->bit0 & 1) * 0x868);
    if ((v >> 16) & 1) return 0;
    func_ov002_02214720(self, arg1);
    return 0;
}
