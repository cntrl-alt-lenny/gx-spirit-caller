/* func_ov002_02252438: kind-11 post if func_0202f430 of the idx card holds and
 * func_ov002_021ca440 holds. */
#include "ov002_core.h"
extern int func_0202f430(int a);
extern int func_ov002_021ca440(int player, int id);
void func_ov002_02252438(int player, int arg1, int idx) {
    int id = ((struct Ov002Slot *)((char *)data_ov002_022cf16c + (player & 1) * 0x868 + idx * 4 + 288))->id;
    if (func_0202f430(id) == 0)
        return;
