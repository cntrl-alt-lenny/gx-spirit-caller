/* func_ov002_02291114: brief 228 C-39 wave 3 — helper(self, 1-bit0); bool tail.
 *
...
extern int func_ov002_02257ab8(struct F02291114_Self *self, unsigned int v);

int func_ov002_02291114(struct F02291114_Self *self) {
