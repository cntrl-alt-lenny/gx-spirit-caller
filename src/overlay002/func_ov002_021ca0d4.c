/* func_ov002_021ca0d4: gate check — arg0 is a player index, arg1 an
...
extern int func_ov002_021b3fd8(int arg0, int arg1, int arg2, int arg3);

int func_ov002_021ca0d4(int arg0, int arg1) {
    if (*(int *)(data_ov002_022ce288 + 0x5c8) != 0) {
        return 0;
    }
    if ((*(unsigned int *)(data_ov002_022cf288 + (arg0 & 1) * 0x868) >> 22) & 1) {
        return 0;
    }
    ...
    if (func_ov002_021bb068(0x147f) != 0) {
        return 0;
    }
    if (func_ov002_021bb068(0x12b1) != 0) {
        return 0;
    }
    if (func_ov002_021bb068(0x1ae1) != 0) {
        return 0;
    }
    if (func_ov002_021bae7c(1 - arg0, 0x1ae8, -1) != 0) {
        return 0;
    }
