/* func_ov002_02211808: call func_ov002_021e286c with bit 16 of *(u32*)p,
 * return 0.
 *
 *     push  {r3, lr}
...
extern void func_ov002_021e286c(int x);

int func_ov002_02211808(T *p) {
    func_ov002_021e286c(p->bit0);
    return 0;
}
