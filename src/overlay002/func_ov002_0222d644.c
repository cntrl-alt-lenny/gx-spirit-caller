/* func_ov002_0222d644: if f12_13==2, tail-call func_ov002_02210104(self,
 * arg1) (arg1 passed through unused otherwise). If f4.bit2!=0 return 0. If
 * func_ov002_021bb7f8(bit0,f0,f1_5)>=2, fire func_ov002_021e104c(bit0,3)
 * then func_ov002_021de408(self, func_ov002_02257704(self)). Always
...
extern int func_ov002_02210104(struct S0222d644 *self, int arg1);
...
int func_ov002_0222d644(struct S0222d644 *self, int arg1) {
    if (self->f2.f12_13 == 2)
        return func_ov002_02210104(self, arg1);
    if (self->f4.bit2 != 0)
        return 0;
    if (func_ov002_021bb7f8(self->f2.bit0, self->f0, self->f2.f1_5) >= 2) {
        func_ov002_021e104c(self->f2.bit0, 3);
