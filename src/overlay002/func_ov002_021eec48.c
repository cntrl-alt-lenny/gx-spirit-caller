/* func_ov002_021eec48: Guard chain over several table/bitfield checks (early-return 0 on any miss); final result is func_ov002_021c1ef0(...) != 0.
...
asm void func_ov002_021eec48(void) {
    nofralloc
    stmdb sp!, {r3, lr}
    ldr r3, =0x00000868
    and lr, r1, #1
