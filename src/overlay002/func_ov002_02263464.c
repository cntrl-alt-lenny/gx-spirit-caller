/* func_ov002_02263464: thunk — `func_ov002_022630b0` with r1 = 0x12a0.
 *
...
int func_ov002_02263464(int a, int _unused, int c, int d) {
    return func_ov002_022630b0(a, 0x12a0, c, d);
}
