/* func_ov002_022592ec: arm a type-7 request in the shared duel-command block
 * data_ov002_022d016c (21 band-callers). Sets the command id (7), stashes
 * arg0 as the request param, clears the two status words, copies the current
 * selection (data_ov002_022cd73c.f4), and clears the result word.
 */
...
void func_ov002_022592ec(int arg0) {
    data_ov002_022d016c.f3400 = 7;
