/* func_ov002_022000e4: C-39d 021ca2b8 predicate — require 021ca2b8(bit0),
...
int func_ov002_022000e4(struct Func022000e4Self *self) {
    if (func_ov002_021ca2b8(self->f2.bit0) == 0)
        return 0;
    return *(int *)(data_ov002_022cf178 + (self->f2.bit0 & 1) * 0x868) != 0;
}
