/* func_ov002_022096e4: C-39b helper1(self) ne-check + helper2(bit0, field9)
...
extern int func_ov002_021ff3bc(struct F022096e4_Self *self);
extern int func_ov002_021b99b4(unsigned int bit, unsigned int field9);

int func_ov002_022096e4(struct F022096e4_Self *self) {
