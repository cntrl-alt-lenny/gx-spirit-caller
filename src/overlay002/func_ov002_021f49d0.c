/* func_ov002_021f49d0: C-39b — helper-reuse without sign-check.
 *
 * Orig shape (48 B, 12 ARM insns):
 *
 *     push  {r4, lr}
 *     mov   r4, r0
 *     bl    func_ov002_021f3458       ; helper1(self)
 *     ldrh  r2, [r4, #2]
 ...
 *     bl    func_ov002_021df780       ; helper2(bit0^bit14, n)
 *     mov   r0, #1
 *     pop   {r4, pc}
 *
...
extern int func_ov002_021f3458(struct Func021f49d0Self *self);
extern int func_ov002_021df780(unsigned int xor_bits, int n);

int func_ov002_021f49d0(struct Func021f49d0Self *self) {
    int n = func_ov002_021f3458(self);
    func_ov002_021df780(self->f2.bit0 ^ self->f2.bit14, n);
    return 1;
}
