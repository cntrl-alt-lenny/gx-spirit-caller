/* func_ov002_021b3e5c: recovered C-42 resister (brief 254). 2-D table
 ...
 *     ldr   r1, .L      ; .word data_ov002_022cf1a6 (base)
...
extern int func_ov002_021b3d7c(u16 val, int a2, int a3);

int func_ov002_021b3e5c(int arg0, int arg1, int a2, int a3) {
    u16 val = *(u16 *)(data_ov002_022cf1a6 + (arg0 & 1) * 0x868 + arg1 * 20);
    return func_ov002_021b3d7c(val, a2, a3);
}
