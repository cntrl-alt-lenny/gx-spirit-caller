/* func_ov002_021f84ec: C-39a — sign-check via dead-arg helper-reuse.
 *
 * Orig shape (68 B, 17 ARM insns) identical to func_ov002_021f4cd4
 ...
 *
 * See `func_ov002_021f4cd4.c` for the recipe rationale and
...
extern void func_ov002_021d7c40(unsigned int bit, int n);

int func_ov002_021f84ec(struct Func021f84ecSelf *self) {
    int n = func_ov002_021b9aa8(self->f2.bit0, self->f4.field9);
    if (n >= 0) {
        func_ov002_021d7c40(self->f2.bit0, n);
    }
    return 1;
}
