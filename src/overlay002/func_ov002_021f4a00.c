/* func_ov002_021f4a00: brief 224 C-39 — tag6-check + bit-0 + helper.
 *
 * Orig shape (76 bytes):
 *
 *     push  {r4, lr}
 ...
 *     cmp   r1, #0x23
 *     beq   .L_end
 *     bl    func_ov002_021f3ba0        ; pre-check
 *     mov   r1, r0
 *     cmp   r1, #0
 *     ble   .L_end
 *     ldrh  r0, [r4, #2]
...
extern int func_ov002_021f3ba0(struct Func021f4a00Self *self);
extern int func_ov002_0226ae30(
    unsigned int bit0,
    unsigned int z1,
    unsigned int z2,
    unsigned int z3);
