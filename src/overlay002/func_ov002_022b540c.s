; func_ov002_022b540c — whole-function ship-as-.s (GLOBAL_ASM endgame, brief 302):
...
; For reg-alloc-walled functions with no C match (brief 294 endgame).
        ...
        .extern func_ov002_022b859c
        .global func_ov002_022b540c
        .arm
func_ov002_022b540c:
    stmdb sp!, {r3, r4, lr}
    sub sp, sp, #0x14
...
.L_40:
    ...
    add sp, sp, #0x14
    ldmia sp!, {r3, r4, pc}
_LIT0: .word data_ov002_022d11bc
