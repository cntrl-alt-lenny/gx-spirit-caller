/* func_ov002_02287cd0: brief 227 C-39 wave 2 — single-arg helper, inverted bool.
 *
...
int func_ov002_02287cd0(struct F02287cd0_Self *self) {
    return func_ov002_021bbf50(self->f2.bit0) == 0;
}
