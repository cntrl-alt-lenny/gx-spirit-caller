/* func_ov002_02206b00: guard on self's 2-bit field (bits12-13 of +2) == 2;
 * then check whether EITHER half (high u16 >>16, or low u16) of the packed
 * int at self+0x14, each shifted >>3 and run through func_ov002_021b947c,
 * yields a byte1(result)==0xf category. */
#include "ov002_core.h"

extern int func_ov002_021b947c(int val);

int func_ov002_02206b00(struct Ov002Self *self) {
