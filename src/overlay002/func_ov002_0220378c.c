/* func_ov002_0220378c: C-39f — index by (1-bit0); if table[1-bit0] and
...
extern int func_ov002_021ff2c8(struct S *self, int bit0);
int func_ov002_0220378c(struct S *self) {
    int v = *(int *)(data_ov002_022cf178 + ((1 - self->bit0) & 1) * 0x868);
    if (v != 0) {
        if (func_ov002_021ff2c8(self, self->bit0) > 0) return 1;
    }
    return 0;
}
