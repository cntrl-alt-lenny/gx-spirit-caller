/* func_ov002_0220a434: C-39 — guard on bits 18-19 of the int at +0x14,
...
extern int func_ov002_022000e4(struct S0220a434 *self, int arg);
int func_ov002_0220a434(struct S0220a434 *self, int arg) {
    if (self->b18_19 != 0) return 0;
    if (func_ov002_021bbf50(self->bit0) > 1) return 0;
