/* func_ov002_02291214: brief 228 C-39 wave 3 — int n = helper1(self); helper2(bit0, f0, n) <CMP> N.
 *
...
extern int func_ov002_0223f6c4(struct F02291214_Self *self);
extern int func_ov002_022536e8(unsigned int bit0, unsigned int f0, int n);

int func_ov002_02291214(struct F02291214_Self *self) {
    int n = func_ov002_0223f6c4(self);
    return func_ov002_022536e8(self->f2.bit0, self->f0, n) > 0;
}
