/* func_ov002_02208720: C-39f bit-0-indexed table lookup (gotcha 14).
...
extern int func_ov002_021ff3bc(struct S02208720 *self, int arg1, int v);
int func_ov002_02208720(struct S02208720 *self, int arg1) {
