/* func_ov002_022085a0 (ov002): bitfield-guard chain then a tail call.
 ...
 * table index). C-60 table family for the data_ov002_022d0250 lookup.
 */
...
int func_ov002_022085a0(struct Obj *card, void *arg1) {
    ...
    if (!func_0202e234(((struct TableVal *)&data_ov002_022d0250[card->idx9 * 2])->low13)) {
        return 0;
    }
