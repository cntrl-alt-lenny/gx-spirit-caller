/* func_ov002_02225cc4: brief 234 — helper(bit0, f0, 5, 0); return 0.
 *
...
int func_ov002_02225cc4(struct F02225cc4_Self *self) {
    func_ov002_021e276c(self->f2.bit0, self->f0, 5, 0);
    return 0;
}
