...
extern void func_ov002_022ae414(int *arr, int idx, int v);

int func_ov002_022aea30(void *self, int arg1) {
    int count;
    int idx;
    ...
    *(int *)(data_ov002_022d0f2c + 0xd0) = 1;
    {
        int d4val = *(int *)(data_ov002_022d0f2c + 0xd4);
        if (d4val < 6)
            d4val = 6;
    ...
    *(int *)((char *)self + 0x30) = 2;
    ...
    do {
        func_ov002_022ae414((int *)self, idx, ((int *)((char *)self + 0x1c))[idx]);
        count = *(int *)((char *)self + 0x3c);
        idx++;
    } while (idx < count);
    return count;
