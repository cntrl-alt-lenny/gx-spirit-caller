/* func_ov002_021fbba8: short-circuit-or-call (W-F / C-14
...
extern int func_ov002_021f4a84(void *p, int x);
...
int func_ov002_021fbba8(state_ov002_021fbba8_t *p, int x) {
    if (p->f_14 != 0) return 1;
    return func_ov002_021f4a84(p, x);
}
