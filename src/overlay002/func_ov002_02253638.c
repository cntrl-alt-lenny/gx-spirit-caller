/* func_ov002_02253638: binary search a 390-entry, 8-byte-stride sorted key
 * table for `key`; return the index or -1. */
struct S02253638KeyRec { unsigned int key; unsigned int rest; };
extern struct S02253638KeyRec data_ov002_022cad34[];
...
int func_ov002_02253638(unsigned int key) {
    ...
    if (key != data_ov002_022cad34[lo].key) return -1;
    return lo;
}
