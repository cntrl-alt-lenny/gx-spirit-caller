/* func_ov002_02205f30: C-42 — 2-arg, helper1 == 0 → return 0, else helper2.
 *
 *   push {r3, r4, r5, lr}; mov r5, r0; mov r4, r1
 *   bl func_ov002_021ff320(self, arg)
 *   cmp r0, #0; moveq r0, #0; popeq
 *   mov r0, r5; mov r1, r4
 *   bl func_ov002_021ff46c(self, arg)
 *   pop
 *
...
extern int func_ov002_021ff46c(void *self, int arg);

int func_ov002_02205f30(void *self, int arg) {
    int n = func_ov002_021ff320(self, arg);
    if (n == 0) return 0;
    return func_ov002_021ff46c(self, arg);
}
