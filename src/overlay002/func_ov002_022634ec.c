/* func_ov002_022634ec: thunk — `func_ov002_022630b0` with r1 = 0x1a21.
 *
...
int func_ov002_022634ec(int a, int _unused, int c, int d) {
    return func_ov002_022630b0(a, 0x1a21, c, d);
}
