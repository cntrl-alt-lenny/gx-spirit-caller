/* func_ov002_022360ac: CE288->f_5a8 state-machine ticker (sibling of the
...
int func_ov002_022360ac(struct S022360ac *self)
{
    ...
    case 128: {
        ...
        val = func_ov002_0223de94(self, 0);
        lo = val & 0xff;
        hi = (((u16)val) >> 8) & 0xff;

        if (func_ov002_0225764c((int)self, lo, hi) == 0) {
            goto fail128;
        }
        if (func_ov002_021de64c((int)self, lo, hi, 0) == 0) {
            goto fail128;
        }

        {
            struct Ov002Slot *slot = (struct Ov002Slot *)
                (data_ov002_022cf16c + (lo & 1) * 0x868 + hi * 20 + 0x30);
            self->fc = slot->id;
        }
        return 0x7f;
fail128:
    ...
    case 127: {
        ...
        if (func_ov002_021ca698(bit0, opp) == 0) {
            return 0;
        }
        func_ov002_021e2b3c();
        return 0x7e;
    ...
    case 126: {
        int opp = 1 - self->b0;
        int idx = func_ov002_021c2e34(opp, self->fc);
        ...
        }
        {
            ...
            struct Ov002Slot *rec = (struct Ov002Slot *)
                (data_ov002_022cf16c + (opp2 & 1) * 0x868 + 0x418 + idx * 4);
            func_ov002_021d8128(opp2, rec, 1);
        }
        return 0x7e;
    }
    case 125:
