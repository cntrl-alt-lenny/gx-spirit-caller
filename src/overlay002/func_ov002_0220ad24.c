/* func_ov002_0220ad24: brief 234 C-39b — helper-reuse + multi-arg helper2 + tail-call.
 *
 * Orig (0x54):
...
extern int func_ov002_021f40f4(struct F0220ad24_Self *self);
extern int func_ov002_021ff170(unsigned int bit, int n, unsigned int field9,
                                unsigned int z0, unsigned int z1);
extern int func_ov002_0220d4d0(struct F0220ad24_Self *self, void *arg1);

int func_ov002_0220ad24(struct F0220ad24_Self *self, void *arg1) {
    int n = func_ov002_021f40f4(self);
    if (func_ov002_021ff170(self->f2.bit0, n, self->f4.field9, 0, 0) == 0) return 0;
    return func_ov002_0220d4d0(self, arg1);
}
