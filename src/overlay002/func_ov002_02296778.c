/* func_ov002_02296778: brief 228 C-39 wave 3 — helper(1-bit0); bool tail.
 *
...
int func_ov002_02296778(struct F02296778_Self *self) {
    return func_ov002_021bbf50(1 - self->f2.bit0) >= 2;
}
