/* func_ov002_0222a23c: brief 234 — helper(1-bit0, f0, 5, 0); return 0.
 *
...
int func_ov002_0222a23c(struct F0222a23c_Self *self) {
    func_ov002_021e276c(1 - self->f2.bit0, self->f0, 5, 0);
    return 0;
}
