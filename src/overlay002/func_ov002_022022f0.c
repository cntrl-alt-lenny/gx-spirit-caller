/* func_ov002_022022f0: brief 228 C-39 wave 3 — helper(1-bit0); bool tail.
 *
...
extern int func_ov002_021c39ec(unsigned int v);

int func_ov002_022022f0(struct F022022f0_Self *self) {
    return func_ov002_021c39ec(1 - self->f2.bit0) >= 0;
}
