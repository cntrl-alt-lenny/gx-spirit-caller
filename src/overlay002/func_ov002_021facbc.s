; func_ov002_021facbc — whole-function ship-as-.s (GLOBAL_ASM endgame, brief 302):
...
; For reg-alloc-walled functions with no C match (brief 294 endgame).
        ...
        .extern func_ov002_0220ae74
        .extern func_ov002_0220b7ac
        .extern func_ov002_0220bcdc
        .extern func_ov002_0220cdd4
        .extern func_ov002_022577dc
        .global func_ov002_021facbc
        .arm
func_ov002_021facbc:
...
.L_100:
    mov r0, r5
    mov r1, r4
    bl func_ov002_0220bcdc
    cmp r0, #0x0
    bne .L_168
    mvn r0, #0x0
    ldmia sp!, {r3, r4, r5, pc}
.L_11c:
    bl func_ov002_0220ae74
    cmp r0, #0x0
    bne .L_168
    mvn r0, #0x0
    ldmia sp!, {r3, r4, r5, pc}
.L_130:
    bl func_ov002_0220b7ac
    cmp r0, #0x0
    bne .L_168
    mvn r0, #0x0
    ldmia sp!, {r3, r4, r5, pc}
