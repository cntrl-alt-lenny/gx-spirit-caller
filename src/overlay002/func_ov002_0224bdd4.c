/* func_ov002_0224bdd4: Same table-lookup-then-classify-then-forward shape as func_ov002_0224c620, with a threshold of 4 instead of 7.
...
asm void func_ov002_0224bdd4(void) {
    nofralloc
