/* func_ov002_022016bc: guard chain -- a 6-bit field of *(u16*)(arg0+2) must
 * equal 0x12, then *(int*)(arg0+0x14) must be nonzero, then compare
 * data_ov002_022cd3f4[0] against bit0 of the same u16.
...
int func_ov002_022016bc(void *arg0) {
    ...
    return *(int *)data_ov002_022cd3f4 != self->b0;
}
