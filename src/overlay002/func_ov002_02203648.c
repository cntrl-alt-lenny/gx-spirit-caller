/* func_ov002_02203648: brief 228 C-39 wave 3 — helper(bit0, -1); bool tail.
 *
...
int func_ov002_02203648(struct F02203648_Self *self) {
    return func_ov002_021bcd80(self->f2.bit0, ~0) > 1;
}
