/* func_ov002_0223fd10: bit-0 extract from halfword field + helper + return 1.
 *
...
extern int func_ov002_0223dad0(struct Func0223fd10Self *self, unsigned int bit);

int func_ov002_0223fd10(struct Func0223fd10Self *self) {
