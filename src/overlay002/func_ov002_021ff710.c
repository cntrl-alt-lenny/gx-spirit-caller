/* func_ov002_021ff710: brief 228 C-39 wave 3 — helper(bit0, -1); bool tail.
 *
...
struct F021ff710_Self {
    unsigned short f0;
    struct F021ff710_F2 f2;
};

extern int func_ov002_021bcd80(unsigned int bit0, int mask);

int func_ov002_021ff710(struct F021ff710_Self *self) {
    return func_ov002_021bcd80(self->f2.bit0, ~0) != 0;
}
