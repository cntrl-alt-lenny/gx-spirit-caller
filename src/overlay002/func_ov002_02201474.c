/* func_ov002_02201474: brief 227 C-39 wave 2 — two-arg helper (self+bit0), bool-from-int.
 *
 ...
 *     bl    func_ov002_021ff2b8       ; helper(self, bit0)
 *     cmp   r0, #0
 *     movne r0, #1
 *     moveq r0, #0
 *     pop   {r3, pc}
...
extern int func_ov002_021ff2b8(struct F02201474_Self *self, unsigned int bit0);

int func_ov002_02201474(struct F02201474_Self *self) {
