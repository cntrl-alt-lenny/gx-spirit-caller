/* func_ov002_02294054: brief 228 C-39 wave 3 — helper(1-bit0); bool tail.
 *
...
extern int func_ov002_022818a4(unsigned int v);

int func_ov002_02294054(struct F02294054_Self *self) {
    return func_ov002_022818a4(1 - self->f2.bit0) >= 0;
}
