/* func_ov002_0229591c: brief 227 C-39 wave 2 — two-arg helper, eq-0 bool.
 *
...
extern int func_ov002_02257ab8(struct F0229591c_Self *self, unsigned int bit0);

int func_ov002_0229591c(struct F0229591c_Self *self) {
