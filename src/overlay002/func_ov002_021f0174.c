/* func_ov002_021f0174: Guard chain similar to its siblings, but the final result is the *inverse* of func_ov002_021c1e44(...)'s truthiness.
...
asm void func_ov002_021f0174(void) {
    nofralloc
    stmdb sp!, {r3, lr}
    cmp r2, #5
    movge   r0, #0
