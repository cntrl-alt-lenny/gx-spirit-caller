/* func_ov002_02257888: reset CE288->f_5c0, then for each player (0,1) and
 * each sub-row index (0..10, 0x14-byte stride at data_ov002_022cf16c
...
int func_ov002_02257888(void *self, Callback02257888 fn, int target) {
    int count = 0;
    int player;
    ...
    do {
        int idx = 0;
        struct RowHdr02257888 *row = (struct RowHdr02257888 *)(data_ov002_022cf16c + (player & 1) * 0x868);
        do {
