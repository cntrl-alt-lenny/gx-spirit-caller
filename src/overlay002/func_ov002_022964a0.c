/* func_ov002_022964a0: brief 230 C-39d — eq-check early + helper(bit0) != 0 tail.
 *
...
int func_ov002_022964a0(struct F022964a0_Self *self) {
    if (func_ov002_021bbf50(1 - self->f2.bit0) == 0) return 0;
