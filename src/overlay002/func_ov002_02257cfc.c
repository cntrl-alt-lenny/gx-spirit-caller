...
extern void *func_ov002_02257464(void *self);
...
int func_ov002_02257cfc(struct Self02257cfc *self, int arg1) {
    int (*fn)(void *, int);
    void *r;
    unsigned short f4;
    f4 = self->field4;
    ...
    }
    {
        ...
        func_ov002_0226af38(1 - b0, 1, 1);
    }
skip:
    self->field4 = self->field4 | 8;
    return 0;
indirect:
    r = func_ov002_02257464(self);
