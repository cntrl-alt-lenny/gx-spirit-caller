/* func_ov002_0220d02c: C-39b sibling of 0220bcdc with different helpers. */
...
extern int func_ov002_021ff400(struct F0220d02c_Self *self, int arg1);

int func_ov002_0220d02c(struct F0220d02c_Self *self, int arg1) {
