/* func_ov002_0228d95c: read cf1a4 u16 and cf16c slot id at (player,idx). If
 * the u16 is nonzero and id==0x118a, return 3. Guard func_0202e2f8(id)!=0
 * -> 2. Else return func_ov002_0227d400(id)!=0. */
struct Ov002Slot {
    unsigned int id : 13;
};
