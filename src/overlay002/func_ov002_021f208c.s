; func_ov002_021f208c — .s escape hatch (brief 290): mwcc is byte-identical except
; the commutative add-operand order below (a CSE'd-temp wall, brief 288).
;   fix [16]: C emits `add lr, ip, lr`; original is `add lr, lr, ip`.
