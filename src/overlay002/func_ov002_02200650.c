/* func_ov002_02200650: C-39d — multi-call re-read with rsb-bit-invert + ternary.
 *
...
extern int func_ov002_02257ab8(struct Func02200650Self *self, unsigned int bit);

int func_ov002_02200650(struct Func02200650Self *self) {
    int n = func_ov002_02257ab8(self, self->f2.bit0);
    if (n < 2) return 0;
    {
        int m = func_ov002_02257ab8(self, 1 - self->f2.bit0);
        return m < 1 ? 0 : 2;
    }
}
