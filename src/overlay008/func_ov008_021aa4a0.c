/* SWAR popcount (no calls, no data refs — pure leaf). Instruction-
 * identical twin of ov017 func_ov017_021b2280 — same C, same recipe.
...
unsigned int func_ov008_021aa4a0(unsigned int x) {
