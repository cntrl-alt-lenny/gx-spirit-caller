/* func_ov000_021aae34: C-42 — multi-call thunk; helper1 result saved in r4,
 ...
 *     bl    func_02006c0c             ; helper1(x, 4, 0)
 *     mov   r4, r0                    ; save helper1 return in r4 (callee-saved)
 *     bl    func_02085074             ; helper2()
...
extern int func_02006c0c(int x, int arg1, int arg2);
extern void func_02085074(void);

int func_ov000_021aae34(int x) {
    int n = func_02006c0c(x, 4, 0);
    func_02085074();
    return n;
}
