/* func_ov019_021b56f8: byte-identical clone of func_ov016_021b5a28 (separate
 * TU in overlay 19). Disables BG0/BG1 of sub-engine DISPCNT, resets their
...
int func_ov019_021b56f8(state_021b56f8_t *p) {
    int enable, kept;
    p->f_8 = 0;
