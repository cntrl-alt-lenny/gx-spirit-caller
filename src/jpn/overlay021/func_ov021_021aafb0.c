/* func_ov021_021aafb0: per-frame sub-state machine (+0x38) with a per-state frame
...
extern void func_ov021_021ab070(void *);
extern void func_ov021_021ab31c(void *);
extern void func_ov021_021ab5e0(void *);
int func_ov021_021aafb0(void *o) {
    switch (*(int *)((char *)o + 0x38)) {
    case 0:
        if (*(int *)((char *)o + 0x40) == 3) {
            func_ov021_021ab070(o);
            *(int *)((char *)o + 0x38) = 1;
            *(int *)((char *)o + 0x40) = 0;
        }
        break;
    case 1:
        func_ov021_021ab31c(o);
