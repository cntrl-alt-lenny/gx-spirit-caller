; func_ov011_021d0be8 — whole-function ship-as-.s (GLOBAL_ASM endgame, brief 302):
...
; For reg-alloc-walled functions with no C match (brief 294 endgame).
        ...
        .extern func_ov011_021d112c
        .extern func_ov011_021d114c
        .global func_ov011_021d0be8
        .arm
func_ov011_021d0be8:
...
.L_30:
    mov r0, r7
    bl func_ov011_021d114c
    cmp r0, #0x0
    beq .L_d0
    mov r0, r7
    bl func_ov011_021d112c
    cmp r0, #0x0
    beq .L_d0
    mov r0, r7
...
_LIT1: .word data_ov011_021d325a
