/* func_ov011_021ca520: two independent field RMWs on the view struct.
...
extern struct View021ca600 data_ov011_021d3f20;

void func_ov011_021ca520(void) {
    data_ov011_021d3f20.f2bc = (data_ov011_021d3f20.f2bc & ~0x3c0000) | 0x40000;
    data_ov011_021d3f20.f2a8 = data_ov011_021d3f20.f2a8 & 0xFFFF0000u;
}
