/* func_ov011_021d1370: build a resource-cfg blob (default: priority
...
extern char data_ov011_021d3eec[];
...
void func_ov011_021d1370(void *selfv, int mode) {
    ...
    case 0:
        cfg.f14 = cfg.f14 | 0x10;
        OS_SPrintf(buf, data_ov011_021d3eec,
                   (unsigned)(*(int *)(self + 0x8) << 13) >> 24);
        cfg.f0 = func_02006bf0(buf, 4, 0);
        break;
    case 1:
        cfg.fc = -1;
        cfg.f8 = -1;
        OS_SPrintf(buf, data_ov011_021d3eec, 1);
        cfg.f0 = func_02006bf0(buf, 4, 0);
        break;
    default:
        break;
