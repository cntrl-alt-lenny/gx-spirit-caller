/* func_ov011_021ca59c: 4-bit field clear at `data_ov011_021d3f20 + 0x2bc`.
 *
 *     ldr r0, .L_021ca690           ; r0 = &data_ov011_021d3f20
 *     ldr r1, [r0, #0x2bc]          ; r1 = *(u32 *)(p + 0x2bc)
 *     bic r1, r1, #0x3c0000         ; clear bits 18..21
 *     str r1, [r0, #0x2bc]
 *     bx  lr
 * .L_021ca690: .word data_ov011_021d3f20
 *
...
void func_ov011_021ca59c(void) {
    data_ov011_021d3f20.flags_2bc &= ~0x3c0000u;
}
