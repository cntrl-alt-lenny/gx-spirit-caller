/* func_ov011_021d0e74: idx-th record (stride 0x28) at data_ov011_021d4580;
...
extern struct Ov011Rec021d0f38 data_ov011_021d4580[];

int func_ov011_021d0e74(int idx, int val) {
    struct Ov011Rec021d0f38 *e = &data_ov011_021d4580[idx];
    u32 v = *(u32 *)&e->f_c;
    if (val == (int)e->f_c.b)
        return v;
    v = (v & ~0xffu) | (val & 0xff);
