/* func_ov002_02291194: brief 227 C-39 wave 2 — two-arg helper, eq-0 bool.
 *
...
struct F022912a4_Self {
    unsigned short f0;
    struct F022912a4_F2 f2;
};

extern int func_ov002_022579d0(struct F022912a4_Self *self, unsigned int bit0);

int func_ov002_02291194(struct F022912a4_Self *self) {
