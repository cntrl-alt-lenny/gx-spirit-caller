/* func_ov002_02201950: brief 228 C-39 wave 3 — helper(bit0, self->f0, 0); bool tail.
 *
...
int func_ov002_02201950(struct F02201a40_Self *self) {
    return func_ov002_02253600(self->f2.bit0, self->f0, 0) >= 5;
}
