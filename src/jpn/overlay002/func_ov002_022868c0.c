/* func_ov002_022868c0: player=1-self->b0; if self->h16 (signed) >= cf16c
...
int func_ov002_022868c0(struct self_t *self)
{
    int player = 1 - self->b0;
    int limit = *(int *)(data_ov002_022cf08c + (player & 1) * 0x868);
