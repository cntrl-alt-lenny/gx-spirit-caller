/* func_ov002_02240dfc: bounds-guarded call. If arg2 >= 5, returns
 * 0; otherwise tail-calls func_ov002_022017dc(r0, r1, r2). The
...
extern int func_ov002_022017dc(int a, int b, int c);

int func_ov002_02240dfc(int a, int b, int c) {
    if (c >= 5) return 0;
