/* func_ov002_02299f3c: u16 table lookup, indexed by (arg << 1).
 *
 *     ldr  r1, .L_0229a05c    ; data_ov002_022ca260
 *     mov  r0, r0, lsl #0x1
 *     ldrh r0, [r1, r0]
 *     bx   lr
 *
...
unsigned short func_ov002_02299f3c(int i) {
    return data_ov002_022ca260[i];
}
