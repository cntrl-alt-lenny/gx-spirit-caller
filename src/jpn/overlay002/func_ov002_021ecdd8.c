/* func_ov002_021ecdd8: read the sub-row f30 up front, require both
 * func_ov002_021c1e10 and (not) func_ov002_021c1d64, the opponent + idx
 * guards, then report whether the cached f30 was set. */
...
int func_ov002_021ecdd8(struct self_t *self, int player, int idx) {
