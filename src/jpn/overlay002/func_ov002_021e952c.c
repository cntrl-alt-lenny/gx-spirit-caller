/* func_ov002_021e952c: idx + f30 guards, reject if func_ov002_021c1d64 holds,
 * then report whether func_ov002_021c1fa4(...,0) holds. */
...
int func_ov002_021e952c(void *self, int player, int idx) {
    struct subrow *sr;
    if (idx >= 5)
        return 0;
