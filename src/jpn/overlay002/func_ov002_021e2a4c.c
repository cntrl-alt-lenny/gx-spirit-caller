/* func_ov002_021e2a4c: per-tick count-UP hub (33 band-callers); sibling of
 * the count-DOWN func_ov002_021e2b6c. Same guard + card-list-slot test; when
 * the slot is in state 2 it fires func_ov002_021b1490(10, -1, &arg, 2) with
...
void func_ov002_021e2a4c(void) {
    unsigned short local;
    if (data_ov002_022ce1a8.f1496 != 0) return;
    if (data_ov002_022d008c.f3340 == 0 ||
        data_ov002_022cd664[data_ov002_022d008c.f3308] != 2) {
        int old = data_ov002_022ce1a8.f1484;
        data_ov002_022ce1a8.f1484 = old + 1;
        if (old != 0) return;
        data_ov002_022ce1a8.f1492 = 0;
        data_ov002_022ce1a8.f1672 = 0;
        data_ov002_022ce1a8.f1488++;
    } else {
        local = 1;
