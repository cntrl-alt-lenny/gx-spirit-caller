/* func_ov002_021e26d0: C-39e variant — bne-skip-helper1 + cross-call compare.
 *
 ...
 *     bl    func_ov002_021c3c10      ; helper1() — only when arg1 == 0
 *     mov   r4, r0                   ; r4 = helper1 result
 *   .L_skip_helper1:
 *     mov   r0, r5                   ; arg = self_thing
 *     bl    func_ov002_021c3be8      ; helper2(self_thing)
 ...
 *     lsr   r1, r1, #16              ; (u16) n
 *     bl    func_ov002_021d46ac      ; helper3(tag, n, 0, 0)
 *     pop   {r3, r4, r5, pc}
 *
...
extern int func_ov002_021c3c10(void);
extern int func_ov002_021c3be8(int self_thing);
extern int func_ov002_021d46ac(unsigned short tag, unsigned short packed,
                                int z0, int z1);

int func_ov002_021e26d0(int self_thing, int arg1) {
    int n;
    if (arg1 == 0) {
        n = func_ov002_021c3c10();
    } else {
        n = arg1;
    }
    {
        int m = func_ov002_021c3be8(self_thing);
        if (n == m) return m;
        {
            unsigned short tag = (unsigned short)(((self_thing ? 0x8000 : 0)) | 0x52);
            return func_ov002_021d46ac(tag, (unsigned short)n, 0, 0);
        }
    }
}
