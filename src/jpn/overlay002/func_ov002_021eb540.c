...
int func_ov002_021eb540(struct Ov002Self *self, int player, int idx) {
    int off;
    ...
    cf1a4_entry = (u16 *)(data_ov002_022cf0c4 + off + idx * 0x14);
    if (*cf1a4_entry == 0) {
        return 0;
    }
    ...
    cf1a2_entry = (u16 *)(data_ov002_022cf0c2 + off + idx * 0x14);
