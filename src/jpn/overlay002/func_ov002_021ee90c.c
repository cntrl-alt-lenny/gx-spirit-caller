/* func_ov002_021ee90c: slot id guard, then arg0->b0 vs player guard, then
 * (idx<5) func_ov002_021b8eec(player,idx) guard, then final cf1a4 u16==0. */
#include "ov002_core.h"

extern int func_ov002_021b8eec(int player, int idx);

int func_ov002_021ee90c(struct Ov002Self *arg0, int player, int idx) {
