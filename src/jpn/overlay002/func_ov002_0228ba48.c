/* func_ov002_0228ba48 (ov002): leaf predicate. self=r0, arg1=r1.
 *   if (arg1 == 0) return 0;
...
int func_ov002_0228ba48(struct S0228bb58 *self, struct S0228bb58 *arg1) {
    unsigned int k;
    if (arg1 == 0) return 0;
    if (arg1->bit0 == self->bit0) return 0;
    k = arg1->k;
    if (k > 4) return 0;
    return *(int *)(data_ov002_022d008c + 0xd0) & 1;
}
