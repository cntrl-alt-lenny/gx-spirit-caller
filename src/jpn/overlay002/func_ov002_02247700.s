; func_ov002_02247700 — whole-function ship-as-.s (GLOBAL_ASM endgame, brief 302):
...
; For reg-alloc-walled functions with no C match (brief 294 endgame).
        ...
        .extern func_ov002_02246d74
        .extern func_ov002_02246de4
        .extern func_ov002_02246e80
        .extern func_ov002_02246f34
        .extern func_ov002_02246fdc
        .global func_ov002_02247700
        .arm
func_ov002_02247700:
...
.L_284:
    ...
    mov r0, r2, lsr #0x1f
    mov r1, r1, lsr #0x13
    bl func_ov002_02246e80
    ldrh r1, [sl, #0x2]
    mov r6, r0
    mov r0, r1, lsl #0x1f
    mov r0, r0, lsr #0x1f
    bl func_ov002_02246f34
    ldr r1, [r4, r5, lsl #0x2]
    add r0, r6, r0
    cmp r0, r1, lsr #0x1a
    movge r0, #0x1
