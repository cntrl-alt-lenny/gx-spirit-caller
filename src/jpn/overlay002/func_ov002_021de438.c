...
extern int func_ov002_021de044(int self, int mask, int cmd, int two);

int func_ov002_021de438(int self, int player, int idx) {
    ...
    return func_ov002_021de044(self, mask, cmd, 2) != 0;
}
