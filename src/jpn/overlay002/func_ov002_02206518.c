/* func_ov002_02206518: C-39e variant — bit-equality test + helper-branch.
 *
 ...
 *     ldrh  r0, [r4]
 *     bl    func_0202e1e0            ; helper(arg1->f0)
 *     cmp   r0, #0
 ...
 *   .L_tail:
 *     mov   r0, r4
 *     bl    func_ov002_021b4b04      ; helper2(arg1)
 *     pop   {r4, pc}
 *
...
extern int func_ov002_021b4b04(struct Func02206608Self *self);

int func_ov002_02206518(struct Func02206608Self *self,
                         struct Func02206608Self *arg1) {
    if (arg1 == 0) return 0;
    if (arg1->f2.bit0 == self->f2.bit0) return 0;
    if (func_0202e1e0(arg1->f0) == 0 && arg1->f2.field2 != 0) return 0;
    return func_ov002_021b4b04(arg1);
}
