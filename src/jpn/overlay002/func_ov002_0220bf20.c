/* func_ov002_0220bf20: brief 236 C-39e — arg1-only variant (self unused).
 *
 * Orig (60 B):
 ...
 *   mov r0, r4
 *   bl func_ov002_021b6520     ; helper2(arg1)
 *   cmp r0, #0
 *   movne r0, #1
 *   moveq r0, #0
 *   pop {r4, pc}
...
extern int func_ov002_021b6520(struct F0220c010_Arg *arg1);

int func_ov002_0220bf20(int self_unused, struct F0220c010_Arg *arg1) {
    (void)self_unused;
    if (arg1 == 0) return 0;
    if (func_0202b824(arg1->f0) != 23) return 0;
    return func_ov002_021b6520(arg1) != 0;
}
