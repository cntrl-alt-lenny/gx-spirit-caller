/* func_ov002_0220e018: C-39f bit-0-indexed table lookup (gotcha 14).
...
extern int func_ov002_022015cc(struct S0220e108 *self, int arg1, int v);
int func_ov002_0220e018(struct S0220e108 *self, int arg1) {
    unsigned int v = *(unsigned int *)(data_ov002_022cf09c + (self->bit0 & 1) * 0x868);
    if (v == 0) return 0;
    return func_ov002_022015cc(self, arg1, (int)v);
}
