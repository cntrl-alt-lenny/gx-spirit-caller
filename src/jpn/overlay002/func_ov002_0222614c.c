/* func_ov002_0222614c: brief 234 — helper(1-bit0, f0, 17, 0); return 0.
 *
...
int func_ov002_0222614c(struct F0222623c_Self *self) {
    func_ov002_021e267c(1 - self->f2.bit0, self->f0, 17, 0);
    return 0;
}
