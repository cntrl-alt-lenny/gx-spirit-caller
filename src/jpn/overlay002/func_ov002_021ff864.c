/* func_ov002_021ff864: C-39 — early-return 1 if the 6-bit field at
...
extern int func_ov002_021ff1c8(struct S021ff954 *self, int arg);

int func_ov002_021ff864(struct S021ff954 *self) {
    if (self->b6_11 == 2) return 1;
    return func_ov002_021ff1c8(self, 1 - self->bit0) != 0;
}
