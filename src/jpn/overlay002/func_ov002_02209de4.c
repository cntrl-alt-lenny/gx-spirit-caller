/* func_ov002_02209de4: C-39d 021ca2b8 predicate — require 021ca2b8(bit0) and
...
extern int func_ov002_02253600(unsigned int bit, unsigned int f0, int z);

int func_ov002_02209de4(struct Func02209ed4Self *self) {
    if (func_ov002_021ca1d8(self->f2.bit0) == 0)
        return 0;
    if (func_ov002_021bc7e8(self->f2.bit0, self->f2.bit0, self->f2.field5) == 0)
        return 0;
    if (func_ov002_02253600(self->f2.bit0, self->f0, 0) != 0)
        return 2;
    return 0;
}
