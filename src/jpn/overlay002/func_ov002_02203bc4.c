/* func_ov002_02203bc4: gate chain -- D016C.f_cec-derived row selector
...
int func_ov002_02203bc4(struct Ov002Self *self) {
    ...
    if (kind == 13 && row_idx == self->b0) {
        if (*(int *)(row + 8) != 0) {
            ...
            if (a < b) {
                int p0 = *(int *)data_ov002_022cd314;
                int p1 = *(int *)(data_ov002_022cd314 + 0x1c);
                if (func_ov002_021c1d64(self, p0, p1) == 0) {
                    return 1;
                }
            }
        }
