/* func_ov002_02206578: C-39b tag-check early-return + cross-call compare.
 *
...
extern int func_ov002_021f40a4(struct F02206668_Self *self);

int func_ov002_02206578(struct F02206668_Self *self) {
    int n;
    if (self->f2.tag6 == 0x23) return 1;
    n = func_ov002_021c2418(self->f2.bit0);
