...
extern int func_ov002_022574e0(struct Ov002Self *self, int bit0, int k);
extern int func_0202e274(int id);

int func_ov002_02295328(struct Ov002Self *self) {
    int k;
    for (k = 0; k <= 4; k++) {
        u16 s2 = *(u16 *)((char *)self + 2);
        int bit0 = (int)(((unsigned int)(s2 << 31)) >> 31);
        if (func_ov002_022574e0(self, bit0, k) != 0) {
            u16 s2b = *(u16 *)((char *)self + 2);
            int bit0b = (int)(((unsigned int)(s2b << 31)) >> 31) & 1;
            char *row = (char *)data_ov002_022cf08c + bit0b * 0x868;
