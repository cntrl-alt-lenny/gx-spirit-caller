/* func_ov002_022236b0: C-39a variant — sign-check via dead-arg
 ...
 *     rsb   r0, r0, #1                 ; r0 = !bit0
 *     bl    func_ov002_021d7880       ; helper2(!bit0, n, 1)
 *   .end:
 *     mov   r0, #0
 *     pop   {r4, pc}
 *
...
extern int func_ov002_021b99c8(unsigned int not_bit, unsigned int field9);
extern void func_ov002_021d7880(unsigned int not_bit, int n, unsigned int one);

int func_ov002_022236b0(struct Func022237a0Self *self) {
    int n = func_ov002_021b99c8(1 - self->f2.bit0, self->f14.field9);
    if (n >= 0) {
        func_ov002_021d7880(1 - self->f2.bit0, n, 1);
    }
    return 0;
}
