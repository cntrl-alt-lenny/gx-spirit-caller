/* func_ov002_021b3b30: search the d0650 node chain (start id in idx) for the
...
void *func_ov002_021b3b30(int idx, int key)
{
    struct LNodeC10 *p;

    while (idx != 0) {
        p = (struct LNodeC10 *)(data_ov002_022d0570 + idx * 8);
        idx = p->next;
