/* func_ov002_02209d60: C-39 — if b6_11==6, return (unsigned)helper(bit0,
...
int func_ov002_02209d60(struct S9e50 *self) {
    if (self->b6_11 == 6) {
        return (unsigned int)func_ov002_02253600(self->bit0, self->f0, 0) >= self->b18_19;
    }
    return 0;
}
