/* func_ov002_022005e0: map arg0[0] to a threshold (3/2/1), derive a player
 * from bit14^bit0 of arg0[1], and compare data_ov002_022cf09c's per-player
...
int func_ov002_022005e0(u16 *arg0) {
    int threshold;
    int player;
    int count;
    ...
    count = *(int *)((char *)data_ov002_022cf09c + player * 0x868);
