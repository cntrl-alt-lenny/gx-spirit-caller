/* func_ov002_0220859c: C-42 — single helper + fn-pointer arg + bool-from-cmp tail.
 *
 * Orig shape (32 B, 7 ARM insns + 1 pool word):
 *
 *     push  {r3, lr}
 *     ldr   r1, [pc, #16]             ; r1 = &func_ov002_021e95b0 (fn ptr)
 *     bl    func_ov002_02257790       ; helper(x, fn)
 *     cmp   r0, #0
 *     movgt r0, #1                    ; bool: result > 0
 *     movle r0, #0
 *     pop   {r3, pc}
 *     .word func_ov002_021e95b0
 *
...
extern int func_ov002_02257790(int x, void *fn);
extern int func_ov002_021e95b0(void);

int func_ov002_0220859c(int x) {
    return func_ov002_02257790(x, (void *)func_ov002_021e95b0) > 0;
}
