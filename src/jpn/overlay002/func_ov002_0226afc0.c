 ...
 *   confidence: high
 */
/* func_ov002_0226afc0: u16-zext two-arg tail-call shim, selector 0x12.
 * Same shape as af38 (mov r1,#0x12) with BOTH args zext'd (vs b094's single).
 * func_ov002_0226ac08(arg0, 0x12, (u16)arg1, (u16)arg2). */

typedef unsigned short u16;

extern void func_ov002_0226ac08(int a, int sel, u16 c, u16 d);

void func_ov002_0226afc0(int arg0, int arg1, int arg2) {
    func_ov002_0226ac08(arg0, 0x12, (u16)arg1, (u16)arg2);
}
