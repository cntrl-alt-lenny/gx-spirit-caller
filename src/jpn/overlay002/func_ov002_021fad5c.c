/* func_ov002_021fad5c: C-39b 2-helper sequence (no compare).
 *
 * Orig (48 B, 12 ARM insns):
 *   stmdb sp!, {r4, lr}
 *   mov   r4, r0
 *   bl    func_ov002_021f495c       ; helper1(self)
 *   ldrh  r0, [r4, #0x2]
 ...
 *   bl    func_ov002_021d92f0       ; helper2(bit0, multi5)
 *   mov   r0, #0x1
 *   pop   {r4, pc}
 *
...
extern int func_ov002_021f495c(struct F021fae4c_Self *self);
extern int func_ov002_021d92f0(unsigned int bit, unsigned int multi, int sentinel);

int func_ov002_021fad5c(struct F021fae4c_Self *self) {
    func_ov002_021f495c(self);
    func_ov002_021d92f0(self->f2.bit0, self->f2.multi5, ~0);
    return 1;
}
