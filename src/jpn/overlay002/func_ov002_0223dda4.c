/* func_ov002_0223dda4: read a (bit0, bits1-4) pair out of a u16 slot
 * (leaf, 27 band-callers). For arg1 in [0,5) the slot is arg0->arr8[arg1];
 * otherwise it indexes the shared data_ov002_022ce640 table at
...
extern u16 data_ov002_022ce640[];

u16 func_ov002_0223dda4(struct node *arg0, int arg1) {
    VBits *p;
    if (arg1 < 5) {
        p = (VBits *)&arg0->arr8[arg1];
    } else {
        int idx = (arg0->f18 + arg1 - 5) % 128;
        p = (VBits *)&data_ov002_022ce640[idx];
    }
