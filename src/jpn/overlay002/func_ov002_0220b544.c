...
extern int func_ov002_02253600(int a, unsigned short b, int c);

int func_ov002_0220b544(S0220b634 *self, int arg1) {
    if (arg1 != 0) {
        return 0;
    }
    if (data_ov002_022d008c.f_cec != self->b0) {
        return 0;
    }
    if (data_ov002_022d008c.f_cf8 != 2 && data_ov002_022d008c.f_cf8 != 4) {
        return 0;
    }
