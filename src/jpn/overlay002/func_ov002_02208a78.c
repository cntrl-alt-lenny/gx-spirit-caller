/* func_ov002_02208a78: C-39b 4-arg helper with literal + tail-call.
 *
...
extern int func_ov002_02208b0c(struct F02208b68_Self *self, int arg1);

int func_ov002_02208a78(struct F02208b68_Self *self, int arg1) {
    if (func_ov002_021b3fb8(self->f2.bit0, self->f2.multi5, 0x17d2) == 0) return 0;
