/* func_ov002_022925c0: brief 228 C-39 wave 3 — helper(bit0, 0); bool tail.
 *
...
extern int func_ov002_0227d570(unsigned int bit0, unsigned int k);

int func_ov002_022925c0(struct F022926d0_Self *self) {
