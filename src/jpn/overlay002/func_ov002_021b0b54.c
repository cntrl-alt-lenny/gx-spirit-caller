/* func_ov002_021b0b54: C-42 — multi-call thunk with conditional helper2 +
 * literal args.
 *
 * Orig shape (32 B, 8 ARM insns):
 *
 *     push  {r3, lr}
 *     bl    func_ov002_0226e37c       ; r0 = helper1()
 *     cmp   r0, #0
 *     popeq {r3, pc}                  ; if helper1==0, return 0 (r0 still 0)
 *     mov   r0, #26
 *     mov   r1, #1
 *     bl    func_ov002_021b0b24       ; helper2(26, 1)
 *     pop   {r3, pc}
 *
...
extern int func_ov002_0226e37c(void);
extern int func_ov002_021b0b24(int arg0, int arg1);

int func_ov002_021b0b54(void) {
    int r = func_ov002_0226e37c();
    if (r == 0) return r;
    return func_ov002_021b0b24(26, 1);
}
