; func_ov002_022759c4 — whole-function ship-as-.s (GLOBAL_ASM endgame, brief 302):
...
.L_120:
    ...
    mov r1, r6
    mov r2, r5
    bl func_ov002_02275770
    ldmia sp!, {r3, r4, r5, r6, r7, pc}
.L_134:
    mov r0, r7
    mov r1, r6
    mov r2, r5
    bl func_ov002_02275848
    ldmia sp!, {r3, r4, r5, r6, r7, pc}
.L_148:
    mov r0, r7
    mov r1, r6
    mov r2, r5
    bl func_ov002_02275924
    ldmia sp!, {r3, r4, r5, r6, r7, pc}
.L_15c:
    mov r0, #0x0
    ldmia sp!, {r3, r4, r5, r6, r7, pc}
