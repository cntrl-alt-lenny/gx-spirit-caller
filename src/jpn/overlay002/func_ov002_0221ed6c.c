/* func_ov002_0221ed6c: C-39b sibling of 0220bcdc with different tail. */
...
extern int func_ov002_02210014(struct F0221ee5c_Self *self, int arg1);

int func_ov002_0221ed6c(struct F0221ee5c_Self *self, int arg1) {
