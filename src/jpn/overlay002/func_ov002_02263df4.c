/* func_ov002_02263df4: thunk — `func_ov002_02263d04` with r1 = 0x1619.
 *
...
int func_ov002_02263df4(int a, int _unused, int c, int d) {
    return func_ov002_02263d04(a, 0x1619, c, d);
}
