/* func_ov002_0220b5ec: C-39f bit-0-indexed table lookup (gotcha 14).
...
extern int func_ov002_021ff310(struct S0220b6dc *self, int arg1, int v);
int func_ov002_0220b5ec(struct S0220b6dc *self, int arg1) {
    unsigned int v = *(unsigned int *)(data_ov002_022cf09c + ((1 - self->bit0) & 1) * 0x868);
    if (v < 2) return 0;
    return func_ov002_021ff310(self, arg1, (int)v);
}
