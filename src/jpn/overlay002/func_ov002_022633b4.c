/* func_ov002_022633b4: thunk — `func_ov002_02262fc8` with r1 = 0x1643.
 *
...
int func_ov002_022633b4(int a, int _unused, int c, int d) {
    return func_ov002_02262fc8(a, 0x1643, c, d);
}
