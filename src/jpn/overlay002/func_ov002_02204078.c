/* func_ov002_02204078: C-39 + XOR of two bitfields (gotcha 4 — bit0
...
extern int func_ov002_021bc7e8(int x, int bit0, int b1_5);

int func_ov002_02204078(struct S02204168 *self) {
    return func_ov002_021bc7e8(self->bit0 ^ self->bit14, self->bit0,
                               self->b1_5) != 0;
}
