/* func_ov002_02295174: C-39d disjunction — helper(bit0, T1) || helper(bit0, T2).
 *
...
extern int func_ov002_021c3a04(unsigned int bit, int t);

int func_ov002_02295174(struct Func02295284Self *self) {
    return func_ov002_021c3a04(self->f2.bit0, 0x1181) ||
           func_ov002_021c3a04(self->f2.bit0, 0x179a);
}
