/* func_ov002_021f8670: C-39b helper-reuse + conditional 2nd helper.
 *
 ...
 *   bl    func_ov002_021d58dc        ; helper2(bit0, multibit, 0x16cb, 2)
 *  .L_021f87a0:
...
extern int func_ov002_021f4994(struct F021f8760_Self *self);
extern int func_ov002_021d58dc(unsigned int bit, unsigned int multi, int tag, int mode, int extra);

int func_ov002_021f8670(struct F021f8760_Self *self) {
    int r = func_ov002_021f4994(self);
    if (r == 1) {
        func_ov002_021d58dc(self->f2.bit0, self->f2.multi, 0x16cb, 2, 0);
    }
    return r;
}
