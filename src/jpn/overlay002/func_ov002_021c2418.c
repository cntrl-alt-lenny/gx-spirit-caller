/* func_ov002_021c2418: sum func_ov002_021b9d20(arg0, j) over slots 0..10
 * whose id (13-bit at slot+0x30) and flag (u16 at slot+0x38) are both set. */
struct Ov002Slot { unsigned int id : 13; };
extern char data_ov002_022cf08c[];
extern int func_ov002_021b9d20(int player, int idx);

int func_ov002_021c2418(int arg0) {
    int j;
    int sum = 0;
    ...
    for (j = 0; j <= 10; j++, r6 += 0x14, r7 += 0x14) {
        ...
        if (id13 != 0 && *(unsigned short *)(r7 + 0x38) != 0) {
            sum += func_ov002_021b9d20(arg0, j);
        }
    }
    return sum;
}
