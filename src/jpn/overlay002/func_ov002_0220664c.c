/* func_ov002_0220664c: C-39b idiom 2 (cross-call compare) + helper3 tail.
 *
 ...
 *     lsl/lsr #31                      ; bit0
 *     bl    func_ov002_021c2418       ; helper1(bit0)
 ...
 *     mov   r0, r6                    ; r0 = self
 *     mov   r1, r5                    ; r1 = arg1
 *     bl    func_ov002_021ff310       ; helper3(self, arg1)
 *     pop   {r4, r5, r6, pc}
 *
...
extern int func_ov002_021c2418(unsigned int bit);
extern int func_ov002_021f40a4(struct Func0220673cSelf *self);
extern int func_ov002_021ff310(struct Func0220673cSelf *self, int arg);

int func_ov002_0220664c(struct Func0220673cSelf *self, int arg1) {
    int n = func_ov002_021c2418(self->f2.bit0);
    if (n < func_ov002_021f40a4(self)) return 0;
