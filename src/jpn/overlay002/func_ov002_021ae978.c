/* func_ov002_021ae978: helper + 2 stores at pool-loaded global.
 *
 *     push  {r3, lr}
 *     bl    helper
 *     ldr   r1, [pc, #16]        ; r1 = pool addr (&data_ov002_022d008c)
 *     mov   r0, #0
 *     str   r0, [r1, #0xcf4]
 *     mov   r0, #1
 *     str   r0, [r1, #0xd04]
...
extern struct FuncOv002021aea58PoolStruct data_ov002_022d008c;
extern void func_ov002_021ae7bc(void);

int func_ov002_021ae978(void) {
    func_ov002_021ae7bc();
    data_ov002_022d008c.f3316 = 0;
    data_ov002_022d008c.f3332 = 1;
    return 1;
}
