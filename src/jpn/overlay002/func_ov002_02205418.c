/* func_ov002_02205418: C-39f bit-0-indexed table lookup (gotcha 14).
...
extern int func_ov002_021ff2cc(struct S02205508 *self, int arg1, int v);
int func_ov002_02205418(struct S02205508 *self, int arg1) {
