/* func_ov002_02242d48: switch-dispatch on u16 field.
 *
 *     push  {r3, lr}
 *     ldrh  r2, [r0, #12]
 *     cmp   r2, #2
...
extern int func_ov002_0223f59c(struct FuncOv00202242e30Self *self, int arg);

int func_ov002_02242d48(struct FuncOv00202242e30Self *self, int arg) {
    switch (self->f12) {
    case 2:
        return func_ov002_0223f59c(self, arg);
    default:
        return 1;
    }
}
