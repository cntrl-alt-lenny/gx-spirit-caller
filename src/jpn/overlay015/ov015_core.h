 ...
 *   data_ov015_021b5d24 (18 refs) — base/table holder (+0xa78 table, +0xa7c base)
 *   data_ov015_021b5d08 (17 refs) — companion flags (+0xa94 guard)
 */
#ifndef OV015_CORE_H
#define OV015_CORE_H
 ...
 * data_ov015_021b5d24 (and /28) MANY times across calls; the orig keeps the base
 * in a callee-saved reg (r4/r5) loaded ONCE up front, but a direct
 * `data_ov015_021b5d24 + off` reference reloads it each time → big diff (021b4740
 * was 22%→100%, 021b3614 88%→100%, like wave-1 021b35d0). Always `char *s =
 * data_ov015_021b5d24;` at the top. See [[ ov005_core.h reshape recipe ]].
 *
