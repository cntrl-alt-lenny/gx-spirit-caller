; func_ov015_021b3f44 — whole-function ship-as-.s (GLOBAL_ASM endgame, brief 302):
...
; For reg-alloc-walled functions with no C match (brief 294 endgame).
        ...
        .extern func_ov015_021b3140
        .extern func_ov015_021b3180
        .extern func_ov015_021b3420
        .global func_ov015_021b3f44
        .arm
func_ov015_021b3f44:
...
.L_1f4:
    ...
    sub r2, r1, #0x1
    mov r1, #0x0
    bl func_ov015_021b3140
    mov r2, r8
    mov r3, r7
    add r0, r4, #0x880
    mov r1, #0x1000
    bl func_ov015_021b3180
    add r5, r5, r0
.L_22c:
    mov r0, r5
    add sp, sp, #0x8
