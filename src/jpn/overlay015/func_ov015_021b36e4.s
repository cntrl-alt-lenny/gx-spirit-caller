; func_ov015_021b36e4 — whole-function ship-as-.s (GLOBAL_ASM endgame, brief 302):
...
; For reg-alloc-walled functions with no C match (brief 294 endgame).
        ...
        .extern func_ov015_021b2cb8
        .extern func_ov015_021b2cdc
        .extern func_ov015_021b2ff0
        .extern func_ov015_021b3514
        .extern func_ov015_021b3618
        .extern func_ov015_021b3db4
        .global func_ov015_021b36e4
        .arm
func_ov015_021b36e4:
    ...
    mov r0, r6
    mov r2, r1
    bl func_ov015_021b3db4
    str r0, [sp, #0x8]
    ldrh r0, [r5]
    mov r1, #0x0
    mov r0, r0, lsl #0x18
    mov r0, r0, lsr #0x18
    bl func_ov015_021b3514
    mov r6, r0
    mov r1, #0x4
    mov r2, #0x0
    bl Task_PostLocked
...
_LIT1: .word data_ov015_021b5d08
_LIT2: .word data_ov015_021b6760
_LIT3: .word data_02104e6c
_LIT4: .word data_ov015_021b6708
