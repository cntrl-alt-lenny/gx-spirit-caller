/* func_ov015_021b2248: save-restore wrapper — passes the caller's
 * arg to func_ov005_021aa3cc, then returns the arg unchanged.
 * Overlay-swap sibling of func_ov010_021b2248 (same 0x021b2348 address,
...
void *func_ov015_021b2248(void *x) {
