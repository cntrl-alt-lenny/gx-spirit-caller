...
/* --- dominant data bases ------------------------------------------------ */
extern char data_ov014_021b4f40[];  /* scene lock/state: +0x44 transition lock */
extern char data_ov014_02234f94[];  /* pane-A controller struct                */
extern char data_ov014_02234ff4[];  /* pane-B controller struct                */
