...
/* --- dominant data bases ------------------------------------------------ */
extern char data_ov007_021b2fb8[];  /* slot-descriptor table (row 0x20, col 4) */
extern char data_ov007_0223342c[];  /* work block A controller                 */
extern char data_ov007_022333d0[];  /* work block B controller                 */
