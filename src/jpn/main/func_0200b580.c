/* CAMPAIGN-PREP candidate for func_0200b580 (main, class A) — brief 494.
 ...
 *   confidence: med
 */
/* func_0200b580 — alloc a 0x18 task, zero it, then store six fields (base+off and plain). */
