/* CAMPAIGN-PREP candidate for func_0204591c (main, class A) — brief 494.
 ...
 *   confidence: med
 */
/* func_0204591c: return index of first zero halfword in arr (count of leading
...
int func_0204591c(unsigned short *arr) {
    int i;
