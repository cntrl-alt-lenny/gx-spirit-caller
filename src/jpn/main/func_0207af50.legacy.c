...
extern void func_0209336c(void *p, unsigned int magic, int zero1, void *fn, int zero2);
extern void func_0207aeb8(void);

extern void *data_021a07ac;

void func_0207af50(int a0) {
    int irq = OS_DisableIrq();
    char *base = (char *)data_021a07ac;

    if (*(int *)(base + 0x2000 + 0x260) == 9 && a0 != 9) {
        func_020933bc(base + 0x22cc);
    }

    base = (char *)data_021a07ac;
    ...
    if (a0 == 9) {
        base = (char *)data_021a07ac;
        func_0209336c(base + 0x22cc, 0x022f5341, 0, (void *)func_0207aeb8, 0);
    }
