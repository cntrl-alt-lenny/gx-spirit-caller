/* func_0203c554: sibling of func_0203c594 — same interpolation setup,
 ...
 *
 * Differences from func_0203c594: the `movs r4, r0` combines the
...
void func_0203c554(anim_outer_a0_t *outer, int target, unsigned short frames) {
    int target_q24_8;
    int step;
