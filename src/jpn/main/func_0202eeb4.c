/* CAMPAIGN-PREP candidate for func_0202eeb4 (main, class A) — brief 494.
 ...
 *   confidence: high
 */
/* func_0202eeb4: 3-way membership test. mwcc factors the common base
