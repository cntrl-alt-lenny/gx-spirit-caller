/* CAMPAIGN-PREP candidate for func_0200eed4 (main, class A) — brief 494.
 ...
 *   confidence: high
 */
/* func_0200eed4: like func_0200ee8c but a flag (a2==1) gates the
 * func_0200ed9c dispatch, and on a non-null result with a non-null
...
int func_0200eed4(void *o, void *src, int flag) {
