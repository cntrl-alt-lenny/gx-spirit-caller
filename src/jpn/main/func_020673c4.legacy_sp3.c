/* func_020673c4: periodic tick/update handler gated on a "now" value
 * from func_020552bc(a). Returns immediately if a->field_0 == -1.
 * Otherwise decides between 3 mutually-exclusive func_02065f9c(a,mode)
...
extern int func_020552bc(Obj_02067438_t *a);
extern int func_02065f9c(Obj_02067438_t *a, int mode);
extern int func_020661b0(Obj_02067438_t *a);
extern int data_021016b8;

int func_020673c4(Obj_02067438_t *a) {
    int now = func_020552bc(a);
    ...
    a->field_b8 = 0;
    return a->field_9c(5, &data_021016b8, a->field_10c);
