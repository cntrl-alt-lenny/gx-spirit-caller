/* func_0203ed84: template-init an output record, copy two words from a0,
...
extern int func_0203ed30(void *a0);
extern int func_0203ecdc(int a0);

extern unsigned char data_020beb98[0x58];
...
void func_0203ed84(struct S0203edd4_A0 *a0, struct S0203edd4_A1 *a1, struct S0203edd4_A2 *a2) {
    struct S0203edd4_Entry *entry;
    unsigned int v;

    func_02094688(data_020beb98, a2, 0x58);
    a2->f_4 = a0->f_0;
    a2->f_8 = a0->f_4;
    ...
    if (entry->f_c0 != 0) {
        a2->f_c = 0;
        a2->f_10 = func_0203ed30(&entry->f_c0);
        a2->f_14 = func_0203ecdc(entry->f_d0);
        a2->f_18 = func_0203ed30(&entry->f_c4);
        a2->f_1c = func_0203ed30(&entry->f_c8);
        a2->f_20 = func_0203ed30(&entry->f_cc);
    } else {
        a2->f_c = 1;
        a2->f_10 = 0;
        a2->f_14 = 0;
