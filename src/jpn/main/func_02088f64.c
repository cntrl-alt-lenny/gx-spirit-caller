 ...
 *     str r1, [r0, #0x4]
 *     bx  lr
 *  .L_02089068: .word data_021a5720
 *
 * **C-2 trick**: cache `p` to a local before the two reads, so
 * mwcc emits a single `&data_021a5720` materialisation followed
