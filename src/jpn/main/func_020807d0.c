/* CAMPAIGN-PREP candidate for func_020807d0 (main, class D, MED tier) — brief 496.
 ...
 *   confidence: med
 */
/* func_020807d0: scatter the marshalled arg block into a struct in the asm's
...
void func_020807d0(Rec *dst, int a, int b, int c, int p0, int p4, int p8, int pc, int p10) {
    dst->f4 = b;
    dst->f8 = c;
