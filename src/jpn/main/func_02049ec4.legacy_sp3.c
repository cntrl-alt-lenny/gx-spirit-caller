/* func_02049ec4: 2x same-helper-returns-ptr + 2 field writes (mwcc 1.2/sp3).
 *
 *     push  {r4, r5, lr}
 *     sub   sp, sp, #4
 *     mov   r5, r0
...
extern struct Func02049f38Target *func_0204987c(void);

void func_02049ec4(int arg0, unsigned short arg1) {
    func_0204987c()->f28 = arg0;
    func_0204987c()->f26 = arg1;
}
