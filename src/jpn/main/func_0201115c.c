/* CAMPAIGN-PREP candidate for func_0201115c (main, class A) — brief 494.
 ...
 *   confidence: high
 */
/* func_0201115c: copy a 0x30-byte (12-word) struct from src to dst;
...
void func_0201115c(Rec12 *src, Rec12 *dst) {
    *dst = *src;
}
