/* func_020213d8 — C-34 re-audit. Duplicate-pool shape (data_02194260):
 ...
 * src/main/func_0202a178.c). Role assignment matters for scheduling: a
...
int func_020213d8(Arg0202142c *arg0)
{
