/* CAMPAIGN-PREP candidate for func_020688f8 (main, class D, MED tier) — brief 496.
 ...
 *   confidence: high
 */
/* func_020688f8 @ 0x0206896c  (cls D, main) — load u16 field at +0xC, byteswap the two
