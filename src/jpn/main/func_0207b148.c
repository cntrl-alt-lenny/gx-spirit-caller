/* CAMPAIGN-PREP candidate for func_0207b148 (main, class A) — brief 494.
 ...
 *   confidence: high
 */
/* func_0207b148: write the constant 0x00AAA082 into the global singleton's
 * field at byte offset 0x2264.
 *
 *   ldr base; ldr [base]; add #0x2000; str #0xaaa082 -> [.,#0x264]
 *   -> (*data_021a07ac)->field_2264 = 0xaaa082;
 */
...
extern Singleton3 *data_021a07ac;

void func_0207b148(void) {
    data_021a07ac->field_2264 = 0xaaa082;
}
