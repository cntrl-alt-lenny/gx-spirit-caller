/* func_02096340: write a per-slot value AND mirror its truthiness as a
 ...
 *     ldr   r1, .L_SLOT_TABLE     ; r1 = &data_021a81a8
 *     cmp   r5, #0
 ...
 *     ldmfd sp!, {r4, r5, lr}
 *     bx    lr
 *   .L_SLOT_TABLE:        .word data_021a81a8
 ...
 * example (`func_0208bcf8`) shipped via the same `.legacy.c` route.
 *
 ...
 *
 * Companion ops: `data_021a81a8` is a 32-slot BSS int array of
...
extern int  data_021a81a8[];

void func_02096340(int slot, int value) {
