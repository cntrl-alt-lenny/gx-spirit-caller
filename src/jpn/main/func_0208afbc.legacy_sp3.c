/* func_0208afbc: 4-field-write thunk with helper.
 *
 *     push  {r4, r5, r6, lr}
 *     mov   r6, r0
 *     mov   r5, r1
...
extern int func_0208af88(struct Func0208b0a4Self *self);

void func_0208afbc(struct Func0208b0a4Self *self, int arg1, int arg2) {
    self->f0 = func_0208af88(self);
    self->f4 = arg1;
    self->f12 = arg2;
    self->f8 = 0;
}
