/* func_0203c594: first medium-tier match — interpolation-setup helper.
 *
 ...
 *
 *   func_0203c594 (this file, 0x3c) — direct call on a struct pointer.
 *   func_0203c554 (0x40)            — same logic on a struct embedded
 *                                     at offset 0xa0 inside a larger
 *                                     outer object, with a NULL-check.
 *   func_02037c04 (0x4c)            — indexed-table variant (table
...
void func_0203c594(anim_linear_t *obj, int target, unsigned short frames) {
