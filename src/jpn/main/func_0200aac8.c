 ...
 *     bl    func_0200aa44          ; r0 still = 0x2f07
 *     mov   r0, #0x0
 *     ldmia sp!, {r3, pc}
 ...
 * in the bl targets):
 *   main|0x0200aae4 → bl func_0200852c + bl func_0200aa44
 *   main|0x0200ab28 → bl func_020085c8 + bl func_0200aa44
 *   main|0x0200ab6c → bl func_0200886c + bl func_0200aa44
 *
...
extern state_0200aae4_t data_02104acc;
extern int func_0200852c(state_0200aae4_t *p);
extern void func_0200aa44(int mask);

int func_0200aac8(void) {
    if (data_02104acc.flags & 0x8) {
        func_0200852c(&data_02104acc);
        return 1;
    }
