/* func_0208bcf8: 32-bit signed integer divide using the DS hardware
 ...
 *
 * 18 insns + 4 pool words = 0x58 bytes. Companion to func_0208bca0, which
...
int func_0208bcf8(int numer, int denom) {
