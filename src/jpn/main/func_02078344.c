/* CAMPAIGN-PREP candidate for func_02078344 (main, class A) — brief 494.
 ...
 *   confidence: high
 */
/* func_02078344: arg-swap tail-call veneer to func_02094688 (memcpy).
...
void *func_02078344(const void *src, void *dst, int n) {
