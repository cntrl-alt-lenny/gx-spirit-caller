/* func_02035184: 5-argument pass-through forwarder — all args in r0..r3
 * plus one stack arg, forwarded verbatim to func_02034d08.
 *
 ...
 *                                    ; callee's arg 5 slot
 *     bl    func_02034d08            ; r0..r3 pass through unchanged
 *     ldmia sp!, {r3, pc}
 *
...
extern void func_02034d08(int a, int b, int c, int d, int e);

void func_02035184(int a, int b, int c, int d, int e) {
    func_02034d08(a, b, c, d, e);
}
