/* func_020547cc: forwards to func_0205468c, inserting a constant `4`
...
extern void func_0205468c(int a0, int a1, int a2, int a3, int a4, int a5);

asm void func_020547cc(void) {
    nofralloc
    stmfd sp!, {lr}
    sub sp, sp, #0xc
    ldr ip, [sp, #0x10]
