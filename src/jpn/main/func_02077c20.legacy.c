/* func_02077c20: IRQ-guarded linear scan of a 4-entry, 0x5c-stride
 * table (data_021a063c) for an active (f5a!=0) entry matching
 * (f54==param1, f58==param2). On match, copies 2 sub-regions in from
 * param0, stamps a tick-derived value at +0x50, and flags param0->
 * 0x30. Same func_02092fc8()>>16 truncation idiom as func_02073838.
 */
...
extern Entry02077d08 data_021a063c[4];

void func_02077c20(void *param0, int param1, int param2) {
    ...
    do {
        Entry02077d08 *e = &data_021a063c[i];
