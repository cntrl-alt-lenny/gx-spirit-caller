/* CAMPAIGN-PREP candidate for func_0202f418 (main, class B) — brief 494.
 ...
 *   confidence: med
 */
/* func_0202f418 — range jump-table membership + two singleton compares */
int func_0202f418(int x) {
    switch (x) {
    case 0x1a90:
    case 0x1a91:
    case 0x1a92:
