/* func_020210c8 — C-34 re-audit. First attempt (plain if/else-if chain on
 ...
 * (src/main/func_0202a178.c: `int *raw = (int *)0x0219a934;`) -- a second
...
extern void func_02021674(int *p);

int func_020210c8(void)
{
