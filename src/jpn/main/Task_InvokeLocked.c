 ...
 *     ldr   r0, .L_020068b0                ; r0 = &data_02104e3c
 *     ldr   r1, [r0, #0x18]
 *     sub   r1, r1, #0x1
 *     str   r1, [r0, #0x18]                ; data_02104e3c._0x18--
 *     bl    OS_DisableIrq                  ; saved = disable_irqs()
 *     ldr   r1, .L_020068b0                ; reload data_02104e3c
 *     mov   r4, r0                         ; cache saved IRQ mask
 *     ldr   r0, [r1, #0x1c]                ; arg0 = data_02104e3c._0x1c
 *     mov   r1, r5                         ; arg1 = p
 *     bl    func_0207d370                  ; worker(_0x1c, p)
 *     mov   r0, r4
 *     bl    OS_RestoreIrq                  ; restore_irqs(saved)
 *     ldmia sp!, {r3, r4, r5, pc}
 *   .L_020068b0: .word data_02104e3c
 *
 ...
 *     section pair.
 *   - Between the IRQ bracket, dispatches to func_0207d370 with the
...
void Task_InvokeLocked(void *p) {
    ...
    data_02104e3c.counter--;
    saved = OS_DisableIrq();
    func_0207d370(data_02104e3c.handler_ctx, p);
    OS_RestoreIrq(saved);
}
