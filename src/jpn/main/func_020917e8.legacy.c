/* CAMPAIGN-PREP candidate for func_020917e8 (main, class C, MED tier) — brief 496.
...
void func_020917e8(void)
{
    Node *self = *(Node **)(data_021a62f0 + 0x4);
    Node *prev_of_self;
    Node *match;
    int   count;
    int   irq;
    ...
    if (prev_of_self == 0)
        *(Node **)(data_021a62f0 + 0x8) = self->next;
    else
