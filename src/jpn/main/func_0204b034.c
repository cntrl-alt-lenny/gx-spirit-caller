/* func_0204b034: 2 helpers + helper3 returns u64 → struct field write.
 *
 *     push  {r4, lr}
 *     bl    helper1
 *     mov   r1, #0
...
extern struct Func0204b0a8Target *func_0204987c(void);
extern long long func_02092fc8(void);

void func_0204b034(void) {
    long long v;
    struct Func0204b0a8Target *p;
    func_0204987c()->f429 = 0;
    p = func_0204987c();
    v = func_02092fc8();
    p->f504 = (int)v;
    p->f508 = (int)(v >> 32);
