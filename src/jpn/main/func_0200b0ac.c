/* CAMPAIGN-PREP candidate for func_0200b0ac (main, class A) — brief 494.
 ...
 *   confidence: med
 */
/* func_0200b0ac — counted loop invoking tasks from an array, then two tail invokes; returns 1.
