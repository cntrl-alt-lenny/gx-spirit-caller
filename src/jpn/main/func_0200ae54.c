/* CAMPAIGN-PREP candidate for func_0200ae54 (main, class A) — brief 494.
 ...
 *   confidence: high
 */
/* func_0200ae54 — null-guard then 8 unrolled null-checked invokes on fields 0x0..0x1c. */
