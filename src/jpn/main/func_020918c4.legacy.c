/* func_020918c4: scan a global list for the node with flag==1.
 *
 *     ldr r0, _LIT0             ; r0 = &data_021a62f0
 *     ldr r0, [r0, #0x8]           ; r0 = data_021a62f0.first
 *     b .L_10
 * .L_c:
...
extern struct s_020919ac_head data_021a62f0;

struct s_020919ac_node *func_020918c4(void) {
    struct s_020919ac_node *n = data_021a62f0.first;
