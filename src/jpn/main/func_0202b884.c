/* func_0202b884: return entry.w1 bit-field [3:0] (4 bits, LSB).
 *
 * One of a 7-function cluster of bit-field getters around 0x0202b6xx
 * - 0x0202b8xx, each calling func_0202b2c8 to get the card entry
 * and extracting a different bit-field from entry.w1:
 *
 *     stmdb sp!, {r3, lr}
 *     bl    func_0202b2c8            ; entry = card_lookup(id)
 ...
 *   [ 7: 4] 4 bits — func_0202b83c
 *   [11: 8] 4 bits — func_0202b854
 *   [14:12] 3 bits — func_0202b86c
 *   [19:15] 5 bits — func_0202b824
 *   [22:20] 3 bits — func_0202b660
 *   [27:23] 5 bits — func_0202b678
 *   [31:28] 4 bits — (unused)
 */
...
unsigned int func_0202b884(int id) {
    return func_0202b2c8(id)->attr_a;
}
