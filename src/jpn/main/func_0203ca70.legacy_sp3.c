/* func_0203ca70: set-bit-and-dispatch (the converse of func_0203ca28).
...
extern ctx_0203cac0_t *func_0203c8b0(int x);

int func_0203ca70(int mask, int arg1) {
    ctx_0203cac0_t *ctx = func_0203c8b0(1);
