/* func_02030584: pattern N2 — switch defeats predication collapse.
 *
 *     push  {r3, lr}
 *     ldr   r1, [pc, #32]
 *     cmp   r0, r1
 ...
 */
extern int func_02030538(int arg);

int func_02030584(int arg) {
    switch (arg) {
    case 0x17c4: return 0;
    default: return (func_02030538(arg) == 0);
    }
}
