/* CAMPAIGN-PREP candidate for func_0201bec4 (main, class A) — brief 494.
 ...
 *   confidence: med
 */
/* func_0201bec4: Copy32 into syswork + flag toggle around a callback.
...
extern void func_0201bd9c(void *a);

int func_0201bec4(char *a) {
