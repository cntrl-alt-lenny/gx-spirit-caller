/* func_0201aab4: clear bit (arg - 0x75) in byte 0 of GetSystemWork()->field_0x900.
 * Same shift-pair byte/bit-extraction shape as func_0201867c (adjacent
