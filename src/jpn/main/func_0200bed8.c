/* func_0200bed8: bit-position-to-index for single-bit values. Returns the
 ...
 * func_02018a88 but with EQ instead of LT, and a single-mov default at
 * the tail. Byte-identical clone of func_0200bf30.
 */

int func_0200bed8(int x) {
    if (x == 0x008) return 0;
    if (x == 0x010) return 1;
    if (x == 0x020) return 2;
    if (x == 0x040) return 3;
