/* func_02031a1c: linked-list iterate-and-call. Walks `h->first`
 * via `n->next20`, calling func_0203194c(n, b, c, d) on each.
 *
...
extern int func_0203194c(list_node_02031a70_t *n, int a, int b, int c);

void func_02031a1c(list_head_02031a70_t *h, int a, int b, int c) {
    list_node_02031a70_t *n;
    for (n = h->first; n != 0; n = n->next) {
        func_0203194c(n, a, b, c);
    }
}
