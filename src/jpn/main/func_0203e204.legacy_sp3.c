/* func_0203e204: fetch the shared 0x10-slot scratch object and dispatch
...
extern int   func_0203e148(void *p);
extern int   func_0203dea0(void *p);
extern int   func_0203de5c(void *p);
extern int   func_0203e050(void *p);

int func_0203e204(int a0) {
    void *raw = func_0203c8b0(0x10);
    Obj0203e254 *obj = (Obj0203e254 *)raw;
    switch (a0) {
    case 0:
        Fill32(0, (char *)raw + 0x300, 0x144);
        obj->f_d10 = (unsigned char)func_0203e148(raw);
        break;
    case 1:
        obj->f_d10 = (unsigned char)func_0203dea0(raw);
        obj->f_d0f = (unsigned char)func_0203de5c(raw);
        break;
    case 2:
        Fill32(0, (char *)raw + 0x300, 0x144);
        obj->f_d0f = 0;
        obj->f_d10 = (unsigned char)func_0203e050(raw);
        break;
    default:
        break;
    }
