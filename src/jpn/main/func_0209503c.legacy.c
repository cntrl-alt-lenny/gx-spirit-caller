/* func_0209503c: SNDi_SetTrackParam wrapper — param=26, flag=1.
 * Sibling of func_02095014; same shape, different `param` constant.
 *
 *     stmdb sp!, {lr}
 *     sub   sp, sp, #4
 *     mov   r3, r2
...
void func_0209503c(int tracks, int b, int value) {
