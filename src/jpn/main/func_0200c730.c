/* CAMPAIGN-PREP candidate for func_0200c730 (main, class D, MED tier) — brief 496.
 ...
 *   confidence: high
 */
/* func_0200c730 @ 0x0200c74c (main, class D)
...
int func_0200c730(struct Obj0200c74c *obj, int idx, int value)
{
    if (idx < 0) {
