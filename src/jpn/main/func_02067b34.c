/* func_02067b34: if field_10 nonzero, run a fixed teardown sequence
...
extern void func_02067c74(Obj02067ba8 *self, int zero);
extern void func_02067be4(Obj02067ba8 *self);
extern void func_02067b94(Obj02067ba8 *self);

void func_02067b34(Obj02067ba8 *self) {
    if (self->field_10 == 0) return;

    func_02067c74(self, 0);
    func_02067be4(self);
