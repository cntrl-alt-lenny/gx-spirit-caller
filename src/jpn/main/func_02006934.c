 ...
 * (data_02104e3c.negc / .neg8 / .p1c) instead of raw cast-offset writes.
 ...
 *
 * C-34 dual-pool fix: orig has 2 distinct pool slots for data_02104e3c
...
extern Glob02104f1c data_02104e3c;
...
void func_02006934(void)
{
    ...
    data_02104e3c.negc = -1;
    data_02104e3c.neg8 = -1;
    top = func_02092b90(0);
    cur = func_02092ba4(0);
    size = (cur & ~3) - ((top + 3) & ~3);
    data_02104e3c.p1c = func_0207d3f4(func_020928c4(0, size, 4), size, 0);
