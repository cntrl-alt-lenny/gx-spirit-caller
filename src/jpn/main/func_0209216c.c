/* func_0209216c: pre-increment counter at data_021a62e0; return new value.
 *
 *     ldr r1, .L_02092268
 *     ldr r0, [r1, #0x0]
 *     add r0, r0, #0x1
...
extern unsigned int data_021a62e0;

unsigned int func_0209216c(void) {
    return ++data_021a62e0;
}
