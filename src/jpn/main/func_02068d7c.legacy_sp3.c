/* CAMPAIGN-PREP candidate for func_02068d7c (main, class A) — brief 494.
 ...
 *   confidence: high
 */
/* func_02068d7c -> route as func_02068d7c.legacy_sp3.c (mwcc 1.2/sp3).
...
extern void func_02068db0(int a0, int a1, int a2, int a3, int s0, int s1, int s2, int s3);

void func_02068d7c(int a0, int a1, int a2, int a3, int a4, int a5, int a6) {
    func_02068db0(a0, a1, a2, a3, a4, a5, 0x80, a6);
}
