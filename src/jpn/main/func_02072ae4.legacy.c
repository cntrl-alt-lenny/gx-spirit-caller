/* func_02072ae4: stamp a size field, relocate a 10-byte chunk, splice
 * in a 6-byte constant, byte-swap data_0219ee3c's high/low 16-bit
...
extern void func_02073c48(void *a0, int a1, int a2, int a3);
extern int data_0219ee3c;
extern char data_0219ee4c[];

void func_02072ae4(char *a) {
    unsigned short hi, lo;

    *(unsigned short *)(a + 0x6) = 0x200;
    func_02094688(a + 0x8, a + 0x12, 10);
    func_02094688(data_0219ee4c, a + 0x8, 6);

    hi = (unsigned short)((unsigned int)data_0219ee3c >> 16);
    hi = (hi >> 8) | (hi << 8);
    *(unsigned short *)(a + 0xe) = hi;

    lo = (unsigned short)data_0219ee3c;
    lo = (lo >> 8) | (lo << 8);
    *(unsigned short *)(a + 0x10) = lo;

    func_02094688(a + 0x12, a - 0xe, 6);
    func_02094688(data_0219ee4c, a - 0x8, 6);
    func_02073c48(a - 0xe, 0x2a, 0, 0);
}
