/* func_ov010_021b22f4: clamp arg1 into [unk60, unk5C], store it (unk68), and
...
void func_ov010_021b22f4(void *arg0, int arg1) {
    char *p = arg0;
    ...
    *(int *)(p + 104) = arg1;
    ...
    else q = func_020b377c(span * (arg1 - *(int *)(p + 96)), *(int *)(p + 92) - *(int *)(p + 96));
    *(int *)(p + 4) = q;
}
