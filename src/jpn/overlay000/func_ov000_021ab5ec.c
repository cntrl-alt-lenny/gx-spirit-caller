/* func_ov000_021ab5ec: byte-low-zero check on a struct field.
 *
 ...
 * empirical re-test on the actual picks (`func_ov000_021ab5ec`,
...
extern struct LowByteStruct data_ov000_021c7450[];

int func_ov000_021ab5ec(void) {
    return data_ov000_021c7450[0x58 / 4].low8 == 0;
}
