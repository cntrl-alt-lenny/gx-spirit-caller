/* func_ov006_021cad18: sub-engine BG2 setup. Clears then re-applies bits of
...
int func_ov006_021cad18(void *self_) {
    int *self = (int *)self_;
    int negX, negY;
    ...
    func_02094410(0, (void *)func_0208dfb8(), 0x800);
    func_02094410(0, (void *)func_0208dd64(), 0x2040);
    return 1;
}
