...
extern char data_ov006_0225c3bc[];   /* (21) */
extern char data_ov006_0225ca3c[];   /* (21) */
extern char data_ov006_0225dd50[];   /* (21) */
extern char data_ov006_0225df48[];   /* (20) */
extern char data_ov006_0224f328[];   /* (19) */
extern char data_ov006_0225de1c[];   /* (13) */
extern char data_ov006_0225dfe0[];   /* (13) */
extern char data_ov006_0225e018[];   /* (13) */
extern char data_ov006_021cf020[];   /* (12) */

/* --- ov006 local sinks --------------------------------------------------
 * Most top local callees are ALREADY MATCHED — `extern` them straight from
 * the tree (no recovery): func_ov006_021c9de8, _021c9ed4, _021c1650,
...
extern int func_ov006_021b9ff0(void *self);   /* [sketch] dispatcher on self->f38 (switch); calls main util 0202224c */
extern int func_ov006_021c688c(void *obj);    /* [sketch] struct accessor: reads obj+0x8/+0xc/+0x14 */
...
extern int          data_ov006_0224f26c[];   /* state[0]=idx,[1]=flag — 021b5614 */
extern Ov006StateCb data_ov006_021cba90[];    /* callback table        — 021b5614 */
extern int          data_ov006_0224f1c8[];   /* state — 021b49b4 */
extern Ov006StateCb data_ov006_021cba54[];    /* table — 021b49b4 */
extern int          data_ov006_0224f210[];   /* state — 021b4f20 */
extern Ov006StateCb data_ov006_021cba6c[];    /* table — 021b4f20 */
extern int          data_ov006_0224f128[];   /* state — 021b3a1c */
extern Ov006StateCb data_ov006_021cba18[];    /* table — 021b3a1c */
extern int          data_ov006_0224f170[];   /* state[4]=reset — 021b3f88 variant */
extern Ov006StateCb data_ov006_021cba30[];    /* table — 021b3f88 */

/* --- guarded-call + clear (021b8d6c) -----------------------------------
 * if (g[1]) { sink(g[1]); g[1]=0; } return 1;  (sink is a main-arm9 util)  */
extern int  data_ov006_0224f2c0[];            /* g[1] = a deferred handle */
extern void func_02006e1c(int);               /* main-arm9 sink (also used by 021cb0a0) */

/* --- singleton globals proven this wave --------------------------------- */
extern char data_ov006_02257428[];            /* u16 fields +0x6c/+0x76 — 021be558 delta-compare */
/* data_ov006_021cf020 (above): the notify-on-truthy status word (021b2b08/2c9c, matched on branch). */
...
extern int  data_ov006_0224f090[];            /* per-state struct (also 021b2e58 dispatch state) */
extern int  data_ov006_0224f0dc[];            /* per-state struct */
...
extern int  func_ov006_021c1498(void *);      /* probe B (returns status) */
 ...
 *             func_020071a4(4, 1, &data_ov006_021cb438); return 1; */
extern int (*data_ov006_021cb9e8[])(void);     /* dispatch table — 021b2e58 */
...
extern int func_ov006_021b2300(int);          /* full-init seed; clone for the rest */
 ...
 * 0x80 (3): f359c/f3b40/f4ad8(1); func_ov006_021b9df8(0225c4dc, K, 0); then 6
 ...
 * func_ov006_021caf94/_021cac30/_021c9ef4/_021c757c/_021c6990/_021c159c/_021ba090
 ...
 *   021b2f70·0224f1b0  021b355c·0224f1fc.  (data_ov006_0224f328 is the shared arg.) */
extern char data_ov006_0224f328[];            /* shared "enter"/"finalize" arg ptr */
 ...
 * [if (flag)] { func_ov006_021b7f5c(p); func_02012454(arg, p + 292); }
 * func_ov006_021b8c6c(p); return 1;   — clone by guard + the 02012454 arg:
...
extern void func_ov006_021b7f5c(void *p);     /* subobject reset (unmatched local) */
extern void func_ov006_021b8e1c(void *p);     /* setup-family pass (021b5db4) */
/* func_ov006_021b8c6c / func_02012454 already used elsewhere; Copy32/Fill32 = main. */
 ...
 * func_ov006_021b69d8 then field/-1/0). */
extern int func_ov006_021b69d8(void *base, int sel, int idx, int d); /* region guard */
...
extern void func_ov006_021c6858(void *p);   /* 021c757c in some members */
extern void func_ov006_021c7450(void *p);
extern void func_ov006_021c9dc8(void *p);   /* 021c9ef4 in some members */
extern void func_ov006_021cab04(void *p);   /* 021cac30 in some members */
extern void func_ov006_021caf24(int *arr);  /* clears 0225e138, lazy-allocs 5 slots */
extern void func_ov006_021b9df8(void *p, int a, int b);   /* node register */
