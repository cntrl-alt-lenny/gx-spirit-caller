/* func_ov006_021c12b8: build+submit a command record for entry `arg1` (else
...
extern int  data_ov006_021cb574[];
extern char data_ov006_021cdc70[];
int func_ov006_021c12b8(void *q, int arg1, int slot) {
    char cmd[40];
    char buf[32];
    if (arg1 != 0) {
        int h;
        func_02091554(buf, data_ov006_021cdc70, data_ov006_021cb574[arg1]);
