 ...
 *
 * Anchor: data_ov006_021ce0a8 @ 0x021ce0a8, size 4 bytes (1 words). Bundle terminates at the next
 * 4-aligned named symbol (0x021ce0ac).
 *
...
unsigned int data_ov006_021ce0a8[1] = {
    0x00009a81,  /* candidate value */
};
