/* func_ov006_021b32c4: per-state "enter" — probe two subsystems, run the shared
...
extern void func_ov006_021b3118(void);
extern void func_ov006_021b3140(void);
