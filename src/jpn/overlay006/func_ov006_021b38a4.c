/* func_ov006_021b38a4: per-state "enter" — probe two subsystems, run the shared
...
extern void func_ov006_021b3704(void);
extern void func_ov006_021b372c(void);
