/* func_ov006_021b48fc: per-state "audio init" — open the per-state sound bank,
...
extern void func_ov006_021b6798(void *);
extern void func_0203737c(int, int, int, int);
extern char data_ov006_0224f1d4[];
...
int func_ov006_021b48fc(void) {
    func_0202ada4(data_ov006_0224f1d4);
    ...
    func_ov006_021b6798(data_ov006_0224f328);
    func_0203737c(0x24, 1, 0, -1);
    data_ov006_0224f1c8[0] = 2;
    return 1;
}
