; func_ov004_021d3d04 — whole-function ship-as-.s (GLOBAL_ASM endgame, brief 302):
...
; For reg-alloc-walled functions with no C match (brief 294 endgame).
        ...
        .extern func_02051a3c
        .extern func_ov004_021d37d4
        .global func_ov004_021d3d04
        .arm
func_ov004_021d3d04:
    stmdb sp!, {r4, lr}
    mov r4, r0
...
.L_3c:
    ...
    movgt r0, #0x0
    ldmia sp!, {r4, pc}
_LIT0: .word data_ov004_02209d24+0x4
