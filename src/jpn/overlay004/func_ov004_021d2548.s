; func_ov004_021d2548 — whole-function ship-as-.s (GLOBAL_ASM endgame, brief 302):
...
; For reg-alloc-walled functions with no C match (brief 294 endgame).
        ...
        .extern data_ov004_02200b94
        .extern data_ov004_02200ba0
        ...
        .extern func_ov004_021d2470
        .global func_ov004_021d2548
        .arm
func_ov004_021d2548:
    stmdb sp!, {r3, r4, r5, r6, r7, r8, r9, sl, fp, lr}
    sub sp, sp, #0x58
    bl func_ov004_021d2470
    mov r1, #0x2
    ldr r5, _LIT0
    mov fp, r0
    mov r0, r5
...
_LIT0: .word data_ov004_02211230
...
_LIT7: .word data_ov004_02200ba0
_LIT8: .word data_ov004_02200b94
_LIT9: .word data_021a1894
_LIT10: .word data_021a17d8
_LIT11: .word data_ov004_022112e8
