/* func_ov018_021acbf0: drive the screen-fade countdown. Each call bleeds the
...
int func_ov018_021acbf0(void) {
    char *st = data_ov018_021ad7c8;
    int t;
    int v;

    t = *(int *)(data_ov018_021ad780 + 0x54) - 0x1000;
    *(int *)(data_ov018_021ad780 + 0x54) = t;
    if (t < 0) {
        *(int *)(st + 0xc) = 0;
    }
    v = -0x10 - func_020b377c(-(*(int *)(st + 0xc) << 4), *(int *)(st + 0x8));
    func_0208c79c(0x400006c, v);
    func_0208c79c(0x400106c, v);
    if (*(int *)(st + 0xc) != 0) {
        return 0;
    }
    *(int *)(st + 0xc) = 0;
    ...
    *(int *)(data_ov018_021ad780 + 0x50) = 0;
    *(int *)(data_ov018_021ad780 + 0x54) = 0;
    return 1;
}
