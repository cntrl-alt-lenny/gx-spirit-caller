/* func_ov018_021ad11c: brighten a run of `count` RGB555 cells (twin of
 * func_ov018_021ad040; low half of `packed` = count, high half = scale). Pass 1
 ...
 * clamps to 0x1ff, recombines via func_ov018_021acea8, and writes to dst.
 */

extern void func_ov018_021acd90(int value, int *out0, int *out1, int *out2);
extern int func_ov018_021acea8(int a, int b, int c);

void func_ov018_021ad11c(unsigned short *src, unsigned short *dst, unsigned int packed) {
    int c0;
    int c1;
    int c2;
    int i;
