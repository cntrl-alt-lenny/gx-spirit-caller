...
void func_ov017_021b72a8(char *self, int *tbl) {
    int job;
    OS_SPrintf(tbl[0], data_ov017_021b8270, *(unsigned char *)(self + 0x1ce));
    OS_SPrintf(tbl[1], data_ov017_021b8290, *(unsigned char *)(self + 0x1ce));
    OS_SPrintf(tbl[2], data_ov017_021b82b0, *(unsigned char *)(self + 0x1ce));
    OS_SPrintf(tbl[3], data_ov017_021b82d0, *(unsigned char *)(self + 0x1ce));
    if (*(int *)(self + 0x10c) != 0) {
