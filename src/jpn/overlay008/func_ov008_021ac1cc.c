...
extern char data_ov008_021b2ca0[];
extern char data_ov008_021b2ca0_alias[];

int func_ov008_021ac1cc(void) {
    volatile unsigned int *dispcnt;
    volatile unsigned short *bgcnt;
    volatile unsigned int *bldcnt;
    unsigned int t;

    func_02094410(0, data_ov008_021b2ca0, 8);
    ...
    *(unsigned short *)&data_ov008_021b2ca0_alias[6] =
        (*(unsigned short *)&data_ov008_021b2ca0_alias[6] & ~0xffu) | 0x1a;
