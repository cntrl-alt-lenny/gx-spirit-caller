...
void func_ov016_021b8a88(void *arg0, void **arg1) {
    char *p = arg0;
    int tmp;
    OS_SPrintf(arg1[0], data_ov016_021b94f8, *(unsigned char *)(p + 463));
    OS_SPrintf(arg1[1], data_ov016_021b9518, *(unsigned char *)(p + 463));
    OS_SPrintf(arg1[2], data_ov016_021b9538, *(unsigned char *)(p + 463));
    OS_SPrintf(arg1[3], data_ov016_021b9558, *(unsigned char *)(p + 463));
    if (*(int *)(p + 360) != 0) {
