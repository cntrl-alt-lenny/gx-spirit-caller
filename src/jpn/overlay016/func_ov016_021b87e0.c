...
void func_ov016_021b87e0(void *arg0, void **arg1) {
    char *p = arg0;
    int tmp;
    OS_SPrintf(arg1[0], data_ov016_021b9378, *(unsigned char *)(p + 461));
    OS_SPrintf(arg1[1], data_ov016_021b9398, *(unsigned char *)(p + 461));
    OS_SPrintf(arg1[2], data_ov016_021b93b8, *(unsigned char *)(p + 461));
    OS_SPrintf(arg1[3], data_ov016_021b93d8, *(unsigned char *)(p + 461));
    if (*(int *)(p + 176) != 0) {
