...
void func_ov016_021b89a4(void *arg0, void **arg1) {
    char *p = arg0;
    int tmp;
    OS_SPrintf(arg1[0], data_ov016_021b9478, *(unsigned char *)(p + 462));
    OS_SPrintf(arg1[1], data_ov016_021b9498, *(unsigned char *)(p + 462));
    OS_SPrintf(arg1[2], data_ov016_021b94b8, *(unsigned char *)(p + 462));
    OS_SPrintf(arg1[3], data_ov016_021b94d8, *(unsigned char *)(p + 462));
    if (*(int *)(p + 268) != 0) {
