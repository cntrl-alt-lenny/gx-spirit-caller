/* func_ov003_021cefec: hit-test the touch point against the widget rect — true
...
int func_ov003_021cefec(int dummy, void *rect) {
    int x, y;
    func_02006110(&x, &y);
    if (func_020061ac() != 0 && *(unsigned short *)rect <= x &&
