/* func_ov003_021cce58: gate a transition on progress — selector 1 is ready once
...
int func_ov003_021cce58(int dummy, int sel) {
    switch (sel) {
    case 1:
        ...
        break;
    case 0x4b:
        if ((unsigned)*(int *)(data_02104f4c + 0x928) >= 0x17)
            return 1;
        break;
    }
    return 0;
