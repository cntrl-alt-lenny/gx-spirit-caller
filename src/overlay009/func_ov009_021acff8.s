; func_ov009_021acff8 — whole-function ship-as-.s (GLOBAL_ASM endgame, brief 302):
...
; For reg-alloc-walled functions with no C match (brief 294 endgame).
        ...
        .extern func_0202b74c
        .extern func_02037208
        .extern func_ov009_021aa4a8
        .extern func_ov009_021ad1bc
        .extern func_ov009_021ad204
        .global func_ov009_021acff8
        .arm
func_ov009_021acff8:
...
.L_be8:
    ...
    ble .L_c94
    mov r0, r5
    bl func_ov009_021ad1bc
    cmp r0, #0x0
    beq .L_c94
    ldr r1, [r5, #0x20]
    mov r0, r5
    bl func_ov009_021ad204
    ldr r1, _LIT1
    str r0, [r5]
    ldr r0, [r1, #0xa64]
    and r0, r0, #0x1f00000
...
_LIT5: .word data_ov009_021adbcc
_LIT6: .word data_ov009_021adc00
