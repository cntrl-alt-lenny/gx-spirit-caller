/* func_ov017_021b30d4: scene controller tick — if a transfer is pending
 * (ctrl->f8c), run func_0201ef3c and clear it; then clear the BG0 mosaic
 * field on both the main and sub display. Returns 1.
 *
 *     ldr r0,[r4,#0x8c]; cmp r0,#0; beq .skip
 *     ldr r0,[r4,#0x10]; add r1,r4,#0x18; add r2,r4,#0x8c; bl func_0201ef3c
...
int func_ov017_021b30d4(char *ctrl) {
    if (*(int *)(ctrl + 0x8c) != 0) {
        func_0201ef3c(*(int *)(ctrl + 0x10), ctrl + 0x18, ctrl + 0x8c);
        *(int *)(ctrl + 0x90) = 0;
        *(int *)(ctrl + 0x8c) = 0;
    }
