/* func_ov017_021b40d8: render the decimal digits of `val` as a sequence of
 ...
 * is built in a local 6-byte struct and handed to func_020944a4 at a
 * destination slot obtained from func_02005dac(2, 0). Returns the final x.
 *
 ...
 * identical 3-call shape (func_02005dac(2,0) -> func_020944a4(buf,handle,N)):
