/* func_ov006_021c19a8: Fill32 + multi-field init — zero 0x105c bytes,
 * clear obj[0x44], obj[0x48], set obj[0x70] = arg1, return 1.
 *
 *     stmdb sp!, {r3, r4, r5, lr}
 *     mov   r4, r1                    ; cache arg1
 *     mov   r5, r0                    ; cache obj
 *     ldr   r1, .L_021c19dc            ; r1 = &data_ov006_0225cbb8
...
int func_ov006_021c19a8(void *obj, int arg1) {
    Fill32(0, data_ov006_0225cbb8, 0x105c);
    *(int *)((char *)obj + 0x44) = 0;
    *(int *)((char *)obj + 0x48) = 0;
