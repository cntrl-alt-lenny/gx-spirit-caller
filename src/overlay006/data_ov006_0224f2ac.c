 ...
 * via func_ov006_021b40ac.s (still ship-as-.s, GLOBAL_ASM endgame): `ldr
 * r0, =data_ov006_0224f2ac; bl func_0202adf8` immediately followed by `bl
...
Ov006AudioBank data_ov006_0224f2ac;
