/* func_ov006_021c16d8: configure a display register, then build+submit a
...
extern char data_ov006_021cddc0[];
int func_ov006_021c16d8(void) {
    volatile unsigned short *reg = (volatile unsigned short *)0x0400000a;
    char cmd[40];
    int h;
    *reg = (*reg & ~3) | 3;
    *reg = (*reg & 0x43) | 0xd00;
    h = func_02006c0c(data_ov006_021cddc0, 4, 0);
    func_0201d47c(cmd);
    *(int *)(cmd + 0) = h;
