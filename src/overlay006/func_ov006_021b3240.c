/* func_ov006_021b3240: C-23 ov006 uniform MMIO family (brief 270 head 021b4d68).
...
extern char data_ov006_0224f1b0[];
int func_ov006_021b3240(void) {
    func_02021158();
    if (*(int *)(data_ov006_0224f1b0 + 8) != 0) {
        func_0200e9c4();
