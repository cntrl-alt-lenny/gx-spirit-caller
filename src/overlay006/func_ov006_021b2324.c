/* func_ov006_021b2324: per-state "audio init" — open the per-state sound bank,
...
extern char data_ov006_021cf174[];
...
int func_ov006_021b2324(void) {
    func_0202adf8(data_ov006_021cf174);
    ...
    func_ov006_021b5c2c(data_ov006_0224f448);
    func_020373cc(0x24, 1, 0, -1);
    data_ov006_021cf140[0] = 2;
    return 1;
}
