/* func_ov006_021b5340: C-23 ov006 uniform MMIO family (brief 270 head 021b4d68).
...
extern char data_ov006_0224f330[];
int func_ov006_021b5340(void) {
    func_02021158();
    if (*(int *)(data_ov006_0224f330 + 8) != 0) {
        func_0200e9c4();
