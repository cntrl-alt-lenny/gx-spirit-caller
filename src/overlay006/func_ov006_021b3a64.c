/* func_ov006_021b3a64: per-state "audio init" — open the per-state sound bank,
...
extern char data_ov006_0224f254[];
...
int func_ov006_021b3a64(void) {
    func_0202adf8(data_ov006_0224f254);
    ...
    func_ov006_021b66c4(data_ov006_0224f448);
    func_020373cc(0x24, 1, 0, -1);
    data_ov006_0224f248[0] = 2;
    return 1;
}
