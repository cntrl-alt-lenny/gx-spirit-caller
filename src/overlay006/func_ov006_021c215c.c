/* func_ov006_021c215c: dense 0-7 jump-table dispatch on
 ...
 */
extern void func_02037208(int id, int neg1, int c, int d);

int func_ov006_021c215c(void *selfv) {
