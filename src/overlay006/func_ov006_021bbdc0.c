/* func_ov006_021bbdc0: jump-table dispatch on p->field_40.
 ...
 *   func_020216b0(func_02021660(p->field_00, 4, 0), 0, 0x801);
 *   func_02022234(2, p->field_40);
 *   func_02022234(3, r5);
 *   return 1;
 */
...
int func_ov006_021bbdc0(obj_021bbdc0_t *p) {
    int cbresult;
    int r5;

    cbresult = func_02021660(p->field_00, 4, 0);
    ...
    func_020216b0(cbresult, 0, 0x801);
    func_02022234(2, p->field_40);
    func_02022234(3, r5);
    return 1;
}
