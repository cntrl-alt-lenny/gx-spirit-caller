/* func_ov006_021b3e20: per-state "enter" (long) — kick the per-state full-init
...
int func_ov006_021b3e20(void) {
    func_ov006_021b3b40(1);
    func_ov006_021b9ef8(data_ov006_0225c4dc, 3, 0);
