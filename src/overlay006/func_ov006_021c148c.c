/* func_ov006_021c148c: build+submit a command record for entry `arg1` (else
...
extern char data_ov006_021cdda8[];
int func_ov006_021c148c(void *q, int arg1, int slot) {
    char cmd[40];
    char buf[32];
    if (arg1 != 0) {
        int h;
        func_02091554(buf, data_ov006_021cdda8, data_ov006_021cb5f4[arg1]);
