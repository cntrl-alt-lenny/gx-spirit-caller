/* func_ov006_021c155c: Fill32-zero a 0x20-byte struct, then init
 ...
 *     mov   r0, #0x1
 *     ldmia sp!, {r4, pc}
 *  .L_021c1598: .word data_ov006_0225cb5c
 *
...
int func_ov006_021c155c(ov006_021c155c_state_t *p) {
    Fill32(0, data_ov006_0225cb5c, 0x20);
    p->f_4 = 0;
    p->f_8 = 0;
    p->f_c = 0;
    p->f_10 = -1;
