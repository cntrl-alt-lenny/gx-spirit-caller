; func_ov006_021bf844 — whole-function ship-as-.s (GLOBAL_ASM endgame, brief 302):
...
; For reg-alloc-walled functions with no C match (brief 294 endgame).
        ...
        .extern func_ov006_021c12fc
        .extern func_ov006_021c13c4
        .extern func_ov006_021c148c
        .extern func_ov006_021cb0d8
        .extern func_ov006_021cb158
        .global func_ov006_021bf844
        .arm
func_ov006_021bf844:
...
.L_c5c:
    ...
    ldr r2, [sp, #0x10]
    mov r0, r9
    bl func_ov006_021c13c4
    b .L_d14
.L_d04:
    ldr r1, [sp, #0x64]
    ldr r2, [sp, #0x10]
    mov r0, r9
    bl func_ov006_021c148c
.L_d14:
    ldr r0, [sp, #0x10]
    add r5, r0, #0x9
    bl func_0208df94
