/* data_ov006_021cc050 (20 bytes, 4-aligned): retyped from opaque bytes to
 * a {short,short}[5] screen-position table as part of cm-data-inference-9.
 * One of a 4-member sibling family (data_ov006_021cc03c/_021cc064/
...
Ov006PosRow021cc03c data_ov006_021cc050[5] = {
    { 0, 0 },
    { 44, 175 },
    { 184, 175 },
    { 0, 0 },
