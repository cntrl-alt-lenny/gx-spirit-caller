/* func_ov006_021b7ce0: 2D-indexed signed-halfword load from a
 ...
 *
 *     ldr   r3, .L_021b7cf8             ; r3 = &data_ov006_0224f400
...
int func_ov006_021b7ce0(int unused, int i, int j) {
    short *record;

    (void)unused;
    record = (short *)(data_ov006_0224f400 + i * 14);
    return record[j];
}
