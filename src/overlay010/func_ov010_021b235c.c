/* func_ov010_021b235c: family f83d4ff8 — zero a 0xa4-byte global via
 * Fill32, run a reset helper on self, then clear self's first word.
 *
 *     push  {r4, lr}
 *     ldr   r1, .L_021b2388      ; .word data_ov010_021b8c2c
 *     mov   r4, r0
 *     mov   r0, #0x0
 *     mov   r2, #0xa4
 *     bl    Fill32               ; Fill32(0, data_ov010_021b8c2c, 0xa4)
 *     mov   r0, r4
...
void func_ov010_021b235c(int *self) {
    Fill32(0, data_ov010_021b8c2c, 0xa4);
