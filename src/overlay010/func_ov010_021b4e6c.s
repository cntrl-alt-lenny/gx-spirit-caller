; func_ov010_021b4e6c — whole-function ship-as-.s (GLOBAL_ASM endgame, brief 302):
...
; For reg-alloc-walled functions with no C match (brief 294 endgame).
        ...
        .extern func_ov010_021b2480
        .extern func_ov010_021b2488
        .global func_ov010_021b4e6c
        .arm
func_ov010_021b4e6c:
    ...
    ldr r6, [r1, #0xb0]
    ldr r5, _LIT2
    bl func_ov010_021b2480
    ldr r1, _LIT0
    mov r7, r0
    ldr r0, [r1, #0xd8]
    bl func_ov010_021b2488
    ldr r2, _LIT3
    mov r1, #0x0
    cmp r0, #0x0
    ldrh r3, [r2, #0x54]
