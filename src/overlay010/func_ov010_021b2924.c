/* func_ov010_021b2924 (brief 535, B4): touch-rect hit-test drives a
 * 2-bit mode/state transition ladder, then conditionally fires a
 * callback and tail-calls func_ov010_021b27d8. Byte-identical to
...
extern int func_ov010_021b27d8(Widget *self, int arg2, int *outparam, int flag);
