/* func_ov010_021b2348: save-restore wrapper — passes the caller's
 * arg to func_ov005_021aa4ac, then returns the arg unchanged.
 * Overlay-swap sibling of func_ov015_021b2348 (same 0x021b2348 address,
...
void *func_ov010_021b2348(void *x) {
