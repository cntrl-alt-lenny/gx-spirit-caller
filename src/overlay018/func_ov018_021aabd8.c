/* func_ov018_021aabd8: draw the active gauge row (sibling of 021aaaf0, with a
 ...
 * at st+0x4 is 0, the row is drawn via func_ov018_021aaa88 (sub-glyph 0x58),
...
int func_ov018_021aabd8(int a0, int *a1) {
    ...
    if (!((OamCtl *)(data_ov018_021ae160 + 0xfc))->b0) {
        ...
        n = func_ov018_021aaa88(a0, a1, *(int *)(st + mode * 4 + 0x8d8), 0x80, 0x58);
        for (i = 0; i < n; i++) {
            cell->attr &= ~0xc00;
        ...
        if (mode == 1) {
            switch (*(int *)(st + 0x0)) {
            case 0xe:
                func_ov018_021aa9b8(0x5000622);
                break;
            case 0xf:
                func_ov018_021aaa3c(0x5000622);
                break;
            }
        } else {
