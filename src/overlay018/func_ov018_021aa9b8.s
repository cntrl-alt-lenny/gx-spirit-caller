; func_ov018_021aa9b8 — whole-function ship-as-.s (GLOBAL_ASM endgame, brief 302):
...
; For reg-alloc-walled functions with no C match (brief 294 endgame).
        ...
        .extern func_ov018_021ad118
        .global func_ov018_021aa9b8
        .arm
func_ov018_021aa9b8:
    stmdb sp!, {r4, lr}
    ldr r1, _LIT0
    ...
    add r0, r0, #0x900
    orr r2, r2, #0xb
    bl func_ov018_021ad118
    ldmia sp!, {r4, pc}
_LIT0: .word data_ov018_021ad860
_LIT1: .word 0x88888889
_LIT2: .word data_ov018_021ad8a8
