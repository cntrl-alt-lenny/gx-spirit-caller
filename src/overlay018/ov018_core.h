...
/* --- dominant data bases ------------------------------------------------ */
extern char data_ov018_021ad8a8[]; /* menu/OAM state block (see field map)   */
extern char data_ov018_021ad860[]; /* sound/scroll register block            */
extern char data_021040ac[];       /* global arm9 main state                 */
extern char data_02104bac[];       /* input block: +0x54/+0x56 key words     */
extern char data_ov018_021ad738[]; /* cell-archive id table [mode<<5 + n*4]  */

/* data_ov018_021ad8a8 (the menu/OAM state block) field map:
 ...
 * data_ov018_021ad860: +0x50/+0x54 scroll/fade-timer, +0x8f8 attr word,
 ...
 *   021ab48c  MMIO scroll reset + 2 func_ov018_021aa5fc cell re-seeds
 * batch 2 (6):
