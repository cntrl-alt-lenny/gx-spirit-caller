/* func_ov018_021ab054: per-frame D-pad handler for the count field at oam+0x4.
...
void func_ov018_021ab054(void) {
    char *oam = data_ov018_021ad8a8;
    unsigned short in;
    unsigned short in2;
    in = *(unsigned short *)(data_02104bac + 0x54);
    if (in & 1) {
        func_02037208(0x97, 0x97 - 0x98, 0, 1);
    ...
    in2 = *(unsigned short *)(data_02104bac + 0x56);
