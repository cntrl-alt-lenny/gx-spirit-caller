/* Ov015_SelectVramBank: VRAM-bank selector — dispatch the 8 bank-setup helpers by
...
int Ov015_SelectVramBank(int sel) {
    switch (sel) {
    case 0:
    ...
    case 4:
        return Vram_GetBankBaseCD();
    case 5:
        return Vram_GetBankBaseE();
    case 6:
