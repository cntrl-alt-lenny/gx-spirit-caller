/* func_ov015_021b2924 (brief 535, B4): touch-rect hit-test drives a
 * 2-bit mode/state transition ladder, then conditionally fires a
 * callback and tail-calls func_ov015_021b27d8. Byte-identical to
 * func_ov015_021b2924 (only the overlay-local callee symbol differs).
 *
 * Key reshape levers:
...
extern void func_02006110(int *outX, int *outY);
extern unsigned int func_02006164(void);
extern unsigned int func_02006194(void);
extern unsigned short func_0207ec28(void *rng);
extern int func_ov015_021b27d8(Widget *self, int arg2, int *outparam, int flag);

int func_ov015_021b2924(Widget *self, void *rngArg, int arg2)
{
    int px, py;
    ...
    self->trigger = 0;
    ret = ret + func_ov015_021b27d8(self, arg2, &savedRng, 0);
    return ret;
}
