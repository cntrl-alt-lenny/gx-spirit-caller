; func_ov015_021b52c4 — whole-function ship-as-.s (GLOBAL_ASM endgame, brief 302):
...
; For reg-alloc-walled functions with no C match (brief 294 endgame).
        ...
        .extern func_ov015_021b37fc
        .extern func_ov015_021b3e14
        .extern func_ov015_021b405c
        .extern func_ov015_021b429c
        .extern func_ov015_021b43a8
        .extern func_ov015_021b4444
        .extern func_ov015_021b4574
        .extern func_ov015_021b46c8
        .extern func_ov015_021b4740
        .global func_ov015_021b52c4
        .arm
func_ov015_021b52c4:
...
.L_ba0:
    ...
    add r1, r1, #0x800
    str r2, [r3]
    bl func_ov015_021b37fc
    add r0, r5, #0x2c
    add r1, sp, #0x8
    add r0, r0, #0x400
    bl func_ov015_021b4444
    ldr r2, [sp, #0x4]
    ldr r1, [r5, #0xa84]
    add r2, r2, r0
    orr r0, r1, #0x8
...
.L_df0:
    ...
    b .L_e3c
.L_e30:
    bl func_ov015_021b429c
    b .L_e3c
.L_e38:
    bl func_ov015_021b4574
.L_e3c:
    ldr r1, [r5, #0xa84]
    mov r0, r1, lsl #0x1d
    mov r0, r0, lsr #0x1f
...
_LIT2: .word data_ov015_021b5e54
