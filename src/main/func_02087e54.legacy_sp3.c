/* func_02087e54: double early-return guard on a cached self-pointer,
 * then a tail call passing a pointer into the inner struct (self+0x1c),
 * a shifted arg1, and a forwarded (unmodeled) 3rd argument.
 *
 * "Hidden-arg liveness" lever: func_0208b0a4 genuinely takes 3 args
 * (see func_0208b0a4.legacy_sp3.c: void func_0208b0a4(struct
 * Func0208b0a4Self *self, int arg1, int arg2)). The lone caller of
 * this function (func_02037d28.s) forwards its own 3rd parameter into
 * r2 right up to this function's call site, and the other 2 real
 * call sites of func_0208b0a4 (func_0208787c.s explicit r2 set;
 * func_02087954.s r1->r2 forward at entry) confirm arg2 is a real,
...
void func_02087e54(EntE54 *p, int arg1, int arg2) {
    InnerE54Full *q = p->field_0;

    if (q == 0) return;
    if (q->byte_2c == 2) return;
    func_0208b0a4(&q->field_1c, arg1 << 8, arg2);
}
