...
extern void func_0201aabc(int a);
extern int func_02019664(void);
extern void func_0201aaf4(int a);
extern void func_0201b7b4(void);
extern int func_0201b7e0(void *obj);
...
void func_02017df0(void *self) {
    ...
    case 1:
        ...
        *(int *)((char *)self + 0x8) = 0x00280100;
        ...
        break;
    case 2:
        if (func_0201b7e0(self) != 3) return;
