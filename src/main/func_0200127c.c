 ...
 * return 1 immediately. Otherwise switch on data_021040ac.f_3c (current
 * state): most handled states call func_02000cc4() then set a new
 * "next action" into data_021040ac.f_b64 and return 0; state 0 and any
...
int func_0200127c(void)
{
    ...
    switch (data_021040ac.f_3c) {
    case 1:
        func_02000cc4();
        p->f_b64 = 3;
        break;
    case 2:
        switch (data_021040ac.f_40) {
        case 1:
            func_02000cc4();
            p->f_b64 = 9;
            break;
