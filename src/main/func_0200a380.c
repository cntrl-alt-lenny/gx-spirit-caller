/* CAMPAIGN-PREP candidate for func_0200a380 (main, class A) — brief 494.
 ...
 *   confidence: med
 */
/* func_0200a380 — counted scan over 0x50 entries, stride 6, clear a flag bit.
...
void func_0200a380(void)
{
    struct Ent *e = (struct Ent *)&data_02106810;
    int i = 0;
    do {
        if (e->act)
            e->f4 &= ~1;
