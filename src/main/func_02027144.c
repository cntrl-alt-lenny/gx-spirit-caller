/* CAMPAIGN-PREP candidate for func_02027144 (main, class A) — brief 494.
 ...
 *   confidence: high
 */
/* func_02027144 — null-guard + bit2 bitfield test + conditional invoke + clear */
...
extern void func_02027ddc(Obj27144 *p);

int func_02027144(Obj27144 *p) {
    if (p->field0 == 0)
        return 0;
    if (p->b2)
        func_02027ddc(p);
