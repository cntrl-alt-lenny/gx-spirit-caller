/* func_0208bd88: 32-bit signed integer divide using the DS hardware
 * divider. Returns the REMAINDER (companion to func_0208bde0 which
 * returns the quotient).
 *
 * Same setup + wait-loop as func_0208bde0; only the final pool word
...
int func_0208bd88(int numer, int denom) {
