/* func_020890e4: clone of wave-17 func_02089024 / 0208910c family at
 * field offset +0x10 (vs +0x14 / +0xc). Bounds-checked struct-array
 * lookup via data_021a5800.
 *
 *     ldr   r1, .L_02089108           ; data_021a5800
 *     ldr   r1, [r1, #0x0]
 *     ldr   r2, [r1, #0x84]
 *     ldr   r1, [r2, #0x8]
 *     cmp   r0, r1
...
unsigned int func_020890e4(unsigned int idx) {
