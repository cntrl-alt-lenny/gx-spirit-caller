/* func_0203e8b8: 64-bit "elapsed since field_cb0" delta, shifted left 6
 * and hashed via func_020b3808 (2-word arg + 2-word return, both real
 * 64-bit values per ARM EABI) — read obj->field_cb0 INLINE in the same
 * expression as the func_020930b0() call (not into a separate local),
 ...
 * func_0203e540, otherwise resets field_cb0 and notifies func_0203e3d4. */
typedef struct {
    char                  pad_cb0[0xcb0];
...
extern int        func_0203e540(void *p, int a1);
extern void       func_0203e3d4(int a0, int a1, int a2, int a3);
extern char       data_020bee6c[];

int func_0203e8b8(Obj0203e8b8 *obj) {
    long long diff = (func_020930b0() - obj->field_cb0) << 6;
    if ((unsigned long long)func_020b3808((int)diff, (int)(diff >> 32), 0x82ea, 0) < 0x12c) {
        goto ret3;
    }
    obj->field_d11 = obj->field_d11 + 2;
    if (obj->field_d11 >= 0xd) {
        return func_0203e540(obj, 3);
    }
    obj->field_cb0 = func_020930b0();
    func_0203e3d4((int)(data_020bee6c + 0x10), (int)(data_020bee6c + 0x18), obj->field_d11, 0x200000);
ret3:
    return 3;
}
