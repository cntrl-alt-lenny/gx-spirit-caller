/* func_02018a38: insert an 8-bit field at bits 11..18 of state[0x8e8].
 ...
 *
 * Pairs with func_02018a64 (the bit-clear variant at same offset).
 */

extern char *GetSystemWork(void);

void func_02018a38(unsigned int value) {
