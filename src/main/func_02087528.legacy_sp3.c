/* func_02087528: sp3 routing — null-check + `helper(1 << self->f0)`.
 *
 *     stmfd sp!, {lr}
 *     sub   sp, sp, #4
 *     ldr   r2, [r0, #8]
...
extern void func_02094ee8(int x, int arg);

void func_02087528(struct Func02087528Self *self, int arg) {
    if (self->f8 == 0) return;
    func_02094ee8(1 << self->f0, arg);
}
