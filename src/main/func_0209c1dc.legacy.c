/* func_0209c1dc: release-side of a refcounted resource in
 * data_021a84c0 (see func_0209c280.legacy.c for the acquire-side
 * sibling, and func_0209cae4.legacy.c / func_0209d1f0.legacy.c for
 * other data_021a84c0 field usages). If the caller doesn't own the
...
extern void func_02091a0c(void *p, int v);

void func_0209c1dc(int a0, int a1) {
