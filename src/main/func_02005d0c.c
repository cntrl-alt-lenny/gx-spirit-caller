/* func_02005d0c: 3-way switch + 3-arg tail-call. Same shape as wave-21's
 * func_02005c60 but with 2 fixed-arg constants (0xc0, 0x400).
 *
...
extern state_02005d0c_t data_02103d6c;
extern int func_02094504(int a, int b, int c);

int func_02005d0c(int kind) {
    int arg;
    switch (kind) {
    ...
    return func_02094504(0xc0, arg, 0x400);
}
