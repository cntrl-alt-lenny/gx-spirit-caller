/* CAMPAIGN-PREP candidate for func_02031f40 (main, class A) — brief 494.
 ...
 *   confidence: med
 */
/* func_02031f40: walk a singly-linked list. Head pointer kept in r5
 ...
 *  .L: ldr r4,[r1,#0x4]; mov r0,r5; bl func_02031ebc
...
extern void func_02031ebc(List_02031f40 *list, Node *node);

void func_02031f40(List_02031f40 *list) {
    Node *n = list->head;

    while (n != 0) {
        Node *next = n->next;
        func_02031ebc(list, n);
        n = next;
    }
}
