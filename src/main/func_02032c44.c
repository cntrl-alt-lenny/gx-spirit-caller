/* func_02032c44: register-at-index-then-dispatch (sp1p5 default).
 *
 *     push  {r3, r4, r5, lr}
 *     mov   r4, r1                ; r4 = idx
 *     mov   r5, r0                ; r5 = arg0
...
extern ctx_02032c44_t *func_0203268c(void);

void func_02032c44(void *arg0, int idx) {
    ctx_02032c44_t *ctx = func_0203268c();
    ctx->array[idx] = arg0;
    if (ctx->fn == 0) return;
    ctx->fn(arg0, idx);
}
