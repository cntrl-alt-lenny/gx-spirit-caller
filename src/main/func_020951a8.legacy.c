/* func_020951a8: SNDi_SetTrackParam wrapper — param=10, flag=2.
 * Sibling of func_02095108; same shape, different `param` + `flag`.
 *
 *     stmdb sp!, {lr}
 *     sub   sp, sp, #4
 *     mov   r3, r2
...
void func_020951a8(int tracks, int b, int value) {
