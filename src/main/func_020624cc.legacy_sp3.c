/* func_020624cc: null-checked field store. Soft-assert (logs, doesn't
...
extern char data_02101518[];
extern char data_02101524[];
...
void func_020624cc(Obj020624cc *self, int val) {
    if (self == 0) {
