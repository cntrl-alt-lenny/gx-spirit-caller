/* func_0201a920: classify x into one of 6 named constants (default 0),
 * then pack the result into the low halfword of ctx->field_18
 * (ctx = func_02018b94(x)), call func_02018a84(r4, 1), return r4.
 *
...
extern void *func_02018b94(int x);
extern void  func_02018a84(int val, int one);

int func_0201a920(int x) {
    int r4;
    void *ctx;
