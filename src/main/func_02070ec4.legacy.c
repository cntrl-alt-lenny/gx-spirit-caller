/* CAMPAIGN-PREP candidate for func_02070ec4 (main, class A) — brief 494.
 ...
 *   confidence: med
 */
/* CAMPAIGN-PREP candidate for func_02070ec4 (main, class A).
 * UNVERIFIED build-free draft. Route -> src/main/func_02070ec4.legacy.c
 ...
 */
/* func_02070ec4: self->f28 = func_0207103c(); self->f8 = 1;
 * old = OS_DisableIrq(); self->f4 = 1; func_02091a8c(0, 1);
...
extern void func_02091a8c(int a, int b);

void func_02070ec4(Self *self) {
    OSIntrMode old;
    self->f28 = func_0207103c();
    self->f8 = 1;
    old = OS_DisableIrq();
    self->f4 = 1;
    func_02091a8c(0, 1);
