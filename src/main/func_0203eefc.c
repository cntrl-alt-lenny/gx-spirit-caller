/* func_0203eefc: acquire a handle + poll a state value; if the state is
...
int func_0203eefc(struct S0203eefc_A0 *a0) {
    struct S0203eefc_Handle *handle;
    int state;

    handle = (struct S0203eefc_Handle *)func_0203c900(1);
    state = func_0204320c();
    if (state != 0) {
        if (handle->f_15 == func_0203c814(a0->f_d0d)) {
            handle->f_10 = func_020431f4();
        }
