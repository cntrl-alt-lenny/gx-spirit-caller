/* func_02091690: IRQ-bracketed pre-decrement counter — if
 * `data_021a63bc != 0`, decrement and return old value; else 0.
 *
 *     stmdb sp!, {r4, lr}
 *     bl    OS_DisableIrq
 *     ldr   r1, .L_020916c4
...
unsigned int func_02091690(void) {
    int saved = OS_DisableIrq();
    unsigned int v = 0;
    unsigned int c = data_021a63bc;
    if (c != 0) {
        v = c;
        data_021a63bc = c - 1;
    }
