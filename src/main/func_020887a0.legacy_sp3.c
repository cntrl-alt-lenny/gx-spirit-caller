...
extern void func_02092904(void *a0, int a1);
extern void func_020950a0(void *a0, void *a1, unsigned int a2, int a3);
...
void func_020887a0(void) {
    ...
    func_02092904(p->field_c, p->field_14);
    func_02092904(p->field_10, p->field_14);

    mask = (p->field_2c >= 0) ? (1u << p->field_2c) : 0;
    func_020950a0(p->field_24, p->field_28, mask, 0);
}
