/* func_0208cc18: C-41 — MMIO bit-clear + tail-call to data-dispatcher.
 *
 * Orig shape (40 B, 7 ARM insns + 3 pool words):
 *
 *     ldr   r2, .L_pool_0              ; r2 = 0x04001000 (DISPCNT MMIO)
 *     ldr   ip, .L_pool_1              ; ip = &func_0208cd64 (helper ptr)
 *     ldr   r1, [r2]                   ; r1 = *MMIO
 *     ldr   r0, .L_pool_2              ; r0 = &data_021a631c (helper arg)
 ...
 *
 *   - 0208cc18: bic #0x80000000, helper func_0208cd64, data 021a631c
 *   - 0208cc40: bic #0x40000000, helper func_0208cd64, data 021a631a
 *   - 0208ce48: bic #0x80000000, helper func_0208cf6c, data 021a631c
 *   - 0208ce70: bic #0x40000000, helper func_0208cf6c, data 021a631a
 *
...
int func_0208cc18(void) {
    DISPCNT &= ~0x80000000;
    return func_0208cd64(data_021a631c);
}
