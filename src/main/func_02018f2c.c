/* func_02018f2c: 2D distance between two points in the system-work block —
 ...
 * func_0208bf3c is FX_Sqrt(fx32). Operand-identical to baserom.
 */
...
extern fx32 func_0208bf3c(fx32 x);   /* FX_Sqrt */
