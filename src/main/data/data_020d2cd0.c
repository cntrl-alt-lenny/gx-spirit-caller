/* data_020d2cd0 (16 bytes, array shape, zero internal outgoing relocations):
 ...
 * 0x020d2cd0-0x020d2ce0.
 * Not const: ground truth section is .data (delinks.txt).
 */
unsigned char data_020d2cd0[16] = {
    0x10, 0x00, 0x2a, 0xf5, 0x00, 0x00, 0x00, 0x11, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00,
};
