/* data_020fe338 (12 bytes, struct shape, one internal outgoing relocation at
...
extern char data_020fe350;

PtrRecord12_8 data_020fe338 = {
    { 0x16, 0x00, 0x2e, 0xf5, 0x00, 0x00, 0x00, 0xf8 },
    &data_020fe350,
};
