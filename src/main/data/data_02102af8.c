/* data_02102af8 (8 bytes, 4-aligned): UTF-16LE wide string "nan\0"
 * (lowercase, unsigned) -- member 9 of 9 in the same family as
 * data_02102ac8 (see that file for the full family map; this is the
 * last member, immediately followed by the already-landed
 * data_02102b00 at 0x02102b00). Non-const: main's .data spans
 ...
 *   - func_020ad96c.s:129 (_LIT9, decl :268) -- %a/%A hexfloat
 *     formatter, positive-NaN + lowercase branch.
 *     relocs.txt: from:0x020adcfc kind:load to:0x02102af8 module:main.
 *   - func_020ade28.s:176 (_LIT9, decl :472) -- %e/%f/%g decimal
 *     formatter, positive-NaN + lowercase branch.
 *     relocs.txt: from:0x020ae46c kind:load to:0x02102af8 module:main.
 *
 ...
 * 0x02102af8 (USA and JPN identical) gives ASCII "15625\0\0\0" -- a
 ...
 * this byte content if data_02102af8 is ever carved under
 * src/usa/main/ or src/jpn/main/ -- re-extract fresh from that
 * region's arm9.bin.
 */
unsigned short data_02102af8[4] = {
    0x006e, 0x0061, 0x006e, 0x0000,
};
