/* data_020d39a8 (24 bytes, array shape, zero internal outgoing relocations):
 ...
 * 0x020d39a8-0x020d39c0.
 * Not const: ground truth section is .data (delinks.txt).
 */
unsigned char data_020d39a8[24] = {
    0x32, 0x00, 0x00, 0xf2, 0x00, 0x00, 0x00, 0x44, 0x00, 0x00, 0x00, 0xff,
