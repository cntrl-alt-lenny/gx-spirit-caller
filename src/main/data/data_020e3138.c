/* data_020e3138 (12 bytes, struct shape, one internal outgoing relocation at
...
extern char data_020e3264;

PtrRecord12_8 data_020e3138 = {
    { 0x39, 0x00, 0x2e, 0xf5, 0x00, 0x00, 0x00, 0xf8 },
    &data_020e3264,
};
