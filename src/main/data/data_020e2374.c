/* data_020e2374 (12 bytes, struct shape, one internal outgoing relocation at
...
extern char data_020e2404;

PtrRecord12_8 data_020e2374 = {
    { 0x00, 0x00, 0x00, 0x53, 0x00, 0x00, 0x00, 0xf8 },
    &data_020e2404,
};
