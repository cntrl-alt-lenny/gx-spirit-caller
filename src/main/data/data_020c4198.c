/* data_020c4198 (16 bytes, array shape, zero internal outgoing relocations):
 ...
 * 0x020c4198-0x020c41a8.
 * Not const: ground truth section is .data (delinks.txt).
 */
unsigned char data_020c4198[16] = {
    0x83, 0x54, 0x83, 0x45, 0x83, 0x93, 0x83, 0x68, 0x83, 0x65, 0x83, 0x58,
    0x83, 0x67, 0x00, 0x00,
};
