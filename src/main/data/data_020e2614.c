/* data_020e2614 (12 bytes, struct shape, one internal outgoing relocation at
...
extern char data_020e27b8;

PtrRecord12_8 data_020e2614 = {
    { 0x2a, 0x00, 0x2e, 0xf5, 0x00, 0x00, 0x00, 0xf8 },
    &data_020e27b8,
};
