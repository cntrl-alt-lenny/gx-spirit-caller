/* data_020c4118 (16 bytes, array shape, zero internal outgoing relocations):
 ...
 * 0x020c4118-0x020c4128.
 * Not const: ground truth section is .data (delinks.txt).
 */
unsigned char data_020c4118[16] = {
    0x83, 0x4e, 0x83, 0x8d, 0x81, 0x5b, 0x83, 0x5b, 0x83, 0x62, 0x83, 0x67,
    0x00, 0x00, 0x00, 0x00,
};
