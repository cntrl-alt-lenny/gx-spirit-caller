/* data_020c77d0 (16 bytes, array shape, zero internal outgoing relocations):
 ...
 * 0x020c77d0-0x020c77e0.
 * Not const: ground truth section is .data (delinks.txt).
 */
unsigned char data_020c77d0[16] = {
    0x1e, 0x00, 0x00, 0x48, 0x00, 0x00, 0x80, 0xff, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x11,
};
