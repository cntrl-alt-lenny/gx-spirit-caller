/* data_020fd968 (12 bytes, struct shape, one internal outgoing relocation at
...
extern char data_020fd98c;

PtrRecord12_8 data_020fd968 = {
    { 0x06, 0x00, 0x2f, 0xf5, 0x00, 0x00, 0x00, 0xf8 },
    &data_020fd98c,
};
