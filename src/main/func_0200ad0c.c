/* CAMPAIGN-PREP candidate for func_0200ad0c (main, class A) — brief 494.
 ...
 *   confidence: med
 */
/* func_0200ad0c — mul-index init: store id, post a task, Fill32 the buffer, clear fields.
...
extern S8 data_02186ae8;

void func_0200ad0c(int id)
{
    S8 *s = &data_02186ae8;
    int n = id * 0x284;
    void *t;
