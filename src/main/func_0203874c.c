/* func_0203874c: medium-tier — short-struct variant of func_020386f4.
 *
 ...
 *
 * 24 ARM instructions, 0x60 bytes. Same semantics as func_020386f4,
 ...
 *
 * The signed-clamp tail (same as func_020386f4) makes sense here
...
int func_0203874c(anim_linear_short_t *obj, int target, unsigned short frames) {
