/* CAMPAIGN-PREP candidate for func_020684b4 (main, class A) — brief 494.
 ...
 *   confidence: high
 */
/* func_020684b4: leaf two-field setter. Store int arg at +0x8,
...
void func_020684b4(obj_020684b4_t *p, int a, unsigned short b) {
    p->f_8 = a;
    p->f_c = b;
}
