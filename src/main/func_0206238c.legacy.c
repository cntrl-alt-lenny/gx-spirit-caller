/* func_0206238c: allocate+copy a buffer sized from func_02064db0's 2nd
 ...
 * home spill (0x10) -- so `sp+0x34`/`sp+0x38` (func_02064db0's two
...
extern void func_02061150(void *arg);
extern void *func_02061018(void *dst, void *src);
extern void func_02062d88(void *self, void *arg);

int func_0206238c(struct S0206238c *a, int b, int c, int *d) {
    int scratch[9];

    func_02064db0(&b, &c);
    if (c > 0) {
        a->field_38 = func_020453e8(c);
        if (a->field_38 == 0) {
            return 1;
        }
        func_020a7368((void *)a->field_38, (signed char *)b, c);
        a->field_3c = c;
    }
    ...
    func_02061150(scratch);
    func_02061018((char *)a + 0x68, scratch);
    func_02062d88(a, scratch);
    a->field_c = 0;
    return 0;
}
