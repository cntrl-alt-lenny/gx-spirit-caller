/* CAMPAIGN-PREP candidate for func_0206f45c (main, class A) — brief 494.
 ...
 *   confidence: med
 */
/* func_0206f45c (main, class A): tiny byte-stream skip scanner, leaf.
...
unsigned char *func_0206f45c(unsigned char *p)
{
    unsigned char c;
