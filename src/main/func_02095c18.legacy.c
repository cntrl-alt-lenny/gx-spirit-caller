/* func_02095c18: zero-init an 8-element array of 12-byte structs.
 *
 *     ldr r1, _LIT0             ; r1 = &data_021a8220
 *     mov r2, #0x0
 *     mov r0, r2
 * .L_c:
 *     str r0, [r1]
...
extern struct s_02095c18_elem data_021a8220[8];

void func_02095c18(void) {
    int i = 0;
    int zero = i;
    struct s_02095c18_elem *p = data_021a8220;
