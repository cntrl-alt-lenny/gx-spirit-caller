/* func_02021158 — C-34 re-audit. Same duplicate-pool shape as
 * func_0202111c (data_02194340), fixed the same way: a raw literal-
 * address-cast for the immediately-dereferenced test value (proven
 * recipe, see src/main/func_0202a1cc.c), and the symbol reference held
 ...
 * held for a later conditional use (matches func_0202111c's finding).
...
extern void func_02021934(int *p);
