...
extern void func_020945f4(void *arg0, int arg1, int arg2);
extern void func_02071028(void *arg0);
extern int func_0206ef0c(void *arg0);
extern void func_02071010(void);

int func_0206e284(void *arg0) {
    ...
    vtable = data_0219ecd8;
    ptr = ((void *(*)(int))(*(void **)((char *)vtable + 0x18)))(0xfd0);
    if (ptr == 0) {
        return 0;
    }
    func_020945f4(buf, 0, 0x64);
    *(void **)(buf + 0x40) = ptr;
    *(int *)(buf + 0x3c) = 0xb68;
    *(void **)(buf + 0x4c) = (char *)ptr + 0xb68;
    *(int *)(buf + 0x48) = 0x466;
    func_02071028(buf);
    result = func_0206ef0c(arg0);
    func_02071010();
    vtable = data_0219ecd8;
