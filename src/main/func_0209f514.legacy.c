/* func_0209f514: validates a bunch of preconditions on a context
 * (returned by func_0209dca8()->field4), then builds a 0x30-byte
 * request packet (0xe tag, param1/param2>>1/param3/param4, plus a
 * 0x1c-byte payload copied from param5) and submits it via
 * func_0209dcb8. Returns an error code from the first failing check,
...
extern int func_0209e628(void);
extern int func_0209e710(void);
extern void func_0209de5c(int code, void *param0);
...
int func_0209f514(void *param0, void *param1, int param2, int param3,
                   unsigned short param4, void *param5)
{
    char *r5;
    int rc;

    r5 = *(char **)((char *)func_0209dca8() + 4);

    rc = func_0209db88(2, 7, 8);
    if (rc != 0) {
        return rc;
    }

    func_020928cc(r5 + 0x188, 2);
    func_020928cc(r5 + 0xc6, 2);
    ...
    func_020928cc(r5 + 0x9c, 2);
    if (*(unsigned short *)(r5 + 0x9c) == 0) {
        if (param2 < func_0209e628()) {
            return 6;
        }
        if (param4 < func_0209e710()) {
            return 6;
        }
    }

    func_0209de5c(0xe, param0);
