/* func_020058b4: IRQ-bracketed VBlank-flag clear.
 * Disables VBlank IE bit, clears data_021040ac[0x4], re-enables VBlank.
 *
 *     stmdb sp!, {r3, lr}
 *     ldr   r0, .L_020058e8            ; r0 = REG_IE (0x04000210)
 *     ldr   r0, [r0, #0x0]             ; read IE
 *     bic   r0, r0, #0x1               ; clear VBlank bit
 *     bl    func_0209065c              ; write IE (sys-level IE writer)
 *     ldr   r0, .L_020058ec            ; r0 = &data_021040ac
 *     mov   r2, #0x0
 *     ldr   r1, .L_020058e8            ; r1 = REG_IE (reload — mwcc's
 *                                      ;   2nd pool ref, NOT deduped)
 *     str   r2, [r0, #0x4]             ; data_021040ac[0x4] = 0
 *     ldr   r0, [r1, #0x0]             ; re-read IE
 *     orr   r0, r0, #0x1               ; set VBlank bit
 *     bl    func_0209065c              ; write IE
 *     ldmia sp!, {r3, pc}
 *   .L_020058e8: .word 0x4000210      ; REG_IE
 *   .L_020058ec: .word data_021040ac
 *
