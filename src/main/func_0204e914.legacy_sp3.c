/* func_0204e914: snprintf into a 0x200-byte stack buffer, append a
 * single byte + NUL, optionally append a caller string d, then hand
 * the buffer off to func_0205538c.
 *
 *   n = OS_SNPrintf(buf, 0x200, data_020ff9d4, data_020ff9dc, 3, data_020ff9e4);
...
extern void func_0205538c(void *a, void *c, char *buf);
extern char data_020ff9d4[];
extern char data_020ff9dc[];
extern char data_020ff9e4[];

void func_0204e914(void *a, int b, void *c, char *d) {
    char buf[0x200];
    char *buf1 = buf + 1;
    int n;
    char *appendPos;
