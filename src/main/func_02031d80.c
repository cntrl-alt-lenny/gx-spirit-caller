/* func_02031d80: pass-through indirect dispatcher to data->fnptr_0xc(arg).
 *
 *     stmdb sp!, {r3, lr}
 *     ldr r1, .L_02031d94
...
extern data_0219adb8_t data_0219adb8;

int func_02031d80(int arg) {
    return data_0219adb8.fnptr_c(arg);
}
