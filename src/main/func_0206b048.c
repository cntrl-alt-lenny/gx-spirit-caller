/* CAMPAIGN-PREP candidate for func_0206b048 (main, class A) — brief 494.
 ...
 *   confidence: high
 */
/* func_0206b048 (default mwcc 2.0/sp1p5, leaf).
...
void func_0206b048(struct P *p, int ch, int *counter) {
