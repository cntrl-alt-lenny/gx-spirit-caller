/* func_0209e628: fetches the singleton object from func_0209dca8(),
 * runs a check via func_0209db88(2,7,8) (bail with 0 on failure),
 * refreshes several fields of obj->inner via func_020928cc(addr, len),
...
int func_0209e628(void) {
    func_0209e628_Obj *obj = (func_0209e628_Obj *)func_0209dca8();
    int isZero;
    unsigned short f3e;
    ...
    func_020928cc(obj->inner + 0xc, 4);

    if (*(int *)(obj->inner + 0xc) == 1) {
        return 0;
    }

    func_020928cc(obj->inner + 0x188, 2);

    isZero = (*(unsigned short *)(obj->inner + 0x188) == 0);

    func_020928cc(obj->inner + 0x3e, 2);
    ...
    func_020928cc(obj->inner + 0xf8, 2);
