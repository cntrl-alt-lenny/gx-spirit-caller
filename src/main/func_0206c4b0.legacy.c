/* func_0206c4b0: lock a sub-object's embedded mutex (obj+0xe0), reset
 * some state, fetch a pair of values via func_02070ce0, stash them into
...
extern void func_02070f78(int a0, int a1, int a2);
extern void func_02070e54(void);
extern int func_02070ce0(unsigned short *out1, int *out2);
extern void func_02092748(void *mutex);

int func_0206c4b0(struct S0206c4b0 *a) {
    ...
    func_020927b8((char *)obj + 0xe0);
    func_02070f78(a->field_10, 0, 0);
    func_02070e54();
    obj->field_f8 = 0;
    result = func_02070ce0(&local1, &local2);
    *a->field_14 = local1;
    *a->field_18 = result;
    ctx->field_70 |= 4;
    func_02092748((char *)obj + 0xe0);
    return 0;
}
