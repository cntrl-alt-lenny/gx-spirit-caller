/* func_020970a8: set dev->+0x1c bit 0x200, dispatch through
 * dev->+0x50(dev, param1, param0->+0x4, param2). Result 0/1 clears the
 * bit back; result 6 spins func_02091a8c(dev+0xc) under IRQ-disable
...
extern void func_02091a8c(void *a);

int func_020970a8(void *param0, int param1, int param2)
{
