/* func_0201b708: GetSystemWork + helper + OR field write.
 *
 *     push {r3, r4, r5, lr}
 *     mov r5, r0
 *     bl GetSystemWork; mov r4, r0
 *     mov r0, r5; bl func_0201b6d4
...
extern int func_0201b6d4(int arg);

void func_0201b708(int arg) {
    struct F0201b708_SysWork *w = GetSystemWork();
    w->f8f4 |= func_0201b6d4(arg);
}
