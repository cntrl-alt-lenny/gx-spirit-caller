/* CAMPAIGN-PREP candidate for func_0201f1f8 (main, class A) — brief 494.
 ...
 *   confidence: med
 */
/* func_0201f1f8: guard chain. If arg->f_2 (u16) != 0: f19c(); return
 * f138(9). Else branch on data_02191f40.f_24: if set, r=f25c(); if r!=0
