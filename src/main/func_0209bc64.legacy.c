/* func_0209bc64: sibling of func_0209bba4 (same data_021a8438 struct
...
int func_0209bc64(void *a0, void (*callback)(void), int a2) {
    ...
    data_021a8438.f_0 = 1;
    OS_RestoreIrq(saved);
    data_021a8438.f_14 = 0;
    data_021a8438.f_18 = 0;
    data_021a8438.f_8 = (int)a0;
    data_021a8438.f_4 = (int)callback;
    data_021a8438.f_10 = a2;
    return (func_0209bdb8() != 0) ? 0 : 3;
}
