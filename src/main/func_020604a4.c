/* CAMPAIGN-PREP candidate for func_020604a4 (main, class A) — brief 494.
 ...
 *   confidence: low
 */
/* func_020604a4: 3-instruction stub that homes the four argument registers
