/* func_02024430 -- C-34 re-audit (cm-parked-reaudit-2 batch A).
 * Literal-address-cast lever: orig has 2 distinct pool slots for
 * data_0219a8ec. The symbol-form reference is a persistent pointer
...
extern Overlay0219a8ec data_0219a8ec;
extern Blob020be754    data_020be754;
extern Overlay0219a8f4 data_0219a8f4;

extern void Fill32(unsigned int value, void *dst, unsigned int size);
extern int  Task_PostLocked(int a0, int a1, int a2);
extern void func_02026f78(void *a0, int a1, int a2, int a3);

int func_02024430(int param)
{
    Blob020be754 localbuf;
    Overlay0219a8ec *p_sym = &data_0219a8ec;
    Overlay0219a8ec *p_literal = (Overlay0219a8ec *)0x0219a8ec;
    Overlay0219a8f4 *p_f4;

    localbuf = data_020be754;
    ...
    p_f4->half6 = 0x80;
    p_f4->word1c = 0;
    func_02026f78(&localbuf, 0, 0x80, 5);
