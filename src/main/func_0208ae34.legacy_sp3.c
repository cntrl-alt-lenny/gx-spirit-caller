/* func_0208ae34: generic 3-callback vtable dispatcher. vt->+0x8 (pre)
 * and vt->+0x10 (post) are optional (NULL-checked), each taking
 * (p0,p1,p2,p3,extra-arg); vt->+0x4 (main) is mandatory and takes
 * (p0,p1,p2,vt-self). Finishes with 2 fixed calls to func_02092904. */
...
void func_0208ae34(int param0, int param1, int param2, int param3, VTable *vt)
{
    if (vt->pre_fn != 0)
    ...
    func_02092904(param0, param2);
    func_02092904(param1, param2);
}
