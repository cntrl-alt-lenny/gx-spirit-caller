...
extern char data_ov004_0220b2a0[];   /* primary BSS state struct             */
extern char data_ov004_0220b308[];   /* parallel table, indexed [idx << 2]   */
extern char data_ov004_02211230[];   /* record A (init/reset target)         */
extern char data_ov004_022112d8[];   /* record B (init target)               */
extern char data_ov004_02291388[];   /* global lock flag (timer gate)         */
extern char data_ov004_0220e2a0[];   /* secondary state struct               */
extern char data_ov004_0220efc8[];   /* f228 record array (stride 84)        */

/* --- data_ov004_0220b2a0 field map (byte offsets; § = byte-verified) ------
 ...
 *   func_ov004_021c9e10(id)             id-change handler
 */
 ...
 *    021ce1bc  (ALL need cached `char *b = data_ov004_0220b2a0;` — bare access
