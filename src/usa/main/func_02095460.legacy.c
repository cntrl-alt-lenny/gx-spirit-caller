/* func_02095460: IRQ-bracketed wrap-aware "arg <= data_021a6670"
...
extern unsigned int data_021a6670;

int func_02095460(unsigned int arg) {
    int saved = OS_DisableIrq();
    unsigned int v;
    if (arg > data_021a6670) {
        if ((arg - data_021a6670) < 0x80000000u) v = 0;
        else v = 1;
    } else {
        if ((data_021a6670 - arg) < 0x80000000u) v = 1;
        else v = 0;
    }
    OS_RestoreIrq(saved);
    return v;
