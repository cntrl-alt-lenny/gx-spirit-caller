/* func_0201b7a0: extract bits 28..31 (top nibble) of obj[0xc] via r4
 ...
 * initialised. Same "seemingly-dead call" pattern as func_0201967c.
 */

extern char *GetSystemWork(void);

unsigned int func_0201b7a0(void *obj) {
    int v;
    (void)GetSystemWork();
    v = *(int *)((char *)obj + 0xc);
