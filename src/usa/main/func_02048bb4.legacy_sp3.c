/* CAMPAIGN-PREP candidate for func_02048bb4 (main, class A) — brief 494.
 ...
 *   confidence: med
 */
/* func_02048bb4: leaf. Through *data_0219dba0 (p), call the function
 * pointer p->f_2c with (0, (u8)p->b_1d, p->f_30); then store 2 into
 * p->f_0. sp3 routing.
 *
 *     ldr r1,=data_0219dba0 ; mov r0,#0 ; ldr r3,[r1]   ; r3 = *p
 *     ldrb r1,[r3,#0x1d] ; ldr r2,[r3,#0x30] ; ldr r3,[r3,#0x2c]
 *     blx r3                                  ; (*f_2c)(0, b_1d, f_30)
 *     ldr r0,=data_0219dba0 ; mov r1,#2 ; ldr r0,[r0] ; str r1,[r0]
 *                                              ; p->f_0 = 2 */
...
extern state_02048c28_t *data_0219dba0;

void func_02048bb4(void) {
    data_0219dba0->f_2c(0, data_0219dba0->b_1d, data_0219dba0->f_30);
    data_0219dba0->f_0 = 2;
}
