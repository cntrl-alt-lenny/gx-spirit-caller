/* func_020a5a50: copy a0's mode byte into a1dst, then dispatch on it.
...
extern void *data_021a9844;
extern Data021a9928 data_021a9848;
extern int func_020a5940(int x);
extern void func_02094688(void *a, void *b, int c);
extern int func_020a59a0(void *a, int b);

int func_020a5a50(SrcObj020a5b44 *a0, DstObj020a5b44 *a1dst, int a2) {
    int r4_result;
    ...
    switch (mode) {
    case 7:
        if (func_020a5940(a2) != 0) {
            return (int)((char *)data_021a9844 + (a2 - 1) * 32);
        }
        *(unsigned char *)&a1dst->field_0x2 = a0->field_0x1;
        if (*(unsigned char *)&a1dst->field_0x2 > data_021a9848.field_0x4) {
            return 0;
        }
        func_02094688((char *)a0 + 2, (char *)a1dst + 3, data_021a9848.field_0x0);
        r4_result = func_020a59a0(a1dst, a2);
        break;
    ...
    case 9:
        ...
        a1dst->field_0x2 = a0->field_0x1 & 0xff;
        a1dst->field_0x2 = a1dst->field_0x2 | ((a0->field_0x2 << 8) & 0xff00);
        func_02094688((char *)a0 + 3, (char *)a1dst + 4, data_021a9848.field_0x0);
        r4_result = r4_result + data_021a9848.field_0x0;
        break;
