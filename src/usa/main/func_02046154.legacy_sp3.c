/* CAMPAIGN-PREP candidate for func_02046154 (main, class A) — brief 494.
 ...
 *   confidence: high
 */
/* func_02046154: dispatch on (*arg).field_4 against three magic
 * constants; if any matches, early-return; else tail-call
 * func_02046494(3). sp3 routing (push {lr} + sub sp,#4 + pop {pc}).
 *
 *     ldr r1, [r1, #0x4]
 *     cmp r1, 0x603 -> return
 *     cmp r1, 0x901 -> return
 *     cmp r1, 0xb01 -> return
 *     mov r0, #3 ; bl func_02046494 ; return
 *
...
extern void func_02046494(int v);

void func_02046154(int a, obj_020461fc_t *p) {
    (void)a;
