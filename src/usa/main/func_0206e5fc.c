/* CAMPAIGN-PREP candidate for func_0206e5fc (main, class A) — brief 494.
 ...
 *   confidence: high
 */
/* func_0206e5fc: store a 32-bit word big-endian into a byte buffer.
 *   dst[0] = (u8)(v >> 24);
 *   dst[1] = (u8)(v >> 16);
 *   dst[2] = (u8)(v >> 8);
 *   dst[3] = (u8) v;
...
void func_0206e5fc(unsigned int v, unsigned char *dst) {
