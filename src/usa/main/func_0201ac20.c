/* func_0201ac20: return pointer into data_020b5998 at stride 6,
 * 1-indexed. `data_020b5998 + (arg - 1) * 6`.
 *
 *     stmdb sp!, {r4, lr}
 *     mov   r4, r0
 *     bl    GetSystemWork
...
extern char data_020b5998[];

char *func_0201ac20(int idx) {
    (void)GetSystemWork();
    return data_020b5998 + (idx - 1) * 6;
}
