/* func_02019000: hard-tier bitfield-getter — extracts the low u16 from
 * state[0x8d4] (the same 32-bit word sign-extracted by func_02019630 /
 * func_02019668 in adjacent slots).
 *
...
unsigned short func_02019000(void) {
