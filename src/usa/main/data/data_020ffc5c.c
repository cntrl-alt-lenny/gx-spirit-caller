 ...
 *
 * Anchor: data_020ffc5c @ 0x020ffc5c, size 20 bytes (5 words). Bundle terminates at the next
 * 4-aligned named symbol (0x020ffc70).
 *
 ...
 *   - data_020ffc60 @ +0x4 (VA 0x020ffc60)
 *
