/* CAMPAIGN-PREP candidate for func_0208577c (main, class A) — brief 494.
 ...
 *   confidence: med
 */
/* func_0208577c: struct init, constant stores in asm order. */
struct init_85864 {
    int f00;   /* +0x00 = 0x1000 */
    int f04;   /* +0x04 = 0 */
...
void func_0208577c(struct init_85864 *p) {
    p->f00 = 0x1000;
    p->f04 = 0;
    p->f10 = 0;
    p->f14 = 0x1000;
