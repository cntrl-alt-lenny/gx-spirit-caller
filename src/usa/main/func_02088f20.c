/* func_02088f20: indexed-by-16 store at offset 0x14 of stride-16 record.
 *
 *     ldr r2, .L_02089020
...
extern state_021a5800_inner_t *data_021a5720;

void func_02088f20(int idx, int arg) {
    char *arr = data_021a5720->arr_84;
