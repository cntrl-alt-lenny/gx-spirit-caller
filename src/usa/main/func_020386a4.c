/* func_020386a4: medium-tier — cousin of the PR #115 interpolation
 * family (func_0203c594 + siblings), with richer return semantics.
 *
 ...
 * func_0203c594's step-is-always-positive clamp: here the ramp can
...
int func_020386a4(anim_linear_t *obj, int target, unsigned short frames) {
