/* CAMPAIGN-PREP candidate for func_02038118 (main, class A) — brief 494.
 ...
 *   confidence: med
 */
/* func_02038118: resolve id via func_02037b08, validate a 4-bit field,
 * write arg, optionally notify, return 1/0.
 *
 *   e = func_02037b08(id); if (!e) return 0;
 *   if (((e->f34 >> 20) & 0xf) != 1) return 0;
 *   e->f1a = (u16)v;
 *   if (!(e->f68 & 0x6000)) func_02087c44(&e->f04, v);
 *   return 1;
 */
...
extern void func_02087c44(void *p, int v);

int func_02038118(int id, int v) {
    Entry68 *e = func_02037b08(id);
