/* CAMPAIGN-PREP candidate for func_02038220 (main, class D, MED tier) — brief 496.
 ...
 *   confidence: high
 */
/* func_02038220 (class D, store-order): obj r0, mode r1, b r2, c r3, d [sp].
...
int func_02038220(unsigned char *obj, int mode, int b, int c, int d) {
    unsigned short h;
