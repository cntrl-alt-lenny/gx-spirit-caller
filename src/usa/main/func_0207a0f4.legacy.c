/* func_0207a0f4: dispatches on a->state (u16) via a 5-entry jump
 * table (0-4). Case 0 further dispatches on
 * func_0209e828(func_0207a370, 0)'s result (2/3/8/other). Cases 1
...
extern int func_0207a370(void);
extern int func_0207af50(int mode);
extern int func_0207ae40(void);
extern int func_0207b054(int a, void *b, int c, int d);
extern int func_0209e828(void *fn, int x);

int func_0207a0f4(Obj_0207a1dc_t *a) {
    switch (a->state) {
    case 0: {
        int result;

        if (*(int *) ((char *) data_021a07ac + 0x2000 + 0x260) == 0xc) {
            func_0207af50(0xa);
            return func_0207ae40();
        }

        result = func_0209e828((void *) func_0207a370, 0);
        ...
        func_0207af50(0xc);
        return func_0207b054(1, (char *) data_021a07ac + 0x2140, 0, 0x8b4);
    ...
    case0_other:
        func_0207af50(0xb);
        return func_0207b054(7, (char *) data_021a07ac + 0x2140, 0, 0x8c0);
    }
    ...
    case 4:
        func_0207af50(0xb);
        return func_0207b054(7, (char *) data_021a07ac + 0x2140, 0, 0x8d3);
    }
}
