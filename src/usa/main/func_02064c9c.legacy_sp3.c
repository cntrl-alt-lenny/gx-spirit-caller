/* func_02064c9c: build a small key struct on the stack, wrap a pointer
 * to it, call func_020543b8(p->field_c, &wrapper), then return
...
extern int *func_020543b8(void *ctx, Key **wrapper);

int *func_02064c9c(void *p, int a, short b) {
    Key key;
    Key *wrapper;
    int *res;
    ...
    key.field4 = b;
    wrapper = &key;
    res = func_020543b8(((void **)p)[3], &wrapper);
