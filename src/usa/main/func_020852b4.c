/* func_020852b4: iterate i = 0..(arg0->f_18 - 1) and call func_02085334
 ...
 *
 * 16 insns = 0x40 bytes. Sibling func_020852f4 calls func_02085378
...
extern void func_02085334(state_0208539c_t *p, int i, int arg2);

void func_020852b4(state_0208539c_t *p, int arg1) {
    u32 i;
    for (i = 0; i < p->f_18; i++) {
        func_02085334(p, i, arg1);
    }
}
