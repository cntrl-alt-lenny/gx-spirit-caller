/* CAMPAIGN-PREP candidate for func_0207e6f0 (main, class A) — brief 494.
 ...
 *   confidence: med
 */
/* func_0207e6f0: linear scan over an offset-linked element list.
 *
 *   stmfd sp!, {lr}
 *   sub   sp, sp, #0x4
...
void *func_0207e6f0(Cont0207e7d8 *p, int key) {
    char *e = (char *)p + p->off;
    unsigned short i, n;
    n = p->count;
    for (i = 0; i < n; i++) {
