/* func_0203ca28: gated dispatch — bit-test/clear in ctx->flags then callback.
...
extern ctx_0203ca78_t *func_0203c8b0(int x);

void func_0203ca28(int mask, int arg1, int arg2) {
    ctx_0203ca78_t *ctx = func_0203c8b0(1);
