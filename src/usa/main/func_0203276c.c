/* func_0203276c: null-check + helper + null-write, large struct offset (0xea8).
 *
 *     push  {r4, lr}
 *     mov   r4, r0
 *     ldr   r1, [r4, #0xea8]
...
extern void func_02032e18(struct Func020327c0Self *self);

void func_0203276c(struct Func020327c0Self *self) {
    if (self->p == 0) return;
    func_02032e18(self);
    self->p = 0;
}
