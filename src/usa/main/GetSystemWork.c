/* GetSystemWork (was GetSystemWork): rename-cascade pilot (brief 014).
 *
 * Returns the address of the arm9 main system state singleton at
 * `data_02104e78` — a 0x92c-byte BSS structure accessed by 189
 ...
 *
 *     ldr r0, .L_02018b30           ; r0 = &data_02104e78
 *     bx  lr
 *   .L_02018b30: .word data_02104e78
 *
 ...
 *
 * Note: the data symbol `data_02104e78` is intentionally left as a
 ...
 *
 * Ported from src/main/GetSystemWork.c (EUR) via port_to_region.py —
 * data_02104f58 (EUR) → data_02104e78 (USA/JPN, EXACT_ADDR confidence).
 */

extern char data_02104e78[];

char *GetSystemWork(void) {
    return data_02104e78;
}
