/* CAMPAIGN-PREP candidate for func_0200fda4 (main, class A) — brief 494.
 ...
 *   confidence: high
 */
/* func_0200fda4: walk the list @data_0218dae8+0x910, matching the
