/* func_0202e1e0: first non-trivial hard-tier match — two-condition
 ...
 *     bl    func_0202b83c            ; else r0 = func_0202b83c(x)
 *     cmp   r0, #0x8
 ...
 * func_0202b83c probably normalizes it or reads a count field.
 *
...
extern int func_0202b83c(int x);

int func_0202e1e0(int x) {
    if (x == 0) goto zero;
    if (func_0202b83c(x) < 8) return 1;
zero:
    return 0;
}
