/* CAMPAIGN-PREP candidate for func_02031aa8 (main, class D, MED tier) — brief 496.
 ...
 *   confidence: low
 */
/* CAMPAIGN-PREP candidate for func_02031aa8 (main, class D, MED tier).
 * UNVERIFIED + ITERATION-EXPECTED. Doubly-linked-list unlink, store-order
 * + reload sensitive (why it shipped as .s).
 *   head = *(Node**)data_0219acd8 (head holder at offset 0)
...
extern struct N_02031afc *data_0219acd8;

void func_02031aa8(struct N_02031afc *node) {
    if (data_0219acd8 == node) {
        data_0219acd8 = node->next;
    }
