/* func_020a6a3c: pattern N1 — sub-shape 2 with trailing helper.
 *
 *     push  {r3, lr}
 *     mov   r0, #1
 *     bl    helper1
...
extern struct Func020a6b30PoolStruct data_021a9e50;
extern void func_020aabb8(int x);
extern void func_020a6a60(int x);

void func_020a6a3c(void) {
    func_020aabb8(1);
    data_021a9e50.f12 = 1;
    func_020a6a60(1);
}
