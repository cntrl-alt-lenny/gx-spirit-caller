/* func_0202c3f8: stride-8 indexed table read on `data_0219a85c.p1`.
 *
 *     ldr r1, .L_0202c468
 *     mov r0, r0, lsl #0x1
 ...
 *     add r0, r2, r0
 *     bx  lr
 *  .L_0202c468: .word data_0219a85c
 *
 * Sibling of func_0202b778 on the inner pointer at offset 4 (instead
...
extern card_ctx3_t data_0219a85c;

char *func_0202c3f8(int idx) {
    card_inner3_t *p = data_0219a85c.p1;
