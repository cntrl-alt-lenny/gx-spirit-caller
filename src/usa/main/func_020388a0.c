/* func_020388a0: store arg at +0x60, then mirror it to +0x5c.
 *
 *     ldr r1, .L_02038904
...
void func_020388a0(int arg) {
    data_0219b200.f_60 = arg;
    data_0219b200.f_5c = data_0219b200.f_60;
}
