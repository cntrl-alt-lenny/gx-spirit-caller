/* CAMPAIGN-PREP candidate for func_020195d0 (main, class A) — brief 494.
 ...
 *   confidence: med
 */
/* func_020195d0: GetSystemWork table-element byte sum. r0 = idx. Element =
...
int func_020195d0(void *o) {
    Elem02019604 *base = (Elem02019604 *)GetSystemWork();
    int idx = func_020191dc(o);
