/* CAMPAIGN-PREP candidate for func_02005d38 (main, class D, MED tier) — brief 496.
 ...
 *   confidence: med
 */
/* func_02005d38: select base table by arg2, then index two short arrays.
 *   base = (arg2==1)? data_02103c8c[0] : (arg2==2)? data_02103c8c[1] : 0;
...
extern void *data_02103c8c[2];

void func_02005d38(int idx, int slot_i, int sel) {
    char *base;
    short *slot;
    switch (sel) {
    case 1:  base = (char *)data_02103c8c[0]; break;
    case 2:  base = (char *)data_02103c8c[1]; break;
