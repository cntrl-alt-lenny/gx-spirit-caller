...
void func_0206b5fc(struct S0206b670_Obj *r6, int r5) {
    int r4 = *(int *)func_0205405c(r6->f_4, r5);
    int f_494 = *(int *)((unsigned char *)r6 + 0x494);
    Cb0206b670 cb = *(Cb0206b670 *)((unsigned char *)r6 + 0x488);

    cb(r6, 2, r4, f_494);

    func_02053de4(r6->f_4, r5);
    func_0206b648(r6, r4);
}
