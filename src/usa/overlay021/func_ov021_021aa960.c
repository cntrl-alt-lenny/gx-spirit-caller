/* func_ov021_021aa960: per-frame sub-state machine (+0x38) with a per-state frame
...
extern void func_ov021_021aaa9c(void *);
extern int  func_02021584(int);
int func_ov021_021aa960(void *o) {
    switch (*(int *)((char *)o + 0x38)) {
    case 0:
        if (*(int *)((char *)o + 0x3c) == 3) {
            func_ov021_021aa9fc(o);
            *(int *)((char *)o + 0x38) = 1;
            *(int *)((char *)o + 0x3c) = 0;
        }
        break;
    case 1:
        func_ov021_021aaa9c(o);
        if (func_02021584(*(int *)o) == 0) {
            *(int *)o = 0;
            *(int *)((char *)o + 0x38) = 2;
            *(int *)((char *)o + 0x3c) = 0;
        }
