...
void func_ov016_021b8b6c(void *arg0, void **arg1) {
    ...
    func_02091554(arg1[0], data_ov016_021b9578, *(unsigned short *)(p + 464) + 75);
    func_02091554(arg1[1], data_ov016_021b9590, *(unsigned short *)(p + 464) + 75);
    func_02091554(arg1[2], data_ov016_021b95a8, *(unsigned short *)(p + 464) + 75);
    func_02091554(arg1[3], data_ov016_021b95c0, *(unsigned short *)(p + 464) + 75);
    if (*(int *)(p + 452) != 0) {
