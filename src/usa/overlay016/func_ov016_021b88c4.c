...
void func_ov016_021b88c4(void *arg0, void **arg1) {
    char *p = arg0;
    int tmp;
    func_02091554(arg1[0], data_ov016_021b93f8, *(unsigned char *)(p + 460));
    func_02091554(arg1[1], data_ov016_021b9418, *(unsigned char *)(p + 460));
    func_02091554(arg1[2], data_ov016_021b9438, *(unsigned char *)(p + 460));
    func_02091554(arg1[3], data_ov016_021b9458, *(unsigned char *)(p + 460));
    if (*(int *)(p + 84) != 0) {
