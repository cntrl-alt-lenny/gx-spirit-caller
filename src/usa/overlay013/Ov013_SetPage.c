/* Ov013_SetPage: switch the active page to `page` (stored in bits [20:18]
 ...
 * Ov013_SlotToCell of the saved page nibble — and re-arms the slide.
 * (ov013_core.h) */
...
void Ov013_SetPage(int page, int reverse) {
    ...
    *(int *)(data_ov013_021cbb20 + 0x1a4) =
    ...
    {
        int cell =
            Ov013_SlotToCell(((unsigned)*(int *)(d + 0x168) << 0xb) >> 0x1d);
        int p = func_02013980();
