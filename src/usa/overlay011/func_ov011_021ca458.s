; func_ov011_021ca458 — whole-function ship-as-.s (GLOBAL_ASM endgame, brief 302):
; the original disassembly emitted verbatim as a byte-exact mwasm TU.
; For reg-alloc-walled functions with no C match (brief 294 endgame).

        .text
        .extern data_ov011_021d2ece
        .extern data_ov011_021d3f20
        .extern func_0201e7c4
        .extern func_0208e334
        .global func_ov011_021ca458
        .arm
func_ov011_021ca458:
    stmdb sp!, {r3, r4, lr}
    sub sp, sp, #0x24
...
.L_14:
    ...
    add sp, sp, #0x24
    ldmia sp!, {r3, r4, pc}
_LIT0: .word data_ov011_021d2ece
