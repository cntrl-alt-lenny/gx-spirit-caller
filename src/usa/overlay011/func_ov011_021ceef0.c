/* func_ov011_021ceef0: read two u16s from data_021d33bc (+0x52,+0x54),
...
extern struct Ov011Src33bc data_ov011_021d32cc;
...
extern struct Ov011Dst4000b data_ov011_021d3f20;

void func_ov011_021ceef0(void) {
    unsigned int h0 = (unsigned int)data_ov011_021d32cc.field_52 << 12;
    unsigned int h1 = (unsigned int)data_ov011_021d32cc.field_54 << 12;
    data_ov011_021d3f20.field_258 = h0;
    data_ov011_021d3f20.field_25c = h1;
    data_ov011_021d3f20.field_254 = 0x1000;
    data_ov011_021d3f20.field_2ac &= ~0x20000;
    data_ov011_021d3f20.field_26c = h0;
    data_ov011_021d3f20.field_270 = h1;
}
