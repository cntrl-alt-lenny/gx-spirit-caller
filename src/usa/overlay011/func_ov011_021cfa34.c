/* func_ov011_021cfa34: write the 4-bit field at bits 12:9 of +0x2b0 from the
...
void func_ov011_021cfa34(int v) {
    *(int *)(data_ov011_021d3f20 + 0x2b0) =
        ((*(int *)(data_ov011_021d3f20 + 0x2b0) & ~0x1e00) | (((unsigned)v << 28) >> 19)) & 0xffe01fff;
}
