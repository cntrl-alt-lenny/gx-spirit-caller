/* func_ov000_021ab6b8: same stride-family register as func_ov000_021ab440,
 ...
 * func_ov000_021ab440 (fixed 0x3f) and func_ov000_021ab4cc (the ratio),
...
extern Bits_ov000_021ab798 data_ov000_021c74a8;
extern void func_ov000_021ab440(int idx, int val);
extern void func_ov000_021ab4cc(int idx, int val);

void func_ov000_021ab6b8(void) {
    Bits_ov000_021ab798 *v = &data_ov000_021c74a8;
    int byte0 = v->byte0;
    int a;
    int factor;
    int div;
    ...
    func_ov000_021ab440(0, 0x3f);
    func_ov000_021ab440(1, 0x3f);
    func_ov000_021ab4cc(0, div);
    func_ov000_021ab4cc(1, div);
