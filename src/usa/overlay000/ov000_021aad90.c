/* func_ov000_021aad90: linked-list traversal — invoke Task_InvokeLocked
 * on each node's handle at +0xc.
 *
 *     stmdb sp!, {r4, lr}
 *     ldr   r0, .L_021aae9c            ; head = *data_ov000_021c744c
 *     ldr   r0, [r0, #0x0]
 *     cmp   r0, #0x0
 *     ldmeqia sp!, {r4, pc}
 *   .L_021aae84:
...
extern ov000_node_t *data_ov000_021c744c;

void func_ov000_021aad90(void) {
    ov000_node_t *p = data_ov000_021c744c;
    while (p != 0) {
