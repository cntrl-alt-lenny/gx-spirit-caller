/* func_ov000_021ab13c: zero-fill state + clear bits 13..15 of two
 * I/O registers at 0x04000000 and 0x04001000 (NDS DISPCNT_A /
 * DISPCNT_B engine-control registers).
 *
 *     stmdb sp!, {r3, lr}
 *     ldr   r1, .L_021ab254            ; r1 = &data_ov000_021c7450
 *     mov   r0, #0x0
 *     mov   r2, #0x5c
...
extern char data_ov000_021c7450[];

void func_ov000_021ab13c(void) {
    ...
    Fill32(0, data_ov000_021c7450, 0x5c);
    *dispcnt_a &= ~0xe000u;
    *dispcnt_b &= ~0xe000u;
}
