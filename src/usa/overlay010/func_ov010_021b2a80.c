 ...
 *   confidence: high
 */
/* func_ov010_021b2a80: dense 0..7 dispatcher. cmp r0,#7; addls pc,pc,r0,lsl#2
...
int func_ov010_021b2a80(int x) {
    switch (x) {
    case 0: return func_0208e138();
    case 1: return func_0208e0e4();
    case 2: return func_0208e038();
    case 3: return func_0208df2c();
    case 4: return func_0208e118();
    case 5: return func_0208e0c4();
    case 6: return func_0208dfb8();
    case 7: return func_0208deac();
    default: return 0;
    }
}
