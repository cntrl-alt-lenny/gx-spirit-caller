/* func_ov010_021b3f3c: compute manager-B's scrollable height — metric * 4 less
...
int func_ov010_021b3f3c(void) {
    char *m = data_ov010_021b90b4;
    int r = func_ov005_021ac8c0(*(int *)(m + 300));
    int n = r * func_ov005_021ab028(*(int *)(m + 296), 4) - 151;
    if (n < 0) n = 0;
