/* func_ov006_021c11f0: build+submit a command record for entry `arg1` (else
...
extern char data_ov006_021cdc58[];
int func_ov006_021c11f0(void *q, int arg1, int slot) {
    char cmd[40];
    char buf[32];
    if (arg1 != 0) {
        int h;
        func_02091554(buf, data_ov006_021cdc58, data_ov006_021cb500[arg1]);
