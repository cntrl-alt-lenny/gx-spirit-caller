/* func_ov006_021b78ac: clear slot's active-bit in the p+0x60b4 stride
 * bitmask table, zero its p+0x5fd0 u16 entry, and Fill32 its p+0x248
 * row (stride 0x124), then notify func_0200925c. */
extern void Fill32(int val, void *dst, int n);
extern void func_0200925c(int zero, int slot);

int func_ov006_021b78ac(void *p, int slot) {
    int *table;
