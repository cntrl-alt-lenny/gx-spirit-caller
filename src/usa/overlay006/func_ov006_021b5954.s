; func_ov006_021b5954 — whole-function ship-as-.s (GLOBAL_ASM endgame, brief 302):
...
; For reg-alloc-walled functions with no C match (brief 294 endgame).
        ...
        .extern func_ov006_021b586c
        .extern func_ov006_021b5894
        .extern func_ov006_021b5a70
        .extern func_ov006_021c9df0
        .extern func_ov006_021ca294
        .global func_ov006_021b5954
        .arm
func_ov006_021b5954:
...
.L_ec:
    mov r6, #0x1
.L_f0:
    bl func_ov006_021b586c
    bl func_ov006_021b5894
    cmp r6, #0x0
    ldrne r0, _LIT2
    movne r1, #0x3
    strne r1, [r0]
