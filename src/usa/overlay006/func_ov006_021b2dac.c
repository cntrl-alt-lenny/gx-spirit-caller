/* func_ov006_021b2dac: per-state "audio init" (channel-gated) — open the per-
...
extern void func_ov006_021b6264(void *);
extern void func_0203737c(int, int, int, int);
extern char data_ov006_0224f0a0[];
...
int func_ov006_021b2dac(void) {
    func_0202ada4(data_ov006_0224f0a0);
    ...
    func_ov006_021b6264(data_ov006_0224f328);
    func_0203737c(0x24, 1, 0, -1);
    data_ov006_0224f090[0] = 2;
    return 1;
}
