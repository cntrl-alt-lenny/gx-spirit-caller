/* func_ov006_021b4c68: C-23 ov006 uniform MMIO family (brief 270 head 021b4d68).
...
extern char data_ov006_0224f1c8[];
int func_ov006_021b4c68(void) {
    func_02021104();
    if (*(int *)(data_ov006_0224f1c8 + 8) != 0) {
        func_0200e9a8();
