/* func_ov006_021b3e10: per-state "enter" — probe two subsystems, run the shared
...
extern void func_ov006_021b3ca8(void);
extern void func_ov006_021b3cd0(void);
