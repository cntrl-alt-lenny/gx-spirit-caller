/* func_ov006_021b4d38: per-state "step" — run the seven fixed per-subobject
 * updates, fire the per-state display-blank "enter", then advance the state
 * word to 1. Returns 1. 0x70 step family, sibling of 021b3ea0 (ov006_core.h). */
...
extern int  func_ov006_021b4bf8(void);
