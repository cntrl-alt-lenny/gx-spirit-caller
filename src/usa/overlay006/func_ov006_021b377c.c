/* func_ov006_021b377c: per-state "enter" (long) — kick the per-state full-init
...
extern void func_ov006_021b349c(int);
...
int func_ov006_021b377c(void) {
    func_ov006_021b349c(1);
    func_ov006_021b9df8(data_ov006_0225c3bc, 2, 0);
