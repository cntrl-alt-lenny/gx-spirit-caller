/* func_ov002_021b3878: walk the linked list rooted at the per-player/slot
 * head in data_ov002_022cf0c6, looking for an entry in data_ov002_022d0570
...
u16 func_ov002_021b3878(int arg0, int arg1) {
    int player = arg0 & 1;
