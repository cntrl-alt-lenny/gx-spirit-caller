/* func_ov002_021c31f4: for player (self&1), if the cf180 counter is
...
int func_ov002_021c31f4(int self, Ov002Callback cb) {
    int off = (self & 1) * 0x868;
    unsigned int n = *(unsigned int *)((char *)data_ov002_022cf0a0 + off);
    int i;
    int count;
    struct Ov002Slot *p;
    char *row;
