/* func_ov002_02296668: brief 228 C-39 wave 3 — helper(1-bit0); bool tail.
 *
...
struct F02296778_Self {
    unsigned short f0;
    struct F02296778_F2 f2;
};

extern int func_ov002_021bbe70(unsigned int v);

int func_ov002_02296668(struct F02296778_Self *self) {
    return func_ov002_021bbe70(1 - self->f2.bit0) >= 2;
}
