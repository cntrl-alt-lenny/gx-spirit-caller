/* func_ov002_022300b8: ptr-copy + helper + LIT-write.
 *
 *     push  {r4, lr}
 *     ldrh  r2, [r1]             ; r2 = *src
 ...
 */
extern int func_ov002_02257c14(unsigned short *dst, unsigned short *src);

int func_ov002_022300b8(unsigned short *dst, unsigned short *src) {
    int r;
    *dst = *src;
    r = func_ov002_02257c14(dst, src);
    *dst = 0x183e;
    return r;
}
