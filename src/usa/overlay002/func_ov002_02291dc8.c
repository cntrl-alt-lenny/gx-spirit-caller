/* func_ov002_02291dc8: brief 228 C-39 wave 3 — helper(1-bit0); bool tail.
 *
...
extern int func_ov002_021bc538(unsigned int v);

int func_ov002_02291dc8(struct F02291ed8_Self *self) {
    return func_ov002_021bc538(1 - self->f2.bit0) >= 2;
}
