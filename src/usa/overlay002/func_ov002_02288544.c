/* func_ov002_02288544: brief 228 C-39 wave 3 — helper(1-bit0); bool tail.
 *
...
struct F02288654_Self {
    unsigned short f0;
    struct F02288654_F2 f2;
};

extern int func_ov002_021bce20(unsigned int v);

int func_ov002_02288544(struct F02288654_Self *self) {
    return func_ov002_021bce20(1 - self->f2.bit0) >= 2;
}
