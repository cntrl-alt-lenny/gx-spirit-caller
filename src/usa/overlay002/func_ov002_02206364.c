/* func_ov002_02206364: C-39b — helper-reuse via callee-saved + cross-call compare.
 *
 ...
 *     bl    func_ov002_021b9d20       ; helper1(bit0, field5)
...
extern int func_ov002_021b9d20(unsigned int bit, unsigned int field5);
extern int func_ov002_021f40a4(struct Func02206454Self *self);

int func_ov002_02206364(struct Func02206454Self *self) {
    int n = func_ov002_021b9d20(self->f2.bit0, self->f2.field5);
    return n >= func_ov002_021f40a4(self);
}
