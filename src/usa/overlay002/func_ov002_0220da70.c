/* func_ov002_0220da70: C-39b helper(bit0, multi5, f0) == 0 → return 0; tail.
...
extern int func_ov002_021ffeb8(struct F0220db60_Self *self, int arg1);

int func_ov002_0220da70(struct F0220db60_Self *self, int arg1) {
    if (func_ov002_021b3dec(self->f2.bit0, self->f2.multi5, self->f0) == 0) return 0;
    return func_ov002_021ffeb8(self, arg1);
}
