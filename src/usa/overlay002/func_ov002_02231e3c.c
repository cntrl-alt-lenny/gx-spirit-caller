/* func_ov002_02231e3c: bit-0 extract + literal-31 arg + helper + return 0.
 *
 ...
 *     bl    func_ov002_021d8750          ; helper(bit0, 31)
 *     mov   r0, #0                       ; return 0
 *     pop   {r3, pc}
 *
 * Brief 222 worked example for C-39 (non-leaf C-37 bitfield
 * recipe). See `func_ov002_0223fc28.c` for the recipe rationale
...
extern int func_ov002_021d8750(unsigned int bit, unsigned int bit_pos);

int func_ov002_02231e3c(struct Func02231f2cSelf *self) {
    func_ov002_021d8750(self->bit0, 31);
    return 0;
}
