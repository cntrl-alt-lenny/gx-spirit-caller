...
extern void func_ov002_021e2ca4(int b0, int idx, int c, int d);

int func_ov002_0221b564(struct Ov002SelfExt *self) {
    struct Ov002Field4 *f4 = (struct Ov002Field4 *)((char *)self + 4);
    char *row = (char *)data_ov002_022cf08c + (self->b0 & 1) * 0x868;
    ...
    func_ov002_021e2ca4(self->b0, idx, 5, 1);
    return 0;
}
