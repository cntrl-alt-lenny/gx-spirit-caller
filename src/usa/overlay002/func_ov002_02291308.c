/* func_ov002_02291308: brief 228 C-39 wave 3 — helper(1-bit0); bool tail.
 *
...
int func_ov002_02291308(struct F02291418_Self *self) {
    return func_ov002_021bce20(1 - self->f2.bit0) > 1;
}
