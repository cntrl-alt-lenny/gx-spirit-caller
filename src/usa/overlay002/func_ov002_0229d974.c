/* func_ov002_0229d974: push a new entry into self's ring buffer.
 *
 * Ground truth for the surrounding family (func_ov002_0229d90c/60) already
...
extern int func_ov002_0229d90c(struct Ov002DaSelf *self, int arg1);

void func_ov002_0229d974(struct Ov002DaSelf *self, struct Ov002DaEntry *src) {
