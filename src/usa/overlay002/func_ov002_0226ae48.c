 ...
 *   confidence: high
 */
/* func_ov002_0226ae48: u16-zext two-arg tail-call shim, selector 3.
 *   mov r3,r2,lsl#16 ; mov r1,r1,lsl#16 ; mov r2,r1,lsr#16
 *   mov r3,r3,lsr#16 ; mov r1,#3 ; bx ip  (-> func_ov002_0226ac08)
 * Callee sig is ground-truth from func_ov002_0226ac08.s:
 ...
 * Mirrors shipped func_ov002_0226b184.c / b0f0.c. */

typedef unsigned short u16;

extern void func_ov002_0226ac08(int a, int sel, u16 c, u16 d);

void func_ov002_0226ae48(int arg0, int arg1, int arg2) {
    func_ov002_0226ac08(arg0, 3, (u16)arg1, (u16)arg2);
}
