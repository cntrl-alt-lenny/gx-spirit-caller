/* func_ov002_021b3bd0: walk the linked list at data_ov002_022d0570 (stride 8,
...
void *func_ov002_021b3bd0(int idx, int id, int val) {
    while (idx != 0) {
        struct Entry3cb0 *e = (struct Entry3cb0 *)(data_ov002_022d0570 + idx * 8);
        int next = e->next;
