/* func_ov002_02203750: brief 227 C-39 wave 2 — single-arg helper, signed-ge bool.
 *
...
extern int func_ov002_021bcf50(unsigned int bit0);

int func_ov002_02203750(struct F02203840_Self *self) {
