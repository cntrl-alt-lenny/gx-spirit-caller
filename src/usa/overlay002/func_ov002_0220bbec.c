/* func_ov002_0220bbec: C-39b helper1(bit0, f4_field9) sign-check + tail. */
...
extern int func_ov002_021ff2cc(struct F0220bcdc_Self *self, int arg1);

int func_ov002_0220bbec(struct F0220bcdc_Self *self, int arg1) {
    if (func_ov002_021b99c8(self->f2.bit0, self->f4.field9) < 0) return 0;
