/* func_ov002_02295034: brief 228 C-39 wave 3 — int n = helper1(self); helper2(bit0, f0, n) <CMP> N.
 *
...
extern int func_ov002_0223f5dc(struct F02295144_Self *self);
extern int func_ov002_02253600(unsigned int bit0, unsigned int f0, int n);

int func_ov002_02295034(struct F02295144_Self *self) {
    int n = func_ov002_0223f5dc(self);
    return func_ov002_02253600(self->f2.bit0, self->f0, n) >= 2;
}
