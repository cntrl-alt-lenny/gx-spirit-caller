/* func_ov002_02295ab0: brief 230 C-39d — helper(bit0)==0 early + helper(bit0, fld5, 1) != 0.
 *
...
extern int func_ov002_021be3c0(unsigned int bit, unsigned int fld, unsigned int k);

int func_ov002_02295ab0(struct F02295bc0_Self *self) {
    if (func_ov002_02259e8c(self->f2.bit0) == 0) return 0;
    return func_ov002_021be3c0(self->f2.bit0, self->f2.fld5, 1) != 0;
}
