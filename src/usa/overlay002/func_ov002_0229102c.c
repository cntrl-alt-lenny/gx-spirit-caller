/* func_ov002_0229102c: brief 227 C-39 wave 2 — two-arg helper, signed-gt bool.
 *
...
extern int func_ov002_022579d0(struct F0229113c_Self *self, unsigned int bit0);

int func_ov002_0229102c(struct F0229113c_Self *self) {
