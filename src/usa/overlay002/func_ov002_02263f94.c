/* func_ov002_02263f94: thunk — `func_ov002_02263e1c` with r1 = 0x16a4.
 *
...
int func_ov002_02263f94(int a, int _unused, int c, int d) {
    return func_ov002_02263e1c(a, 0x16a4, c, d);
}
