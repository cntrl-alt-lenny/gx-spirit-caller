/* func_ov002_021ae558: clone of 021ae60c with subkind constant #7.
 ...
 *     ldr   ip, .L_021ae660           ; func_ov002_0229acd0
 *     mov   r0, #0x31
 *     mov   r1, #0x7
 *     bx    ip
 */
...
void func_ov002_021ae558(int p, unsigned int b, unsigned int c) {
    func_ov002_0229acd0(0x31, 7, p,
