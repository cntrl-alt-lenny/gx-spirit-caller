/* func_ov002_02201720: C-39 — 5-arg call. helper(bit0@2, 5, b6_14@4,
...
extern int func_ov002_021ff05c(int bit0, int k, int bits, int d, int e);

int func_ov002_02201720(struct S02201810 *self) {
    return func_ov002_021ff05c(self->bit0, 5, self->b6_14, 0, 0) != 0;
}
