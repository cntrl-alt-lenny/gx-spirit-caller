/* func_ov002_02203648: if the 6-bit kind field at +0x2 is 0x23, return 1.
...
int func_ov002_02203648(struct S02203738 *self) {
    int *row;
    if (self->kind == 0x23) return 1;
    row = (int *)(data_ov002_022cf08c + ((1 - self->b0) & 1) * 0x868);
