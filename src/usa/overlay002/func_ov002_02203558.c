/* func_ov002_02203558: brief 228 C-39 wave 3 — helper(bit0, -1); bool tail.
 *
...
struct F02203648_Self {
    unsigned short f0;
    struct F02203648_F2 f2;
};

extern int func_ov002_021bcca0(unsigned int bit0, int mask);

int func_ov002_02203558(struct F02203648_Self *self) {
    return func_ov002_021bcca0(self->f2.bit0, ~0) > 1;
}
