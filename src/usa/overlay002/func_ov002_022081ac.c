/* func_ov002_022081ac: brief 228 C-39 wave 3 — helper(bit0, 1); bool tail.
 *
...
extern int func_ov002_021bbc24(unsigned int bit0, unsigned int k);

int func_ov002_022081ac(struct F0220829c_Self *self) {
    return func_ov002_021bbc24(self->f2.bit0, 1) > 0;
}
