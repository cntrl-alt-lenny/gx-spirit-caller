/* func_ov002_021f682c: brief 227 C-39 wave 2 — three-arg helper (bit0,0,1), return 1.
 *
 ...
 *     bl    func_ov002_0226ae48       ; helper(bit0, 0, 1)
 *     mov   r0, #1
 *     pop   {r3, pc}
 *
...
extern void func_ov002_0226ae48(unsigned int bit0, unsigned int z, unsigned int one);

int func_ov002_021f682c(struct F021f691c_Self *self) {
    func_ov002_0226ae48(self->f2.bit0, 0, 1);
    return 1;
}
