/* func_ov002_021b9dd8: thunk — `func_ov002_021b3d48` with r2 = 0x1439.
 *
...
int func_ov002_021b9dd8(int a, int b, int _unused, int d) {
    return func_ov002_021b3d48(a, b, 0x1439, d);
}
