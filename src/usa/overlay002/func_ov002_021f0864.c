/* func_ov002_021f0864: 0x868 wrapper — f30 / opponent / idx guards, require
 * func_ov002_021c1e10, then report func_ov002_021c1d64 clear. */
...
int func_ov002_021f0864(struct self_t *self, int player, int idx) {
