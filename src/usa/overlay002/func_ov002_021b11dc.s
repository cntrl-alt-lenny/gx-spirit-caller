; func_ov002_021b11dc — whole-function ship-as-.s (GLOBAL_ASM endgame, brief 302):
...
; For reg-alloc-walled functions with no C match (brief 294 endgame).
        ...
        .extern func_ov002_0225829c
        .extern func_ov002_022582cc
        .extern func_ov002_022583c4
        .extern func_ov002_02258418
        .extern func_ov002_022584f4
        .extern func_ov002_02271988
        .global func_ov002_021b11dc
        .arm
func_ov002_021b11dc:
    stmdb sp!, {r3, lr}
    ldr r0, _LIT0
...
.L_44:
    mov r0, r1, lsl #0x10
    mov r0, r0, lsr #0x10
    bl func_ov002_022583c4
    ldmia sp!, {r3, pc}
.L_54:
    bl func_ov002_0225829c
    ldmia sp!, {r3, pc}
.L_5c:
    mov r0, #0x0
    mov r1, r0
