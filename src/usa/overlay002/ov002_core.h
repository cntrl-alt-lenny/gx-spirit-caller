...
extern int  func_ov002_021c1e10(struct Ov002Self *self, int player, int idx); /* [member2] */
extern int  func_ov002_021c1d64(struct Ov002Self *self, int player, int idx); /* [member1] */

/* command sink: r0 = command id, r1..r3 = (often packed) payload.          */
extern int  func_ov002_0229acd0(int cmd, int a, int b, int c);   /* [member1] */

/* list sink: (player, kind=13, 0) is the dominant call shape.              */
extern int  func_ov002_02253370(int a, int b, int c);            /* [member2] */

/* arg-pack sink: r0 is a packed u16 built by the caller.                   */
extern int  func_ov002_021d46ac(int packed, int a, int b, int c);/* [member2] */

/* --- sinks already matched on main (signatures are ground-truth) -------- */
extern int  func_ov002_021bc1a8(int player, int idx);            /* [shipped 021bcfe4] slot-ready */
extern int  func_ov002_021ff2cc(struct Ov002Self *self);         /* [shipped .s] bool query */
extern int  func_ov002_021ca1d8(int a, int unused, int c, int d);/* [shipped] thunk → 021ca0d4(a,0,c,d) */
extern void func_ov002_021b90e4(int *dst, const int *src);       /* [shipped] *dst = *src */
 ...
 * shared EUR C bodies retain the context macro spellings.  The USA layout
...
extern int  func_ov002_021e277c(int arg0);                       /* [shipped] → 021d479c(packed,...) */
...
extern u16  func_ov002_0223dda4(void *node, int idx);            /* [shipped] */

/* event-send sink (id, arg, out-ptr, kind). */
extern void func_ov002_021b1490(int a, int b, u16 *out, int kind);/* [shipped via 021e2c5c] */

/* accessor guard + sink used by band-sized 0x868 accessors (pass-through). */
extern int  func_ov002_021b8eec(int player, int idx);            /* [member 021ea1b4] accessor guard */
extern int  func_ov002_021c1fa4(struct Ov002Self *self, int player, int idx, int d); /* [member 021ea1b4] */
