/* func_ov002_022069a8: brief 234 C-39b — sibling of 021ff354 (different helpers).
 *
 * Same shape as func_ov002_021ff264.c — tag6 != 0x23 → helper-chain.
 */
...
extern int func_ov002_021f4004(struct F02206a98_Self *self);
extern int func_ov002_021ff080(unsigned int bit, int n, unsigned int field9,
                                unsigned int z0, unsigned int z1);

int func_ov002_022069a8(struct F02206a98_Self *self) {
