/* func_ov002_0228ab40: brief 227 C-39 wave 2 — single-arg helper, gt-2 threshold bool.
 *
...
int func_ov002_0228ab40(struct F0228ac50_Self *self) {
    return func_ov002_021bbe70(self->f2.bit0) > 2;
}
