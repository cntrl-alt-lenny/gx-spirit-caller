...
extern int func_ov002_0227d9a8(int x);

int func_ov002_022874b4(struct Self *self) {
    int n = func_ov002_021bbe70(1 - self->b0);
    n = n + func_ov002_021bbe70(self->b0);
    if (n <= 2) return 0;
    return func_ov002_0227d9a8(self->b0);
}
