/* func_ov002_02295094: bitfield-test + helper-tail.
 *
 *     push  {r3, lr}
 *     ldrh  r2, [r0, #2]
 *     lsl   r2, r2, #18
...
extern int func_ov002_02291050(struct FuncOv002022951a4Self *self, int arg);

int func_ov002_02295094(struct FuncOv002022951a4Self *self, int arg) {
    if (self->f2.field2 != 0) return 1;
    return func_ov002_02291050(self, arg);
}
