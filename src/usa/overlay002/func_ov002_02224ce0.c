/* func_ov002_02224ce0: C-39b sibling of 0221ee5c with different tail. */
...
extern int func_ov002_022116f0(struct F02224dd0_Self *self, int arg1);

int func_ov002_02224ce0(struct F02224dd0_Self *self, int arg1) {
    if (func_ov002_021b98d4(self->f2.bit0, self->f4.field9) < 0) return 0;
    return func_ov002_022116f0(self, arg1);
}
