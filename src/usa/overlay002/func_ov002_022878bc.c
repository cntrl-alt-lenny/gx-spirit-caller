/* func_ov002_022878bc: C-39 — if pre(self) is non-zero, return
 ...
 *
 *     push  {r4, lr}
 *     mov   r4, r0 ; bl func_ov002_0228780c
 *     cmp   r0, #0x0 ; beq .L
...
extern int func_ov002_0228780c(struct S022879cc *self);
extern int func_ov002_02280870(int bit0);

int func_ov002_022878bc(struct S022879cc *self) {
    if (func_ov002_0228780c(self) != 0) {
