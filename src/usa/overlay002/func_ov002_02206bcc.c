/* func_ov002_02206bcc: brief 230 C-39d — helper(bit0, lit1) ne early + helper(bit0, lit2) != 0.
 *
...
int func_ov002_02206bcc(struct F02206cbc_Self *self) {
    if (func_ov002_021c2e44(self->f2.bit0, 0x167a) != 0) return 1;
    return func_ov002_021c2e44(self->f2.bit0, 0x167b) != 0;
}
