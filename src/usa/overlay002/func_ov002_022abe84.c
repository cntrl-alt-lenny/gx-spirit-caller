/* func_ov002_022abe84: recovered C-42 resister (brief 254). The orig
...
extern int func_ov002_021afb8c(int v);

int func_ov002_022abe84(struct S2b07 *self, int idx) {
    int n = -self->f4;
    switch (n) {
    case 0x4b:
    case 0x4c:
    ...
    return func_ov002_021afb8c(self->f68[idx]);
}
