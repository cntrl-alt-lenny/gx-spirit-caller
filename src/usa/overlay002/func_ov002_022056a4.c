/* func_ov002_022056a4: if f6_11!=0x23, guard via func_ov002_021bb82c(bit0,
 * 0x159d)==0 -> 0. Then if the OPPOSITE-player cf178 table entry is nonzero,
 * return 1; else return func_ov002_021c3afc(bit0)!=0. */
...
int func_ov002_022056a4(struct S02205794 *self) {
    if (self->f2.f6_11 != 0x23) {
        if (func_ov002_021bb82c(self->f2.bit0, 0x159d) == 0)
            return 0;
    }
    if (*(int *)(data_ov002_022cf098 + ((1 - self->f2.bit0) & 1) * 0x868) != 0)
        return 1;
    return func_ov002_021c3afc(self->f2.bit0) != 0;
}
