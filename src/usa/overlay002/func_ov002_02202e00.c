/* func_ov002_02202e00: guard on self's 2-bit field (bits12-13 of +2) == 2;
 * call func_ov002_021b939c(self->+0x14 >> 3), decompose the result into
...
extern char data_ov002_022cf814[];
extern int func_ov002_021b939c(int val);

int func_ov002_02202e00(struct Ov002Self *self) {
    ...
    result = func_ov002_021b939c((unsigned int)(*(int *)((char *)self + 0x14)) >> 3);
    ...
    bit0 = byte0 & 1;
    val2 = *(unsigned short *)(data_ov002_022cf814 + bit0 * 0x868 + hi * 2);
    if ((val2 & 0xff) == 0x40)
        return 1;
