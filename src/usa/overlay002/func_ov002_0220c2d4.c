/* func_ov002_0220c2d4: bail if arg1==0; else self->b0 (bit0 at +2) picks a
 ...
 * field) to the sink. */
extern char data_ov002_022cf0c0[];
extern int func_ov002_021b8614(int a, int b);

struct F2Bits { unsigned short b0 : 1; unsigned short f1_5 : 5; };
struct F4Bits { unsigned short _pad : 6; unsigned short f2_9 : 9; };

int func_ov002_0220c2d4(void *self, int arg1) {
    struct F2Bits *f2;
    struct F4Bits *f4;
    int idx;
    unsigned short val;
    ...
    idx = (f2->b0 & 1) * 0x868;
    val = *(unsigned short *)(data_ov002_022cf0c0 + idx + f2->f1_5 * 20);
    if (val == 0)
        return 0;
    f4 = (struct F4Bits *)((char *)self + 4);
    return func_ov002_021b8614(arg1, f4->f2_9);
}
