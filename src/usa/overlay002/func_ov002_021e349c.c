 ...
 *   confidence: med
 */
/* func_ov002_021e349c: arg-shuffle trampoline -> func_021e2e80(0, arg0, arg1, 0).
 * arg0 routes r0->r3->r1 while r0 is reloaded to 0; r3 then re-zeroed. */
extern int func_ov002_021e2d90(int a, int b, int c, int d);

int func_ov002_021e349c(int arg0, int arg1) {
    return func_ov002_021e2d90(0, arg0, arg1, 0);
}
