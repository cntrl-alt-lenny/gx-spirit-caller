...
extern int func_ov002_021bcca0(int inverted, int minus_one);
extern void func_ov002_0226af00(int inverted, int ffff, int one);

int func_ov002_02217360(void *a) {
    ...
    }
    {
        ...
        if (func_ov002_021bcca0(inverted, -1) == 0) {
            return 0;
        }
    }
    {
        ...
        func_ov002_0226af00(inverted2, 0xffff, 1);
        return 0;
    }
}
