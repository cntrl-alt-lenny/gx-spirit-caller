/* func_ov002_02247600 — C-34 address-CSE duplicate pool slot (re-audit,
 ...
 * C-34 and src/main/func_0202a178.c for the worked reference example.
 */
...
int func_ov002_02247600(int arg0, int arg1, int arg2) {
    int i;
    struct Ov002Item *p;
    struct Ov002Item *base;

    if (arg0 == data_ov002_022ce1a8.f1164->flag && arg1 == 0xb) {
        i = 0;
        if (data_ov002_022cabc0[0].id != 0) {
            base = (struct Ov002Item *)(data_ov002_022cf08c + (arg0 & 1) * 0x868 + 0x120);
            p = (struct Ov002Item *)0x022cabc0;
            do {
                if (p->id == base[arg2].id) {
                    if (func_ov002_02247700(data_ov002_022ce1a8.f1164, i) != 0) {
                        return 0x800;
                    }
                }
                p++;
