/* func_ov002_02205188: C-39d 021ca2b8 predicate — three guards on self->f2.bit0:
...
extern int func_ov002_02253600(unsigned int bit, unsigned int a, int b);

int func_ov002_02205188(struct Func02205278Self *self) {
    if (func_ov002_021ca1d8(self->f2.bit0) == 0)
        return 0;
    if (func_ov002_021bc538(self->f2.bit0) < 2)
        return 0;
