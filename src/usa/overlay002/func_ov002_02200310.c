/* func_ov002_02200310: field6==0x23 skips the 021bb91c(0x128b) gate, then tail
 * 021ff46c(self, arg1). */
...
extern int func_ov002_021ff37c(struct F02200400_Self *self, int arg1);

int func_ov002_02200310(struct F02200400_Self *self, int arg1) {
