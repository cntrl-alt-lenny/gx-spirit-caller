/* func_ov002_02200288: C-39d — multi-call re-read with early-return + literal arg.
 *
 ...
 *     lsl   r0, r0, #31
 *     lsr   r0, r0, #31                   ; bit0
 *     bl    func_ov002_021ca1d8           ; helper1(bit0)
 *     cmp   r0, #0
 *     moveq r0, #0
 ...
 *     lsl   r0, r0, #31
 *     lsr   r0, r0, #31                   ; bit0
 *     bl    func_ov002_021ca310           ; helper2(bit0, 0x14f8)
 *     cmp   r0, #0
 *     movne r0, #1
 *     moveq r0, #0
 *     pop   {r4, pc}
...
int func_ov002_02200288(struct Func02200378Self *self) {
    if (func_ov002_021ca1d8(self->f2.bit0) == 0) return 0;
    return func_ov002_021ca310(self->f2.bit0, 0x14f8) != 0;
}
