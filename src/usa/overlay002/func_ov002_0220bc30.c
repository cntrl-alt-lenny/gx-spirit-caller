/* func_ov002_0220bc30: self->kind==0x23 shortcuts to "true". Otherwise
 ...
 * func_ov002_021bb82c(self->flag0, callArg); result is (call != 0).
 */
...
extern int func_ov002_021bb82c(int flag0, int callArg);

int func_ov002_0220bc30(struct Self0220bd20 *self, int callArg)
{
    ...
    L_70:
        if (func_ov002_021bb82c(self->flag0, callArg) == 0) return 0;
    }
L_8c:
    return 1;
}
