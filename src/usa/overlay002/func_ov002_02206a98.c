/* func_ov002_02206a98: C-39d 021ca2b8 predicate — three guards on self->f2.bit0:
...
extern int func_ov002_021ff1c8(struct Func02206b88Self *self, int v);

int func_ov002_02206a98(struct Func02206b88Self *self) {
    if (func_ov002_021ca1d8(self->f2.bit0) == 0)
        return 0;
    if (func_ov002_021ca310(self->f2.bit0, 0x1670) == 0)
        return 0;
    return func_ov002_021ff1c8(self, 1 - self->f2.bit0) >= 3;
}
