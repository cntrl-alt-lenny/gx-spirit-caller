/* func_ov002_02247588: recursive subset-reachability search. Scans arr[n..0];
...
int func_ov002_02247588(int *arr, int n, int target, int budget) {
    if (n < 0)
        goto return_zero;
        ...
        do {
            ...
            if (v < target) {
                if (n != 0) {
                    ...
                    if (func_ov002_02247588(arr, n - 1, target - v, newBudget) != 0)
                        return 1;
                }
            } else {
                if (v < upper)
