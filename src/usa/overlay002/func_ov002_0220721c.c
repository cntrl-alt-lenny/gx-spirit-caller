/* func_ov002_0220721c: C-39f 2-D table — base + (bit0&1)*0x868 +
...
extern int func_ov002_021ff230(struct S730 *self, int arg1);
int func_ov002_0220721c(struct S730 *self, int arg1) {
    unsigned int v = *(unsigned int *)(data_ov002_022cf0cc + (self->bit0 & 1) * 0x868 + self->b1_5 * 0x14);
