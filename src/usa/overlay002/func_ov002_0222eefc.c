...
extern void func_ov002_021e267c(int bit0, unsigned short f0, int kind, int fld);
extern int func_ov002_0223de04(void *self, int idx);
extern int func_0202b89c(int id);
extern void func_ov002_021df728(void *self, int opp, int val);
...
int func_ov002_0222eefc(struct Ov002Self *self) {
    ...
    {
        int idxResult = func_ov002_0223de04(self, 0);
        struct SmallSlot2 *slot = (struct SmallSlot2 *)((char *)data_ov002_022d0170 + idxResult * 4);
        int r = func_0202b89c(slot->id);
        func_ov002_021df728(self, 1 - self->b0, r);
    }
    return 0;
}
