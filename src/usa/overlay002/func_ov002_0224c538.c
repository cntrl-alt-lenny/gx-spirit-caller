/* func_ov002_0224c538: Same table-lookup-then-classify shape as func_ov002_0224e96c, with an added func_ov002_021ca360 gate before forwarding to func_ov002_02253370.
...
asm void func_ov002_0224c538(void) {
    nofralloc
