/* func_ov002_0220bae0: C-39f bit-0-indexed table lookup (gotcha 14).
...
extern int func_ov002_021ff310(struct S0220bbd0 *self, int arg1);
int func_ov002_0220bae0(struct S0220bbd0 *self, int arg1) {
