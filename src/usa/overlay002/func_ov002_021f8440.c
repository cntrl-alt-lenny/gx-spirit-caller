/* func_ov002_021f8440: brief 236 — helper1(self); helper2(bit0, 1, 0, 1); return 1.
 *
...
extern int func_ov002_021f495c(struct F021f8530_Self *self);
extern int func_ov002_0226ad40(unsigned int bit, unsigned int one, unsigned int z, unsigned int one2);

int func_ov002_021f8440(struct F021f8530_Self *self) {
