...
extern int func_ov002_021deb3c(unsigned int bit, unsigned int multi, int a, int b);

int func_ov002_02237c70(struct Self *self) {
    ...
    func_ov002_021deb3c(self->b0, self->p5, 0, 0);
    return 0;
}
