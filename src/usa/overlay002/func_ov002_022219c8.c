/* func_ov002_022219c8: C-39 — two guards (f0==0x14c0, bits4-7@2==0),
...
extern void func_ov002_021e050c(int bit0, int v);

int func_ov002_022219c8(struct S02221ab8 *self, struct A02221ab8 *arg1) {
    /* nested guards (not early-return) so both `bne` to the shared
     * `return 0` epilogue (orig), not predicated movne/popne. */
    if (self->f0 == 0x14c0) {
        if (self->b4_7 == 0) {
            func_ov002_021e050c(arg1->bit0, (unsigned int)self->f4 >> 1);
        }
    }
    return 0;
}
