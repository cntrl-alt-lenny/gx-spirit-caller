/* func_ov002_021edda4: 0x868 wrapper — opponent guard; for in-range idx also
 * require func_ov002_021b8eec; then f30 guard and func_ov002_021c1e10. */
...
int func_ov002_021edda4(struct self_t *self, int player, int idx) {
    struct subrow *sr;
    if (player == self->b0)
        return 0;
    if (idx < 5) {
