/* func_ov002_021bc5ac: counting loop, 5 iterations.
 *
 *     push  {r4, r5, r6, lr}
 *     mov   r5, #0          ; count = 0
 ...
 */
extern int func_ov002_021bc47c(int self, int i);

int func_ov002_021bc5ac(int self) {
    int i;
    int count = 0;
    for (i = 0; i < 5; i++) {
        if (func_ov002_021bc47c(self, i)) count++;
    }
    return count;
}
