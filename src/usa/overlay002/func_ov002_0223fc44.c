/* func_ov002_0223fc44: C-39 bit-extract base recipe (brief 252 pilot).
...
extern void func_ov002_0223d9e0(struct S0223fd2c *self, u16 arg);

int func_ov002_0223fc44(struct S0223fd2c *self) {
    func_ov002_0223d9e0(self, 1 - self->bit0);
    return 1;
}
