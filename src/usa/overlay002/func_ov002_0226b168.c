 ...
 *   confidence: high
 */
/* func_ov002_0226b168: forward (u16)arg1 to the command sink func_ov002_0226ac08
...
int func_ov002_0226b168(int arg0, int arg1, int arg2) {
    return func_ov002_0226ac08(arg0, 0x16, (u16)arg1, 0);
}
