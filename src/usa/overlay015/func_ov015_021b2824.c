/* func_ov015_021b2824 (brief 535, B4): touch-rect hit-test drives a
 * 2-bit mode/state transition ladder, then conditionally fires a
 * callback and tail-calls func_ov015_021b26d8. Byte-identical to
...
extern int func_ov015_021b26d8(Widget *self, int arg2, int *outparam, int flag);

int func_ov015_021b2824(Widget *self, void *rngArg, int arg2)
{
    int px, py;
    ...
    self->trigger = 0;
    ret = ret + func_ov015_021b26d8(self, arg2, &savedRng, 0);
    return ret;
}
