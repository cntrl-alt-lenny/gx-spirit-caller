/* func_ov015_021b30f0: load a 4-short rect into the object's +0x54 window, clear
 * the +0x60 cursor, and seed +0x64 with the scaled height span minus 1. (ov015) */
extern int func_020b377c(int, int);
void func_ov015_021b30f0(void *o, const short *src) {
    ...
    *(int *)((char *)o + 0x60) = 0;
    *(int *)((char *)o + 0x64) =
        func_020b377c(*(short *)((char *)o + 0x5a) - *(short *)((char *)o + 0x56),
                      *(short *)((char *)o + 0x6c)) - 1;
}
