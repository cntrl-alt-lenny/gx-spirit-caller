/* func_ov015_021b3e68: set bit 2 on the int at data_ov015_021b5d08 + 0xaa0.
 *
 *     ldr r0, .L_021b3f94
 *     ldr r1, [r0, #0xaa0]
 *     orr r1, r1, #0x4
 *     str r1, [r0, #0xaa0]
 *     bx  lr
 * .L_021b3f94: .word data_ov015_021b5d08
 *
 ...
 * `*(int *)(data_ov015_021b5d08 + 0xaa0) |= 0x4;` gets folded by mwcc
...
extern ov015_state_tail_t data_ov015_021b5d08;

void func_ov015_021b3e68(void) {
    data_ov015_021b5d08.flags |= 0x4;
}
