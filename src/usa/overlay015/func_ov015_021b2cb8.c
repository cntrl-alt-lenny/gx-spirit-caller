/* func_ov015_021b2cb8: family 46f91df6 sibling of ov010_021b2db8
...
extern int func_ov015_021b2a08(void *self);
extern void Fill32(int value, int dst, int len);

void func_ov015_021b2cb8(void *self, int a1, int a2) {
    Fill32(0, func_ov015_021b2a08(self) + (a1 << 5), a2 << 5);
}
