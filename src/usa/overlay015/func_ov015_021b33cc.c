/* func_ov015_021b33cc: advance the scroll if the window has actually moved — the
...
int func_ov015_021b33cc(void *o) {
    int span = *(short *)((char *)o + 0x6c);
    int v;
    if (span == 0)
        v = 0;
    else
        v = func_020b377c(*(short *)((char *)o + 0x5a) - *(short *)((char *)o + 0x56),
                          span);
