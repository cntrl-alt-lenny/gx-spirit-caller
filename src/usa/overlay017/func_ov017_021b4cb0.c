/* func_ov017_021b4cb0: clear bit 2 of the BG control field (bits 12:8) of the
 * sub-display 0x04001000 register, then clear the 0x800-byte VRAM block from
 * func_0208dfb8. Returns 1.
 *
...
extern void func_02094410(int val, void *dst, unsigned int size);

int func_ov017_021b4cb0(void) {
