; func_ov005_021abd7c — whole-function ship-as-.s (GLOBAL_ASM endgame, brief 302):
...
; For reg-alloc-walled functions with no C match (brief 294 endgame).
        ...
        .extern func_ov005_021abcd8
        .extern func_ov005_021abd24
        .global func_ov005_021abd7c
        .arm
func_ov005_021abd7c:
...
.L_554:
    ...
    mov r3, #0x10
    mov r1, r1, lsr #0x1f
    bl func_ov005_021abcd8
    ldr r1, [sp, #0x1c]
    ldr r2, [fp, #0x4]
    mov r0, r9
    mov r3, #0x10
    bl func_ov005_021abd24
    ldr r0, [sp, #0x1c]
    mov r3, r7
    add r0, r0, #0x1
    str r0, [sp]
...
_LIT1: .word data_ov005_021b16e0
_LIT2: .word data_ov005_021b16e4
