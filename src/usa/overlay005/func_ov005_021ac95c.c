/* func_ov005_021ac95c: begin a scroll if one isn't already running and there is
...
extern int func_ov005_021ac87c(void *);
void func_ov005_021ac95c(void *o, int target) {
