/* func_ov011_021ca664: 4-bit bitfield extractor from
 * `data_ov011_021d4000 + 0x2bc`, bits 18..21.
 *
 *     ldr r0, .L_021ca678           ; r0 = &data_ov011_021d4000
 *     ldr r0, [r0, #0x2bc]          ; r0 = *(u32 *)(p + 0x2bc)
 *     mov r0, r0, lsl #0xa          ; << 10 (kill top 10 bits)
 *     mov r0, r0, lsr #0x1c         ; >> 28 (extract 4-bit field)
 *     bx  lr
 * .L_021ca678: .word data_ov011_021d4000
 *
...
unsigned func_ov011_021ca664(void) {
    return (data_ov011_021d4000.flags_2bc << 10) >> 28;
}
