/* func_ov011_021c9dd8: when idle (021d1d18 clear, 021cf2dc set, 403c.278 bit clear)
 * and the 403c.260 bit is clear, run func_0200617c. */
#include "ov011_core.h"
extern int func_ov011_021d1d18(void);
extern int func_ov011_021cf2dc(void);
extern int func_0200617c(int);
int func_ov011_021c9dd8(void) {
