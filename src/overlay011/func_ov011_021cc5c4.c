/* func_ov011_021cc5c4: sibling of 021cc424 over the ov000 75cc handle table —
 * push a 0x1c000/0x600 config (mode 2) via 0201e964, reset+release on fresh
 * tag. */
#include "ov011_core.h"
extern char data_ov000_021c75cc[];
...
void func_ov011_021cc5c4(int idx, int a1, int a2, int a3, void *p5) {
    void *h = ((void **)data_ov000_021c75cc)[idx];
    if (a1 != -1) func_0201e800(h, (unsigned int)(a1 << 16) >> 16);
    func_0201e964(2, *(int *)((char *)h + 0x2C), p5, 0,
