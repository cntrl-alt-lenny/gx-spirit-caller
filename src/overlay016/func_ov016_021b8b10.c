...
void func_ov016_021b8b10(void *arg0, void **arg1) {
    char *p = arg0;
    int tmp;
    OS_SPrintf(arg1[0], data_ov016_021b95d8, *(unsigned char *)(p + 462));
    OS_SPrintf(arg1[1], data_ov016_021b95f8, *(unsigned char *)(p + 462));
    OS_SPrintf(arg1[2], data_ov016_021b9618, *(unsigned char *)(p + 462));
    OS_SPrintf(arg1[3], data_ov016_021b9638, *(unsigned char *)(p + 462));
    if (*(int *)(p + 268) != 0) {
