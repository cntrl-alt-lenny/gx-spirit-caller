...
void func_ov016_021b894c(void *arg0, void **arg1) {
    char *p = arg0;
    int tmp;
    func_02091554(arg1[0], data_ov016_021b94d8, *(unsigned char *)(p + 461));
    func_02091554(arg1[1], data_ov016_021b94f8, *(unsigned char *)(p + 461));
    func_02091554(arg1[2], data_ov016_021b9518, *(unsigned char *)(p + 461));
    func_02091554(arg1[3], data_ov016_021b9538, *(unsigned char *)(p + 461));
    if (*(int *)(p + 176) != 0) {
