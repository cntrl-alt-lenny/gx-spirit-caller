...
void func_ov016_021b8bf4(void *arg0, void **arg1) {
    char *p = arg0;
    int tmp;
    OS_SPrintf(arg1[0], data_ov016_021b9658, *(unsigned char *)(p + 463));
    OS_SPrintf(arg1[1], data_ov016_021b9678, *(unsigned char *)(p + 463));
    OS_SPrintf(arg1[2], data_ov016_021b9698, *(unsigned char *)(p + 463));
    OS_SPrintf(arg1[3], data_ov016_021b96b8, *(unsigned char *)(p + 463));
    if (*(int *)(p + 360) != 0) {
