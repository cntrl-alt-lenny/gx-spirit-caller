...
void func_ov016_021b8cd8(void *arg0, void **arg1) {
    ...
    func_02091554(arg1[0], data_ov016_021b96d8, *(unsigned short *)(p + 464) + 75);
    func_02091554(arg1[1], data_ov016_021b96f0, *(unsigned short *)(p + 464) + 75);
    func_02091554(arg1[2], data_ov016_021b9708, *(unsigned short *)(p + 464) + 75);
    func_02091554(arg1[3], data_ov016_021b9720, *(unsigned short *)(p + 464) + 75);
    if (*(int *)(p + 452) != 0) {
