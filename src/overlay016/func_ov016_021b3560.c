/* func_ov016_021b3560: C-43 packed stack-local struct builder (brief
 ...
 *     bl    func_ov016_021b3498  ; helper(a0, a1, a2, &local)  (gap at 10)
 *     add   sp, sp, #0xc
 *     pop   {r3, r4, pc}
 */
...
extern void func_ov016_021b3498(int a0, int a1, int a2, void *p);

void func_ov016_021b3560(int a0, int a1, int a2, u16 a3, int A, int B, int C) {
    struct P021b3560 local;
    local.f0 = a3;
    local.f2 = A;
    local.f6 = B;
    local.f8 = C;
    func_ov016_021b3498(a0, a1, a2, &local);
}
