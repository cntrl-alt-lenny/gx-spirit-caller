; func_ov016_021b61dc — whole-function ship-as-.s (GLOBAL_ASM endgame, brief 302):
...
; For reg-alloc-walled functions with no C match (brief 294 endgame).
        ...
        .extern func_ov016_021b77cc
        .global func_ov016_021b61dc
        .arm
func_ov016_021b61dc:
...
.L_1ec:
    ...
    sub r1, r2, #0xb9
    str r1, [r0, #0x1e8]
    bl func_ov016_021b77cc
    mov r0, #0x1
    add sp, sp, #0x8
    ldmia sp!, {r3, r4, r5, r6, r7, pc}
_LIT0: .word data_ov016_021bac64
_LIT1: .word data_ov016_021b9740
_LIT2: .word data_02102c90
_LIT3: .word 0x000006b9
_LIT4: .word 0x04000014
_LIT5: .word data_ov016_021bb2c4
_LIT6: .word data_ov016_021bb3c4
