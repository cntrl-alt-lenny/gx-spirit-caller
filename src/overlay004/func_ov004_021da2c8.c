/* func_ov004_021da2c8: VRAM-bank palette/tile row clearer. idx*0x30 mod 256
...
void func_ov004_021da2c8(int idx) {
    int r5 = (idx * 0x30) % 256;
    int base;

    if (r5 <= 0xd0) {
        base = func_0208e0a0();
        func_02094504(0, (char *)base + (r5 / 8) * 64, 0x180);
    } else {
        int r4;
        base = func_0208e0a0();
        r4 = 0x100 - r5;
        func_02094504(0, (char *)base + (r5 / 8) * 64, ((r4 * 32) / 8) * 2);

        base = func_0208e0a0();
        func_02094504(0, (char *)base, (((0x30 - r4) * 32) / 8) * 2);
    }
}
