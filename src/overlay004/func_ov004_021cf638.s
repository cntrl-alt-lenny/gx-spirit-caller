; func_ov004_021cf638 - whole-function ship-as-.s (GLOBAL_ASM endgame, brief 302):
...
; For reg-alloc-walled functions with no C match (brief 294 endgame).
        ...
        .extern func_ov004_021cedf8
        .extern func_ov004_021cf070
        .extern func_ov004_021cf3a8
        .extern func_ov004_021cf600
        .extern func_ov004_021d8798
        .extern func_ov004_021d8cd0
        .extern func_ov004_021d8d58
        .extern func_ov004_021d9134
        .global func_ov004_021cf638
        .arm
func_ov004_021cf638:
    stmdb sp!, {r3, r4, lr}
    sub sp, sp, #0x254
...
.L_4f0:
    ...
    cmp r0, #0x0
    beq .L_510
    bl func_ov004_021cf600
    b .L_514
.L_510:
    bl func_ov004_021cf3a8
.L_514:
