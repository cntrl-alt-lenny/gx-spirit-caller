; func_ov004_021d83b0 - whole-function ship-as-.s (GLOBAL_ASM endgame, brief 302):
...
; For reg-alloc-walled functions with no C match (brief 294 endgame).
        ...
        .extern func_ov004_021d71ec
        .extern func_ov004_021d7440
        .extern func_ov004_021d7564
        .extern func_ov004_021d7c84
        .extern func_ov004_021d7f2c
        .global func_ov004_021d83b0
        .arm
func_ov004_021d83b0:
...
.L_854:
    mov r0, #0xe0
    bl func_ov004_021c9ef0
    bl func_ov004_021d7f2c
.L_860:
    bl func_ov004_021d71ec
    bl func_ov004_021d7564
    ldr r0, [r4, #0x54]
    cmp r0, #0x4
    addls pc, pc, r0, lsl #0x2
    b .L_8a8
