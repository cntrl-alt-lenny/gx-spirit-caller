/* func_ov005_021aafac: bind a command buffer to the object — record the buffer
...
extern void func_0209448c(int, int, int);
void func_ov005_021aafac(void *o, char *buf) {
    *(char **)((char *)o + 0x4) = buf;
    *(char **)((char *)o + 0x8) = buf + 0xc;
    *(char **)((char *)o + 0xc) = buf + *(int *)(*(char **)((char *)o + 4) + 8);
    *(int *)((char *)o + 0x10) =
        Task_PostLocked((func_ov005_021ab0fc(o) + 1) * 2, 4, 0);
    {
        int n = func_ov005_021ab0fc(o) + 1;
        int slot = *(int *)((char *)o + 0x10);
        func_0209448c(0, slot, n * 2);
    }
}
