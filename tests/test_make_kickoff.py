...
def test_all_lane_host_emissions_pass_kickoff_lint():
...
def test_pool_item_stamps_live_figure_and_reproducer():
    text = make_kickoff.generate(
        "scaffolder",
        "windows",
...
def test_item_without_named_pool_emits_no_number():
...
def test_stripped_establishment_is_refused():
